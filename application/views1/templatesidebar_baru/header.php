        ...
        <div id="header-fix" class="header fixed-top">
            <div class="site-width">
                <nav class="navbar navbar-expand-lg  p-0">
					...
					<?php
					} else if ($backhome == "gizi") {
						?>
						<a href="<?php echo site_url();?>/applayanan/appgizi" class="navbar-brand">
							<i class="fa fa-home"></i> Menu SIMRS
						</a>
					<?php
					} else if ($backhome == "gudang") {
					?>
					<a href="<?php echo site_url();?>/applayanan/appgudang" class="navbar-brand">
						<i class="fa fa-home"></i> SIMRS
					</a>
					<?php
					} else if ($backhome == "inst") {
					?>
					<a href="<?php echo site_url();?>/applayanan/appinstalasi" class="navbar-brand">
						<i class="fa fa-home"></i> SIMRS
					</a>
					<?php
					} else if ($backhome == "bo") {
						?>
						<a href="<?php echo site_url();?>/applayanan/menuappbackoffice" class="navbar-brand">
							<i class="fa fa-home"></i> Menu Utama
						</a>
						<?php
					}
