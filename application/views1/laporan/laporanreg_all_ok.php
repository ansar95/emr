			...
			<div class="col-12">
				<div class="card">
					<div class="card-header d-flex justify-content-between align-items-center">
						<h4 class="mb-0">Laporan Register Pasien</h4>
					</div>
					<div class="card-body">
						<form target="_blank" action="<?php echo site_url(); ?>/laporanpasien/panggilcetak_all" method="post">
							<div class="row mb-2">
								<div class="col-md-2">
									<label class="col-form-label">Periode Register</label>
								</div>
								<div class="col-md-2">
							...
							<div class="row mb-2">
									...
									<div class="col-md-9">
										<div class="custom-control custom-radio custom-control-inline">
											<input type="radio" class="custom-control-input" name="bagian" value="IGD" id="cekigd" checked>
											<label class="custom-control-label" for="cekigd">IGD</label>
										</div>
										<div class="custom-control custom-radio custom-control-inline">
											<input type="radio" class="custom-control-input" name="bagian" value="JALAN" id="cekjalan">
											<label class="custom-control-label" for="cekjalan">RAWAT JALAN</label>
										</div>
										<div class="custom-control custom-radio custom-control-inline">
											<input type="radio" class="custom-control-input" name="bagian" value="INAP" id="cekinap">
											<label class="custom-control-label" for="cekinap">RAWAT INAP</label>
										</div>
									</div>
									<div class="col-md-3">
									</div>
							...
							<div class="row mb-2">
								<div class="col-md-2">
									<label class="col-form-label">Unit Pelayanan</label>
								</div>
								<div class="col-md-2">
									<div class="custom-control custom-radio custom-control-inline">
							...
							<div class="row mb-3">
								...
								<div class="col-md-6">
									...
									<div class="custom-control custom-radio custom-control-inline">
										<input type="radio" class="custom-control-input" name="kunjungan" id="kunjungan0" value="0">
										<label class=" custom-control-label" for="kunjungan0">Pasien Lama</label>
									</div>
									<div class="custom-control custom-radio custom-control-inline">
										<input type="radio" class="custom-control-input" name="kunjungan" id="kunjungan1" value="1">
								...
								<div class="row mb-2">
									...
									<div class="col-md-3">
										<div class="custom-control custom-radio custom-control-inline">
											<input type="radio" class="custom-control-input" name="urut" value="tanggal" id="uncekurut" checked>
											<label class="custom-control-label" for="uncekurut">Tanggal</label>
										</div>
										<div class="custom-control custom-radio custom-control-inline">
											<input type="radio" class="custom-control-input" name="urut" value="diagnosa" id="cekurut">
							...
							<div class="row mt-2">
								...
								<div class="col-md-6">
									<input type="submit" name="cet" class="btn btn-primary mt-2" value="Cetak" />
									<input type="submit" name="cete" class="btn btn-success mt-2" value="Excel" />
								</div>
							</div>
						</form>
					</div>
