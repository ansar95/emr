...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tbody>
    ...
    <tr>
      <td style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; font-size: 11px;">DAFTAR FAKTUR PEMBELIAN BHP MEDIK</td>
    </tr>
  </tbody>
</table>
...
<table class="tabelbiasa2" width="100%"  align="left" cellpadding="1" cellspacing="1">
  <tbody>
    <?php
        ...
        $diorder = " order by pfakturheader.tglbeli, pfakturheader.id ";
        $totaldiskon=0;
        $totalppn=0;
        $totaljumlah=0;
        $totaljumlahharga=0;
        $per1="SELECT noterima FROM pfakturheader where bhp=1 and (tglbeli BETWEEN '$tanggalawal' and '$tanggalakhir') ";
        // $per1="SELECT  pfakturheader.noterima FROM pfakturheader,pfakturdetail,mobat where pfakturheader.noterima=pfakturdetail.noterima and pfakturdetail.kodebarang=mobat.kodeobat and  (pfakturheader.tglbeli BETWEEN '$tanggalawal' and '$tanggalakhir')";

        $perintah1=$per1.$filterpbf.' order by pfakturheader.tglbeli,pfakturheader.id';
 ...
 ?>
       <?php 
        foreach ($qry1->result_array() as $brs1) { 
            ...
            $per2="SELECT  pfakturheader.tglbeli, pfakturheader.noterima, pfakturheader.nofak, pfakturheader.namapbf, pfakturdetail.namabarang, pfakturdetail.batch, pfakturdetail.expire, pfakturdetail.qty, pfakturdetail.harga,  pfakturdetail.diskon,  pfakturdetail.potlangsung, pfakturheader.ppn  FROM pfakturheader,pfakturdetail,mobat where pfakturheader.noterima=pfakturdetail.noterima and pfakturdetail.kodebarang=mobat.kodeobat and  (pfakturheader.tglbeli BETWEEN '$tanggalawal' and '$tanggalakhir') and pfakturheader.noterima='$noterima' and pfakturdetail.hapus=0 ";
            $perintah=$per2.$filterpbf.$filterobatbhp.$diorder;
        ...
        ?>        
                    ...
                    <th width="6%" style="text-align: center" ><?php echo tgl_format_indo($brs2['tglbeli']); ?></th>
