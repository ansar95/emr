							...
							<table class="table table-borderless mt-3">
								<tr>
									...
									<td width="90%" valign="middle">
										<div class="custom-control custom-checkbox custom-control-inline">
											<input type="checkbox"  class="custom-control-input" name="qtysaja" id="qtysaja"> 
											<label class="custom-control-label checkbox-primary" for="qtysaja">Hanya Cetak Qty</label>                                       
										</div>
									</td>
									<!-- <td width='82%'></td> -->
								</tr>
