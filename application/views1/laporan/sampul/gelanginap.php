...
@page{
	...
	<body>
	<?php
	$qry2=$this->db->query("SELECT * FROM register INNER JOIN pasien ON register.no_rm = pasien.no_rm INNER JOIN register_detail ON register.notransaksi =register_detail.notransaksi and register_detail.id = '".$id."' LIMIT 1");;
...
<table border="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="40"><span class="style4">No. RM</span></td>
    <td width="500" class="style4">: <span class="style1"><?php echo $xno_rm ;?></span></td>
  </tr>
  <tr>
    <td ><span class="style4">Nama</span></td>
    <td class="style4">: <span class="style1"><?php echo $xnama_pasien ;?></span></td>
  </tr>
  <tr>
