...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
      <td><img src="<?=$kop_billing?>" alt="ss" width="700" height="105" /></td>
  </tr>
  <tr>
    <td>
      <div align="left">
        <span class="style51">BILLING </span>
        <span class="style52">| <?php echo $xasuransi;?></span>
      </div>
    </td>
  </tr>  
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <!-- <tr>
    <td width="8%"><div align="left"><span class="style2"><?php echo $ztgl_keluar;?></span></div></td>
    <td width="83%"><span class="style2"><?php echo 'Administrasi';?></span></td>
    <td width="9%"><div align="right"><span class="style2"><?php echo groupangka($xhargaqty);?></span></div></td>
  </tr> -->
  ...
  <!-- <tr>
    <td width="8%"><div align="left"><span class="style2"><?php echo $ztgl_keluar;?></span></div></td>
    <td width="83%"><span class="style2"><?php echo 'Materai';?></span></td>
    <td width="9%"><div align="right"><span class="style2"><?php echo groupangka($xhargaqty);?></span></div></td>
  </tr> -->
