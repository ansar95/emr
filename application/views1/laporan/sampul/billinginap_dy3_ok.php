...
<?php
 ...
 $qry1=$this->db->query("SELECT notransaksi FROM register where register.id = '$id' LIMIT 1");
   ...
   foreach ($qry2->result_array() as $brs2) {
                  ...
                  //  $xasuransi=$brs2['golongan']; kebawah
   ...
   //cek ulang golongannya
   $qry22=$this->db->query("SELECT golongan as golonganrawat FROM register where notransaksi = '$notrx' LIMIT 1");
   foreach ($qry22->result_array() as $brs22) {
      $xasuransi=$brs22['golonganrawat'];
...
<?php
        ...
        // $qry1=$this->db->query("SELECT kode_unit,kode_kelas,nama_unit,kode_kamar from register_detail WHERE notransaksi='$xnotransaksi' AND no_rm='$xno_rm' ORDER BY id ASC");
        $qry1=$this->db->query("SELECT kode_unit,kode_kelas,nama_unit,kode_kamar,tgl_masuk_kamar, tgl_keluar_kamar from register_detail WHERE notransaksi='$xnotransaksi' AND no_rm='$xno_rm' ORDER BY id ASC");
        $xjumharga=0;
        foreach ($qry1->result_array() as $brs1) {
...
<?php
                    ...
                    foreach ($qry8->result_array() as $brs8) {
                      ...
                      ?>
                        <tr>
                        <td width="79%" height="5"><span class="style2"><?php echo $xnama_makanan;?></span></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="83%"><span class="style2"><?php echo 'Rekam Medik';?></span></td>
    <td width="9%"><div align="right"><span class="style2"><?php echo groupangka($xhargaqty);?></span></div></td>
  </tr>
