...
<table width="80%" border="0" cellspacing="1" cellpadding="2">
  <tbody>
    ...
    <tr>
      ...
      <td style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-style: normal; font-weight: bold; font-size: 11px; text-align: right"><?php echo $pilihdana; ?></td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <?php
        ...
        if ($kondisicekdana == 1 ) {
          ...
          $filterdana=" and ampra_detail.penggunaan='$pendanaan' ";
          $pilihdana=$pendanaan;
        }
       ...
       <?php 
            ...
            foreach ($qry2->result_array() as $brs2) {    
                ...
                if ($kode_unit !=  $kode_unitcek or $tgldrop !=  $tgldropcek) {
                  if ($subjumlahharga != 0 ) {
                    ...
                    <th class="warna" width="7%" style="text-align: right" ><?php echo ($excel = 1 ? (double)$subjumlahharga : formatuang($subjumlahharga)); ?></th>
        ...
        ?>        
                ...
                <?php } 
                  ...
                  <?php if ($excel == 1) { ?>
                    <th width="7%" style="text-align: right" ><?php echo (double)$brs2['qtyampra']; ?></th>
                    <th width="7%" style="text-align: right" ><?php echo (double)$brs2['qtydrop']; ?></th>
                    <th width="7%" style="text-align: right" ><?php echo (double)$brs2['harga']; ?></th>
                    <th width="8%" style="text-align: right" ><?php echo (double)$jumlahharga; ?></th>
        ...
        ?>
            <tr class="atas" style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 9px; text-align: center;">
              ...
              <!-- <th class="warna" width="7%" style="text-align: right" ><?php echo formatuang($subjumlahharga); ?></th> -->
              <th class="warna" width="7%" style="text-align: right" ><?php echo ($excel = 1 ? (double)$subjumlahharga : formatuang($subjumlahharga)); ?></th>
              <th class="warna" width="4%" style="text-align: left" ><?php echo ""; ?></th>
              <th class="warna" width="4%" style="text-align: left" ><?php echo ""; ?></th>
            </tr>
              <!-- <td style="text-align: center">&nbsp;</td> -->
            <!-- <tr></tr> -->
...
<table width="80%" border="0" cellpadding="2" cellspacing="1">
  <tbody>
    <tr style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 9px; text-align: center;">
              ...
              <th width="8%" style="text-align: left" ><?php echo ""; ?></th>
              <th width="8%" style="text-align: left" ><?php echo ""; ?></th>
              <th width="4%" style="text-align: right" ><?php echo ""; ?></th>
              <th width="4%" style="text-align: right" ><?php echo ""; ?></th>
              <th width="4%" style="text-align: right" ><?php echo ""; ?></th>
              <th width="4%" style="text-align: right" ><?php echo ""; ?></th>
              <th width="6%" style="text-align: right" ><?php echo "TOTAL"; ?></th>
              <!-- <th width="7%" style="text-align: right" ><?php echo formatuang($totaljumlah); ?></th> -->
              <th class="warna" width="7%" style="text-align: right" ><?php echo ($excel = 1 ? (double)$totaljumlah : formatuang($totaljumlah)); ?></th>
              <th width="4%" style="text-align: left" ><?php echo ""; ?></th>
              <th width="4%" style="text-align: left" ><?php echo ""; ?></th>
    </tr>
  </tbody>
</table>
