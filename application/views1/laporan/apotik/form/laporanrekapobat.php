			...
			<div class="col-12">
				<div class="card">
					<div class="card-header d-flex justify-content-between align-items-center">
						<h4 class="mb-0">Laporan Rekapitulasi Obat Keluar</h4>
					</div>
					<div class="card-body">
						<form target="_blank" action="<?php echo site_url(); ?>/depoapotik/panggilcetakrekapobat" method="post">
							<div class="row ">
								<div class="col-md-2">
								...
								<div class="col-md-2">
									<div class="input-group  mb-3">
										...
										<input type="text" id="akhir" class="form-control" required name="akhir" autocomplete='off'>
									</div>
								</div>
							...
							<div class="row  mb-2">
								...
								<div class="col-md-3">
									<div class="custom-control custom-radio custom-control-inline">
										<input type="radio" class="custom-control-input" name="cekunit" value="1" id="uncekunit" onclick="javascript:unitcek();" checked>
										<label class="custom-control-label" for="uncekunit">Semua</label>
									</div>
									<div class="custom-control custom-radio custom-control-inline">
										<input type="radio" name="cekunit" class="custom-control-input" value="2" id="cekunit" onclick="javascript:unitcek();">
