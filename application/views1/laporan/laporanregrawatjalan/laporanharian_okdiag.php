...
if ($bagian == 'IGD') {
    ...
    $filter_aloket="";
    // $filterbagian=" and register.bagian = 'INAP' or (register.bagian='IGD' and (kode_keluarpada<>'IGDP' or kode_keluarpada<>'IGDD' or kode_keluarpada<>'IGDC' or kode_keluarpada<>'KMBCOV')) ";

    //jika hanya yg regis langsung inap saja
    $filter_aloket=" and register_detail.kode_unitR='ALOKET' ";
    $filterbagian=" and register.bagian = 'INAP' ";
    $filterunit="";
    if ($unit == "pilih") {
        $filterunit=" and munit.kode_unit='$unitpilih' ";
    }
  ...
  <?php 		
    ...
    <?php 
        ...
        if ($l == null) {?>
          ...
          $selectregister="SELECT register.user1 as user, register.bagian, register.kode_keluarpada, register.bagian, register.tgl_masuk as tgl, register.no_rm, pasien.nama_pasien as nama_pasien, pasien.sex as sex, pasien.alamat, register.golongan as golongan, register.barulama as barulama, register.notransaksi, register_detail.nama_unit, register_detail.kode_unit, register_detail.nama_unit, pasien.tgl_daftar from register_detail, register, pasien where register_detail.notransaksi=register.notransaksi and register_detail.no_rm=pasien.no_rm and register.tgl_masuk>='$tgl1' and register.tgl_masuk<='$tgl2' and register_detail.kode_unit='$kode_unitnya' ";


          // $filterunit="";
          // if ($unit == "pilih") {
          //   $filterunit=" and register_detail.kode_unit='$unitpilih' ";
          // }
          ...
          if ($urut == "tanggal") {
            ...
            $diorder=" order by pdiagnosa.nodaftar, register.tgl_masuk, register.jam_masuk";
          }
