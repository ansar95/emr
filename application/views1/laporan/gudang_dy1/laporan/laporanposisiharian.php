...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    ...
    <tr>
      <td width="70%" style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; font-size: 11px;">POSISI STOK PERIODE : <?php echo $periodeawal." s/d ".$periodeakhir ; ?></td>
      <td width="30%" style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; font-size: 11px; text-align: right;"><?php echo 'Pendanaan : '.$pendanaan; ?></td>
    </tr>
    <tr>
      <!-- <?php echo $cekgen;?> -->
    </tr>  
 ...
 ?>
       ...
       $i=0;
        foreach ($qry->result_array() as $brs) {
            ...
            //saldo awal
            $sawal=0;
            $perintah1="SELECT  sum(masuk-keluar+returm-returk) as sawal FROM kartustok_gudang where kodeobat='$kodeobat' and tanggal<'$tanggalawal' and harga='$harga' and pendanaan='$pendanaan' group by kodeobat, harga";
            ...
            //datanya
            $perintah2="SELECT * FROM kartustok_gudang where kodeobat='$kodeobat' and tanggal>='$tanggalawal' and tanggal<='$tanggalakhir' and harga='$harga' and pendanaan='$pendanaan' group by kodeobat, harga";
