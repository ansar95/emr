    ...
    <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="7%" rowspan="2"><img src="../rsudpemprov/assets/img/logokes.jpg" width="46" height="61" /></td>
            <td width="93%" valign="bottom"><span class="style33">Formulir RL. 4.A </span></td>
          </tr>
          <tr>
