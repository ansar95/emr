       ...
       <?php 
        ...
        ?>        
                ...
                <?php }  ?>
                    ...
                    <?php } else { ?>
                      ...
                      <th width="6%" style="text-align: right" ><?php echo formatuang_dec($brs2['harga']); ?></th>
                      <th width="7%" style="text-align: right" ><?php echo formatuang_dec($jumlahharga); ?></th>
                      <th width="7%" style="text-align: right" ><?php echo formatuang_dec($diskonnya); ?></th>
                      <th width="6%" style="text-align: right" ><?php echo formatuang_dec($ppnnya); ?></th>
                      <th width="8%" style="text-align: right" ><?php echo formatuang_dec($jumlahnya); ?></th>
                    <?php }?>
                    </tr>            
        <?php } 
            if ($subjumlahharga != 0 ) {
        ?>
            <tr class="atas" style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 9px; text-align: center;">
              ...
              <?php } else { ?>
                <th class="warna" width="7%" style="text-align: right" ><?php echo formatuang_dec($subjumlahharga); ?></th>
                <th class="warna" width="7%" style="text-align: right" ><?php echo formatuang_dec($subtotaldiskon); ?></th>
                <th class="warna" width="6%" style="text-align: right" ><?php echo formatuang_dec($subtotalppn); ?></th>
                <th class="warna" width="8%" style="text-align: right" ><?php echo formatuang_dec($subtotaljumlah); ?></th>
              <?php }?>
            </tr>
...
<table width="100%" border="0" cellpadding="1" cellspacing="1">
  <tbody>
    <tr style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 9px; text-align: center;">
      ...
      <?php } else { ?>
        <th width="7%" style="text-align: right" ><?php echo formatuang_dec($totaldiskon); ?></th>
        <th width="7%" style="text-align: right" ><?php echo formatuang_dec($totalppn); ?></th>
