...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tbody>
    ...
    <tr>
      <td style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; font-size: 11px;">GUDANG BMHP | DAFTAR FAKTUR PEMBELIAN</td>
    </tr>
  </tbody>
</table>
...
<table class="tabelbiasa2" width="100%"  align="left" cellpadding="1" cellspacing="1">
  <tbody>
    <?php
        ...
        $totaljumlah=0;
        $totaljumlahharga=0;
        $per1="SELECT noterima FROM pfakturheader where bhp=1 and (tglterima BETWEEN '$tanggalawal' and '$tanggalakhir') ";
 ...
 ?>
       <?php 
        foreach ($qry1->result_array() as $brs1) { 
            ...
            $per2="SELECT  pfakturheader.tglterima, pfakturheader.noterima, pfakturheader.nofak, pfakturheader.namapbf, pfakturdetail.namabarang, pfakturdetail.batch, pfakturdetail.expire, pfakturdetail.qty, pfakturdetail.harga,  pfakturdetail.diskon,  pfakturdetail.potlangsung, pfakturheader.ppn  FROM pfakturheader,pfakturdetail,mobat where pfakturheader.noterima=pfakturdetail.noterima and pfakturdetail.kodebarang=mobat.kodeobat and  (pfakturheader.tglterima BETWEEN '$tanggalawal' and '$tanggalakhir') and pfakturheader.noterima='$noterima' and pfakturdetail.hapus=0 and mobat.bhp = 1 ";
