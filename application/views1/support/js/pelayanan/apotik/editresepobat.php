...
<div class="modal fade" id="formmodal" data-backdrop="static" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false">
    ...
    <script type="text/javascript">
        ...
        function untukheader() {
            var reseptgl = new Date("<?php echo $dtheader->tglresep; ?>");
            $('#tglresep').datepicker({
                autoclose: true,
                dateFormat: 'dd-mm-yy',
                changeMonth: true,
        ...
        function prosesheader_edit() {
            ...
            modaldetailtutup();
            console.log('luar edit resepzzzzzzzzzzzz');
            $.ajax({
                url: "<?php echo site_url(); ?>/depoapotik/editheader",
                type: "GET",
                data: {
                    norep: norep,
                    tipe: tipe,
            ...
            console.log('selesai luar edit resep');
        }

        function prosesheader_nonedit() {
            var norm = $("#norm").val();
            var nama = $("#nama").val();
            var kartu = $("#kartu").val();
            var gol = $("#gol").val();
