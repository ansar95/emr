...
<script type="text/javascript">
    ...
    function cetakregis(id) {
        var win = window.open("<?php echo site_url(); ?>/sampul/buktiregisigd/" + id, '_blank');
        win.focus();
    }

    function cetakregis_sjp(id) {
        var win = window.open("<?php echo site_url(); ?>/sampul/buktiregisigd/" + id, '_blank');
        win.focus();
    }
    ...
    function buatsep(id) {
        prosesload();
        $.ajax({
            url: "<?php echo site_url(); ?>/registrasipasien/formsepigd",
            type: "GET",
            data: {
                id: id
            },
    ...
    function editsep(id) {
        prosesload();
        $.ajax({
            url: "<?php echo site_url(); ?>/registrasipasien/formsepigdedit",
            type: "GET",
            data: {
                id: id
            },
    ...
    function hapussep(id) {
        prosesload();
        $.ajax({
            url: "<?php echo site_url(); ?>/registrasipasien/formhapusigd",
            type: "GET",
            data: {
                id: id
            },
    ...
    function buatspri(id) {
        prosesload();
        $.ajax({
            url: "<?php echo site_url(); ?>/registrasipasien/formspri",
            type: "GET",
            data: {
                id: id
            },
    ...
    function editspri(id) {
        prosesload();
        $.ajax({
            url: "<?php echo site_url(); ?>/registrasipasien/formspriedit",
            type: "GET",
            data: {
                id: id
            },
    ...
    function hapusspri(id) {
        prosesload();
        $.ajax({
            url: "<?php echo site_url(); ?>/registrasipasien/formsprihapus",
            type: "GET",
            data: {
                id: id
            },
