...
function load_data(page) {
            ...
            cari.addEventListener('click', function(){
                ...
                console.log(key1);
                    $.ajax({
                        url:"<?php echo site_url();?>/masterfarmasi/paginationbhp/"+"1",
                        method:"GET",
                        data: {key1: key1},
                        dataType:"json",
                        success:function(data) {
                            $('#tablebhp').html(data.obat);
            ...
            $.ajax({
                url:"<?php echo site_url();?>/masterfarmasi/paginationbhp/"+page,
                method:"GET",
                data: {key1: key1},
                dataType:"json",
                success:function(data) {
        ...
        $(document).ready(function () {
            ...
            $("#tambahbhp").click(function(e) {
                modaltable();
                $.ajax({
                    url: "<?php echo site_url();?>/masterfarmasi/panggiltambahbhp",
                    type: "GET",
        ...
        function panggiledit(id) {
            modaltable();
            $.ajax({
                url: "<?php echo site_url();?>/masterfarmasi/panggileditbhp",
                type: "GET",
                data: {id: id},
                success: function (ajaxData) {
                    $("#formmodal").html(ajaxData);
