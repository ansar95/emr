...
<script type="text/javascript">
    ...
    function lanjutproses() {
        ...
        $.ajax({
            url: "<?php echo site_url();?>/ampra_rt/caritglorder",
            type: "GET",
            data: {
                unit: unit,
                unittext: unittext,
    ...
    function detailbydate() {
        var unit = $("#unit").val();
        $.ajax({
            url: "<?php echo site_url();?>/ampra_rt/ambildatatanggalamprabhp",
            type: "GET",
            data: {
                tgl: tglaktif,
                unit:unit
    ...
    function addampra() {
        modaldetail();
        $.ajax({
            url: "<?php echo site_url();?>/ampra_rt/tambahamprabhp",
            type: "GET",
            data: {
                tgl: tglaktif
            },
    ...
    function panggileditdetail(id) {
        modaldetail();
        $.ajax({
            url: "<?php echo site_url();?>/ampra_rt/editamprabhp",
            type: "GET",
            data: {
                id: id,
                tgl: tglaktif
        ...
        $.confirm({
            ...
            buttons: {
                hapus: {
                    ...
                    action: function(){
                        $.ajax({
                            url: "<?php echo site_url();?>/ampra_rt/hapusamprabhp",
                            type: "GET",
                            data: {
                                id: id
                            },
