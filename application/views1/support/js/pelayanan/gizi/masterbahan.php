...
<script type="text/javascript">
	function load_country_data(page) {
		modaltable();
		$.ajax({
			url:"<?php echo site_url();?>/gizi/paginationbahan/"+page,
			method:"GET",
			dataType:"json",
			success:function(data) {
				$('#tablebahan').html(data.country_table);
	...
	$(document).ready(function () {
		...
		$("#tambahbahan").click(function(e) {
			modaltable();
			$.ajax({
				url: "<?php echo site_url();?>/gizi/panggiltambahbahan",
				type: "GET",
	...
	function panggiledit(id) {
		modaltable();
		$.ajax({
			url: "<?php echo site_url();?>/gizi/panggileditbahan",
			type: "GET",
			data: {id: id},
			success: function (ajaxData){
				$("#formmodal").html(ajaxData);
