...
<script type="text/javascript">
	...
	function load_data(page) {
		...
		cari.addEventListener('click', function(){
			...
			console.log(key1);
                $.ajax({
                    url:"<?php echo site_url();?>/masterdata/paginationruang/"+"1",
                    method:"GET",
                    data: {key1: key1},
                    dataType:"json",
        ...
        $.ajax({
                    url:"<?php echo site_url();?>/masterdata/paginationruang/"+page,
                    method:"GET",
                    data: {key1: key1},
                    dataType:"json",
                    success:function(data) {
	...
	$(document).ready(function () {
		...
		$("#tambahruang").click(function(e) {
			modaltable();
			$.ajax({
				url: "<?php echo site_url();?>/masterdata/panggiltambahruang",
				type: "GET",
    ...
    function panggiledit(id) {
        modaltable();
        $.ajax({
            url: "<?php echo site_url();?>/masterdata/panggileditruang",
            type: "GET",
            data: {id: id},
            success: function (ajaxData){
                $("#formmodal").html(ajaxData);
        ...
        $.confirm({
            ...
            buttons: {
                ...
                hapus: {
                    ...
                    action: function(){
                        $.ajax({
                            url: "<?php echo site_url();?>/masterdata/deletedataruang",
                            type: "GET",
                            data : {
                                id: id
                            },
