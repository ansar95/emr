    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header p-1 pl-3 align-text-bottom">
                <b class="modal-title" id="exampleModalLabel">Tambah Data Master BHP</b>
            ...
            <div class="modal-body">
                <div class="row ">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row col-spacing-row">
                            <label class="col-md-3 col-form-label">Satuan Stok</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row col-spacing-row">
                            <label class="col-md-3 col-form-label">Isi Satuan Pakai per Stok</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row col-spacing-row">
                            <label class="col-md-3 col-form-label">Kemasan</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="kemasan" id="kemasan" value="0">
                            </div>
                        </div>
                        <div class="form-group row col-spacing-row">
                            <label class="col-md-3 col-form-label">Komposisi</label>
                            <div class="col-md-9">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group row col-spacing-row">
                            <label class="col-md-3 col-form-label">Generik</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row col-spacing-row">
                            <label class="col-md-3 col-form-label">harga Dasar</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="hrgdasar" id="hrgdasar" value="0">
                            </div>
                        </div>
                        <div class="form-group row col-spacing-row">
                            <label class="col-md-3 col-form-label">Harga Umum</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="hrgumum" id="hrgumum" value="0">
                            </div>
                        </div>
                        <div class="form-group row col-spacing-row">
                            <label class="col-md-3 col-form-label">Saldo Minimum</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="saldo" id="saldo" value="0">
                            </div>
                        </div>
                        <div class="form-group row col-spacing-row">
                            <label class="col-md-3 col-form-label">Prinsipal</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row col-spacing-row">
                            <label class="col-md-3 col-form-label">PBF</label>
                            <div class="col-md-9">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#simpanunit").click(function(e) {
                ...
                $.ajax({
                    url: "<?php echo site_url(); ?>/masterfarmasi/simpandatabhp",
                    type: "GET",
                    data: {
                        kd: kd,
                        nm: nm,
...
?>
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <!-- <div class="box box-default box-solid" id="proseskotak"> -->
            <div class="modal-header p-1 pl-3 align-text-bottom">
                <b class="modal-title" id="exampleModalLabel">Edit Master BHP</b>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                        ...
                        <div class="form-group row col-spacing-row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control prov" style="width: 100%;" name="satuanstok" id="satuanstok">
                                    ...
                                    foreach ($dtsatuan as $row) {
                                    ?>
                                        <option value="<?php echo $row->id; ?>" <?php if ($dtobat->satuanstok == $row->satuanobat) {
                                                                                    echo "selected";
                                                                                } ?>><?php echo $row->satuanobat; ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="form-group row col-spacing-row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control prov" style="width: 100%;" name="satuanpakai" id="satuanpakai">
                                    ...
                                    foreach ($dtsatuan as $row) {
                                    ?>
                                        <option value="<?php echo $row->id; ?>" <?php if ($dtobat->satuanpakai == $row->satuanobat) {
                                                                                    echo "selected";
                                                                                } ?>><?php echo $row->satuanobat; ?></option>
                                    <?php
                                    }
                        ...
                        <div class="form-group row col-spacing-row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control prov" style="width: 100%;" name="gol" id="gol">
                                    ...
                                    foreach ($dtgol as $row) {
                                    ?>
                                        <option value="<?php echo $row->idjns; ?>" <?php if ($dtobat->idgolongan == $row->idjns) {
                                                                                        echo "selected";
                                                                                    } ?>><?php echo $row->jns; ?></option>
                                    <?php
                                    }
                        ...
                        <div class="form-group row col-spacing-row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control prov" style="width: 100%;" name="kla" id="kla">
                                    ...
                                    foreach ($dtkla as $row) {
                                    ?>
                                        <option value="<?php echo $row->idjns; ?>" <?php if ($dtobat->idklasifikasi == $row->idjns) {
                                                                                        echo "selected";
                                                                                    } ?>><?php echo $row->jns; ?></option>
                                    <?php
                                    }
                        ...
                        <div class="form-group row col-spacing-row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control prov" style="width: 100%;" name="gen" id="gen">
                                    ...
                                    foreach ($dtgen as $row) {
                                    ?>
                                        <option value="<?php echo $row->idjns; ?>" <?php if ($dtobat->idgenerik == $row->idjns) {
                                                                                        echo "selected";
                                                                                    } ?>><?php echo $row->jns; ?></option>
                                    <?php
                                    }
                        ...
                        <div class="form-group row col-spacing-row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control prov" style="width: 100%;" name="merk" id="merk">
                                    ...
                                    foreach ($dtmerk as $row) {
                                    ?>
                                        <option value="<?php echo $row->idmerk; ?>" <?php if ($dtobat->merk == $row->merk) {
                                                                                        echo "selected";
                        ...
                        <div class="form-group row col-spacing-row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control prov" style="width: 100%;" name="pbf" id="pbf">
                                    ...
                                    foreach ($dtpbf as $row) {
                                    ?>
                                        <option value="<?php echo $row->id; ?>" <?php if ($dtobat->idvendor == $row->id) {
                                                                                    echo "selected";
    ...
    <script>
        ...
        function editdata(id) {
            ...
            var pbftext = $("#pbf option:selected").text();
            $.ajax({
                url: "<?php echo site_url(); ?>/masterfarmasi/editdatabhp",
                type: "GET",
                data: {
                    id: id,
                    kd: kd,
