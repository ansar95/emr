        ...
        <div class="box box-default box-solid" id="kotakform">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <select class="form-control" style="width: 100%;" name="produk" id="produk" onchange="tampilkanTextarea()">
                            ...
                            ?>
                            <option value="CATAT">Racikan (Teks)</option>
                        </select>
                    </div>
                </div>
                ...
                <div id="catatanRacikanContainer" style="display: none;">
                    <div class="form-group row">
                        <label for="catatanRacikan" class="col-sm-2 col-form-label">Catatan Racikan</label>
                        <!-- <label for="catatanRacikan">Catatan Racikan:</label> -->
                        <div class="col-sm-10">
                            <textarea class="form-control" name="catatanRacikan" id="catatanRacikan" rows="5"></textarea>
                        </div>
                    </div>
                </div>
