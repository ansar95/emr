...
<div class="card">
	...
	<div class="col-md-12">
		<div class="form-group row col-spacing-row mt-2">
			...
			<div class="col-md-10">
				<input type="text" id="diagpreoperasi" name="diagpreoperasi" class="form-control border-secondary" value="<?php echo $dtlaporanopr->diagpreoperasi; ?>" disabled>
			</div>
		</div>
	</div> 
	<div class="col-md-12">
		<div class="form-group row col-spacing-row mt-2">
			...
			<div class="col-md-10">
				<input type="text" id="diagnosapost" name="diagnosapost" class="form-control border-secondary" value="<?php echo $dtlaporanopr->diagnosapost; ?>" disabled>
			</div>
		</div> 
	</div> 
	<div class="col-md-12">
