    ...
    <div class="modal-content">
        <div class="box box-default box-solid" id="kotakform">
            ...
            <div class="form-group row">
                    <label for="kode_unit_tujuan" class="col-sm-2 col-form-label text-left">Dokter Konsul</label>
                    <div class="col-sm-9">
                        <select class="form-control" style="width: 100%;" name="kode_dokter_tujuan" id="kode_dokter_tujuan">
                            ...
                            ?>
                                <option value="<?php echo $row->kode_dokter?>" <?php if ($dtkonsulid->kode_dokter_jawab==$row->kode_dokter) {echo "selected";} ?>><?php echo $row->nama_dokter;?></option>
                            <?php
                            }
                            ?>
                        </select>
            ...
            <div class="col-md-12">
				<textarea rows="7" name="konsul" id="konsul" class="form-control"><?php echo $dtkonsulid->konsul;?></textarea>
			</div>
