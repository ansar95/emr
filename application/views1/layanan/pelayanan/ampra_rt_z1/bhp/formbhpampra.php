        ...
        <div class="form-horizontal">
            <div class="box box-default box-solid" id="kotakform">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Tambah Ampra</h4>
                </div>
                    ...
                    <div class="box-body">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <button type="button" class="btn-sm btn-default" onclick="tanggalbaru()">Baru</button>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label">Nama Item BHP/Obat</label>
                                <div class="col-sm-8">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#sat').select2();
        // $('#tgl').datepicker({ autoclose: true }).datepicker("setDate", "0");
        $('#tgla').datepicker({ autoclose: true }).datepicker("setDate", "0");
        ...
        $("#simpan").click(function(e) {
            ...
            $.ajax({
                url: "<?php echo site_url();?>/ampra_rt/simpanamprabhp",
                type: "GET",
                data: {
                    unit: unit,
                    unittext: unittext,
        ...
        <div class="form-horizontal">
            <div class="box box-default box-solid" id="kotakform">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Ubah Ampra</h4>
                </div>
                <div class="modal-body">
                    <div class="box-body">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" name="id" id="id" value="<?php echo $dtdetail->id; ?>" hidden/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label">Nama Item BHP/Obat</label>
                ...
                <div class="modal-footer">
                    <a id="simpan" class="btn btn-primary">Ubah</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#tgl').datepicker({ autoclose: true, dateFormat: "mm/dd/yyyy" }).datepicker("setDate", tgl_order);
        ...
        $("#simpan").click(function(e) {
            ...
            $.ajax({
                url: "<?php echo site_url();?>/ampra_rt/ubahamprabhp",
                type: "GET",
                data: {
                    id: id,
                    tgl: tgl,
