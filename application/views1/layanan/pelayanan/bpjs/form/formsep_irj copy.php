                    ...
                    <div class="row spacing-row">
                        <div class="col-md-12">
                            <div class="row form-group" id="divPoli">
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control" name="txtkdpoli" id="txtkdpoli" value="<?php echo $rujukan['rujukan']['poliRujukan']['kode'];?>">
                                </div>   
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row spacing-row">
                        <div class="col-md-12">
                            <div class="row form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control" name="kodeasalrujukan" id="kodeasalrujukan" value="<?php echo '1';?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row spacing-row">
                        <div class="col-md-12">
                            <div class="row form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control" name="kodeppkrujukan" id="kodeppkrujukan"  value="<?php echo $rujukan['rujukan']['provPerujuk']['kode'];?>">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                    <div class='input-group date'>
                                        ...
                                        <input type="text" id="txttglrujukan" name="txttglrujukan" value="<?php echo $rujukan['rujukan']['tglKunjungan']?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row spacing-row">
                        <div class="col-md-12">
                            <div class="row form-group">
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control" id="txtkddiagnosa" value="<?php echo $rujukan['rujukan']['diagnosa']['kode'];?>">
                                </div> 
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row spacing-row">
                        <div class="col-md-12">
                            <div class="row form-group" id="divkatarak">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <p class="text-muted well well-sm no-shadow"><input type="checkbox" id="chkkatarak" name="chkkatarak">    Centang Katarak <i class="fa fa-check"></i>, Jika Peserta Tersebut Mendapatkan Surat Perintah Operasi katarak</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row spacing-row">
                        <div class="col-md-12">
                            <div class="row form-group" id="divPoli">
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control" name="txtkdpoli" id="txtkdpoli" value="<?php echo $dtsep->poli;?>">
                                </div>   
                            </div>
                        </div>
                    </div>
                    <div class="row spacing-row">
                        <div class="col-md-12">
                            <div class="row form-group" id="divPoli">
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control" name="txtkddpjp" id="txtkddpjp" value="<?php echo $dtsep->kodedokterbpjs;?>">
                                </div>   
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row spacing-row">
                        <div class="col-md-12">
                            <div class="row form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control" name="kodeppkrujukan" id="kodeppkrujukan"  value="<?php echo $dtsep->ppk_rujukan;?>">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                    <div class='input-group date'>
                                        ...
                                        <input type="text" id="txttglrujukan" name="txttglrujukan" value="<?php echo $dtsep->tgl_rujukan;?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
