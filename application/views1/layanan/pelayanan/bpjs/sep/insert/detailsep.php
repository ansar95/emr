                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="row spacing-row">
                                                <div class="col-md-12">
                                                    <div class="row form-group" id="divPoli">
                                                        ...
                                                        <div class="col-md-7">
                                                            <select class="form-control"name="txtnmpoli" id="txtnmpoli" onchange="pilihpoli()">
                                                            </select>
                                                        </div>    
                                                        <div class="col-md-2">
                                                            <input type="text" class="form-control" id="txtkdpoli">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            ?>
                                                <div class="form-group">
                                                    <label class="col-md-3 col-sm-3 col-xs-12 col-form-label">No. Surat Kontrol/SKDP <label style="color:red;font-size:small">*</label></label>
                                                ...
                                                <div class="form-group" id="divDPJP">
                                                    <label class="col-md-3 col-sm-3 col-xs-12 col-form-label">DPJP Pemberi Surat SKDP/SPRI<label style="color:red;font-size:small">*</label></label>
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                                            <div class='input-group date'>
                                                                <input type='date' class="form-control datepicker" id="txttglsepkode" placeholder="yyyy-MM-dd" maxlength="10" value="<?php echo $txtTanggal?>"  />
                                                        ...
                                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-addon">
                                                                    <label class="control-label"><input type="checkbox" id="chkCOB" name="chkCOB" disabled> Peserta COB</label>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
