                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row col-spacing-row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $dtheader->nama ?>" autocomplete="off" />
                                    </div>
                                </div>
                                <div class="form-group row col-spacing-row">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <?php 
                                            $sel = '';
                                            if ($row->id==$dtpotongan[0]->id_potongan) {
                                                $sel = 'selected="selected"';
                                            }
                                        ?>
                                        
                                            <option value="<?php echo $row->id; ?>" <?php echo $sel; ?>><?php echo $row->nama_potongan; ?> (<?php echo $row->persentase_potongan ?>%)</option>
                                        <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                            ...
                                            $nob = 1;
                                            $jum = 0;
                                            $dtpotongan = $persen_potongan = (int)$dtpotongan[0]->persentase_potongan;
                                ...
                                <?php
                                            ...
                                            $dtpotongan = ($jum/100) * $dtpotongan;
                                            $total = $jum - $dtpotongan;
