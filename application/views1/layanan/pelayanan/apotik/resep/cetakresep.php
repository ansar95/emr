  ...
  <tr>
    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
          <tr class="style15">
            ...
            <td style='text-align:right'><span class="style16">Harga</span></td>
            <td style='text-align:right'><span class="style16">Jumlah (Rp)</span></td>
          </tr>
        <?php
          $i=1;
          $total=0;
          ...
          foreach ($qry2->result_array() as $brs2) {
            ...
            $jumlah=$brs2['hargapakai']*$brs2['qty'];
            $total=$total+$jumlah;
        ?>
          <tr class="style15">
            <td width="6%" style='text-align:center'><?php echo $i++;?></td>
            <td width="52%"><?php echo $brs2['namaobat'];?></td>
            <td width="8%" style='text-align:center'><?php echo $brs2['qty'];?></td>
            <td width="14%" style='text-align:right'><?php echo formatuang($brs2['hargapakai']);?></td>
            <td width="18%" style='text-align:right'><?php echo formatuang($jumlah);?></td>
          </tr>
         
        <?php } ?>
          <tr class="style15">
            <td colspan="4" style='text-align:center'><div align="right">Jumlah Harga </div></td>
            <td style='text-align:right'><?php echo formatuang($total);?></td>
          </tr>
    </table></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="70%">&nbsp;</td>
        <td width="30%"><span class="style16">Paraf Petugas,</span></td>
      </tr>
      <!-- <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><span class="style16"><?php echo $noserep;?></span></td>
      </tr> -->
    </table></td>
  </tr>
</table>
