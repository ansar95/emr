                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="custom-control custom-checkbox custom-control-inline">
                            ...
                            <label class="custom-control-label" for="noina">Non INACBG</label>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#simpanunit").click(function(e) {
                ...
                $.ajax({
                    url: "<?php echo site_url(); ?>/depoapotikresep/simpandepo",
                    type: "GET",
                    data: {
                        tipe: tipe,
                        shift: shift,
...
?>
    ...
    <script>
        ...
        function ubah(id) {
            ...
            $.ajax({
                url: "<?php echo site_url(); ?>/depoapotikresep/editdepo",
                type: "GET",
                data: {
                    id: id,
                    norep: norep,
