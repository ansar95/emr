                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-1 d-flex align-items-end flex-column">
                                <button class='btn  btn-primary mt-auto' type='button' onclick="ambildata()" />Tampilkan</button>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row mt-2 mb-2">
                            <div class="col">
                                <button onclick="addresep()" class="btn-sm btn-warning btn"><i class='glyphicon glyphicon-plus'></i> Resep Baru</button>
