...
if ($formpilih == 0) {
        ...
        <div class="modal-content" >
            <div class="form-horizontal">
                <div class="box box-default box-solid" id="kotakform">
                    ...
                    <h5 class="modal-title">Tambah Data Master BHP</h5>
    ...
    <div class="modal-dialog modal-xl" style="width:1200px;">
        <div class="modal-content" >
            <div class="form-horizontal">
                <div class="card card-default box-solid" id="kotakform">
                    <div class="modal-header">
                    <h4 class="modal-title">Edit Master BHP</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                        ...
                        <div class="card-body">
                            <div class="col-sm-12  row col-spacing-row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group row col-spacing-row">
                                        <label class="col-sm-3 control-label">Isi Satuan Pakai per Stok</label>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="form-group row col-spacing-row">
                                        <label class="col-sm-3 control-label">Komposisi</label>
                                        <div class="col-sm-9">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group row col-spacing-row">
                                        <label for="inputEmail3" class="col-sm-3 control-label">Generik</label>
                                        <div class="col-sm-6">
                                            <select class="form-control prov" style="width: 100%;" name="gen" id="gen">
                                                <?php
                                                foreach($dtgen as $row) {
                                    ...
                                    <div class="form-group row col-spacing-row">
                                        <label for="inputEmail3" class="col-sm-3 control-label">Prinsipal</label>
                                        <div class="col-sm-6">
                                            <select class="form-control prov" style="width: 100%;" name="merk" id="merk">
                                                <?php
                                                foreach($dtmerk as $row) {
                                    ...
                                    <div class="form-group row col-spacing-row">
                                        <label for="inputEmail3" class="col-sm-3 control-label">PBF</label>
                                        <div class="col-sm-6">
                                            <select class="form-control prov" style="width: 100%;" name="pbf" id="pbf">
                                                <?php
                                                foreach($dtpbf as $row) {
