			...
			<div class="col-12">
				<div class="card">
					<div class="card-header d-flex justify-content-between align-items-center">
						<h4 class="mb-0">Laporan Pasien Diagnosa TB</h4>
					</div>
					<div class="card-body">
						<form target="_blank" action="<?php echo site_url(); ?>/sitb/panggilcetak" method="post">
							<div class="row justify-content-center">
								...
								<div class="col-md-2">
									<div class="input-group  mb-3">
										...
										<input type="text" class="form-control pull-right" id="tglmulai" name="tglmulai" required autocomplete='off'>
									</div>
								</div>
								...
								<div class="col-md-2">
									<div class="input-group  mb-3">
										...
										<input type="text" class="form-control pull-right" id="tglselese" name="tglselese" require autocomplete='off'>
									</div>
								</div>
							</div>
