					...
					<div class="row spacing-row mb-3 mt-1">
						<div id="accordionassesment">
							<div id="collapseassesment" class="collapse" aria-labelledby="headingassesment" data-parent="#accordionassesment">
								...
								<form id="myForm">
									<div class="col-md-12">
									<h6><span style="color: red;">ASESMEN AWAL RAWAT JALAN</span></h6>
									<div class="row mt-1 mb-1">
										<div class="col-md-6 text-left">
											<button type="button" id="disableButton" class="btn btn-primary">Update Asesmen</button>
										</div>
									</div>
						...
						<div id="accordion_soap">
							<div d="soap_his">
								<h6 class="mb-0">
									...
									<span style="color: red; font-style: italic;">History SOAP</span>
									</button>
								</h6>
							</div>
...
function simpanassesmen(){
	...
	var assKeluhanutama = document.getElementById("assKeluhanutama").value;
	var assRiwayatsekarang = document.getElementById("assRiwayatsekarang").value;
	
	var assalergiTidak = document.getElementById("assalergiTidak").value;
	var assalergiYa = document.getElementById("assalergiYa").value;

	var assRiwayatdahulu = document.getElementById("assRiwayatdahulu").value;

	var assAlergi = document.getElementById("assAlergi").value;
	var assKesadaran = document.getElementById("assKesadaran").value;
	var assKesadaranlainnya = document.getElementById("assKesadaranlainnya").value;
	var assKesadaranumum = document.getElementById("assKesadaranumum").value;
	var assSuhu = document.getElementById("assSuhu").value;

	var assTinggi = document.getElementById("assTinggi").value;
	var aasBerat = document.getElementById("aasBerat").value;
	var assTensi = document.getElementById("assTensi").value;
	var aasNadi = document.getElementById("aasNadi").value;
	var assRespirasi = document.getElementById("assRespirasi").value;
	var assSpo2 = document.getElementById("assSpo2").value;
	var assGcs = document.getElementById("assGcs").value;
		
					
$.ajax({
	// url: siteURL + "/urj/simpandatasoap",
	url: siteURL + "/rme/simpandataassesmen",
	type: "GET",
	data : {id: id,
