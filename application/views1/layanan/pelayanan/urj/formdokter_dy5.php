				...
				<div class="card-body">
					...
					<div class="row spacing-row mb-3 mt-3">
						<div id="accordionassesment">
							<div id="collapseassesment" class="collapse show" aria-labelledby="headingassesment" data-parent="#accordionassesment">
<!-- =============== -->
							<div class="col-md-12 mt-4">
							<h6><span style="color: red;">ASSESMEN AWAL RAWAT JALAN</span></h6>
							<h6><span style="color: black; font-style: italic;">Anamnesis</span></h6>
									...
									<div class="form-group row col-spacing-row">
										...
										<div class="col-md-5">
											<div class="form-check  form-check-inline">
												<input class="form-check-input" type="checkbox" id="tidakCheckbox">
												<label class="form-check-label" for="tidakCheckbox">Tidak</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input" type="checkbox" id="yaCheckbox">
												<label class="form-check-label" for="yaCheckbox">Ya, Sebutkan</label>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group row col-spacing-row">
										...
										<div class="col-md-10">
											<input type="text" class="form-control" disabled name="kesadaranumum" id="kesadaranumum" >
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group row col-spacing-row">
										...
										<div class="col-md-10">
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="radio" id="kandung">
												<label class="form-check-label col-form-label" for="kandung">Kandung, Jumlah   </label>
											</div>
											<div class="form-check form-check-inline">
												<input type="text" class="form-control col-form-label" disabled name="jumlahkandung" id="jumlahkandung" >
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="radio" id="yaCheckbox">
												<label class="form-check-label col-form-label" for="yaCheckbox">Tiri, Jumlah</label>
											</div>
											<div class="form-check form-check-inline">
												<input type="text" class="form-control col-form-label" disabled name="jumlahtiri" id="jumlahtiri" >
											</div>
										</div>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group row col-spacing-row">
										...
										<div class="col-md-10">
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="kandung">
												<label class="form-check-label col-form-label" for="kandung">Orang tua   </label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="yaCheckbox">
												<label class="form-check-label col-form-label" for="yaCheckbox">Lainnya, jelaskan</label>
											</div>
								...
								<div class="col-md-12">
									<div class="form-group row col-spacing-row">
										...
										<div class="col-md-10">
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="kandung">
												<label class="form-check-label col-form-label" for="kandung">Jelas</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="yaCheckbox">
												<label class="form-check-label col-form-label" for="yaCheckbox">Tidak dapat di mengerti</label>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-md-12">
									<div class="form-group row col-spacing-row">
										...
										<div class="col-md-10">
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="kandung">
												<label class="form-check-label col-form-label" for="kandung">Verbal</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="yaCheckbox">
												<label class="form-check-label col-form-label" for="yaCheckbox">Non Verbal</label>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-md-12">
									<div class="form-group row col-spacing-row">
										...
										<div class="col-md-10">
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="kandung">
												<label class="form-check-label col-form-label" for="kandung">Stabil</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="yaCheckbox">
												<label class="form-check-label col-form-label" for="yaCheckbox">Tenang</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="kandung">
												<label class="form-check-label col-form-label" for="kandung">Cemas</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="yaCheckbox">
												<label class="form-check-label col-form-label" for="yaCheckbox">Takut</label>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group row col-spacing-row">
										<label class="col-md-4 col-form-label">Riwayat pernah mengalami gangguan jiwa</label>
										<div class="col-md-8">
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="kandung">
												<label class="form-check-label col-form-label" for="kandung">Tidak</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="yaCheckbox">
												<label class="form-check-label col-form-label" for="yaCheckbox">Ya, Tahun  </label>
											</div>
											<div class="form-check form-check-inline">
												<input type="text" class="form-control col-form-label" disabled name="jumlahtiri" id="jumlahtiri" >
											</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group row col-spacing-row">
										<label class="col-md-2 col-form-label">Riwayat Tauma</label>
										<div class="col-md-10">
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="kandung">
												<label class="form-check-label col-form-label" for="kandung">Tidak Ada</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="kandung">
												<label class="form-check-label col-form-label" for="kandung"> Aniaya Fisik</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="kandung">
												<label class="form-check-label col-form-label" for="kandung"> Psikologi</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="kandung">
												<label class="form-check-label col-form-label" for="kandung">KDRT</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="kandung">
												<label class="form-check-label col-form-label" for="kandung">Aniaya Sex/Perkosaan</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="yaCheckbox">
												<label class="form-check-label col-form-label" for="yaCheckbox">Tindakan Kriminal, Sebutkan  </label>
											</div>
											<div class="form-check form-check-inline">
												<input type="text" class="form-control col-form-label" disabled name="jumlahtiri" id="jumlahtiri" >
											</div>
								...
								<div class="col-md-12">
									<div class="form-group row col-spacing-row">
										...
										<div class="col-md-10">
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="kandung">
												<label class="form-check-label col-form-label" for="kandung">Sedih</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="yaCheckbox">
												<label class="form-check-label col-form-label" for="yaCheckbox">Putus Asa </label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="kandung">
												<label class="form-check-label col-form-label" for="kandung">Ketakutan</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input col-form-label" type="checkbox" id="yaCheckbox">
												<label class="form-check-label col-form-label" for="yaCheckbox">Gembira Berlebihan</label>
											</div>
										</div>
									</div>
								</div>
