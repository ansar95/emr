			...
			<div class="card">
				<div class="col-md-12">
					<div class="row spacing-row">
																	...
																	?>
																		<tr onclick="addResep('<?php echo $row->id; ?>', '<?php echo $row->kodeobat; ?>')">
																			...
																			<td width="98%">
																				...
																				echo $row->qty.' '.$row->takaran.' | '.'<br>';
																				echo tanggaldua($row->tglresep) .' | '.$row->nama_dokter. '<br>';;
																				echo "<br>";	
																				?>
																			</td>
																		</tr>
							...
							<div class="col-md-3 mt-4" id="order">
								<div id="accordion47" class="accordion-alt" role="tablist" style="background-color: #D3D3D3;">
									<div class="mb-2">
										<h6 class="mb-0">
										...
										<div class="table-responsive mt-2 table-hover table-scrollable" id="isirad" style="max-height: 350px; overflow-y: auto;">
											<table class="table" id="tabelhasil" style="background-color: #FFE4C4;">
															<tbody>
																<?php
																if ($dthasilinstalasi == NULL) {
																?>
																	<tr>
																		<td colspan="100%" class="text-center">
																			Belum Ada Data
																	...
																	$no = 1;
																	$jmlt = 0;
																	foreach ($dthasilinstalasi as $row) {
																		// $kode_dokter_resep=$row->kode_dokter;
																		if ($row->kode_unit == 'LABS') {
																			$backgroundColor = 'background-color: blue;'; // Warna biru untuk kode_unit 'LABS'
																		} elseif ($row->kode_unit == 'RDGL') {
																			$backgroundColor = 'background-color: green;'; // Warna hijau untuk kode_unit 'RDGL'
																		}
																	?>
																		 <tr onclick="bukaFormHasil('<?php echo $row->id; ?>')" style="border-bottom: 1px solid #0099CC;">
																			<td>
																				<?php 
																				echo '<strong style="color: red; font-size: 11px;">' . tanggaldua($row->tanggal) .' | '.$row->nama_unit.'</strong><br>';
																				echo 'Unit Pemesan : '.$row->nama_unit_pemesan.'<br>';
																				echo 'Dokter Pemesan : '.$row->nama_dokter.'<br>';
																				echo "<br>";	
																				?>
																			</td>
																			<!-- ini diambil dari form dokter sebelumnya -->
									...
									<div class="mt-2">
										...
										<div id="collapse471" class="collapse" role="tabpanel" data-parent="#accordion2">
											...
											<div class="table-responsive mt-2 table-hover table-scrollable" id="isidatarambahan">
												...
												<button onclick="tambahMasterRacik()" class="btn btn-sm btn-secondary ml-2" id="tombolSEP" name="tombolLain" style="background-color: #FF9900; color: white;">CEK SEP / SJP</button>
												<br>
												<br>
												<button onclick="resumeMedis()" class="btn btn-sm btn-secondary ml-2" id="tombolresumemedis" name="tombolLain" style="background-color: #CC0033; color: white;">RESUME MEDIS</button>
												<br>
												<br>
												<div class="form-inline mt-4">
													<label style="font-size: 14px; font-weight: bold; color: black;">+ Master Data Obat Racikan</label>
													<!-- <button onclick="tambahMasterRacik()" class="btn btn-sm btn-secondary ml-2" id="tombolMasterRacikan" name="tombolLain" style="background-color: #009933; color: white;">Tambah</button> -->
												...
												<!-- <div class="table-responsive mt-1 table-hover table-scrollable" id="isimasterracik"> -->
													...
													<tbody>
														...
														?>			
																		<tr>
																			<td colspan="2">
																				<?php
																					echo '<span style="margin-left: 2ch;"></span> <strong style="color: red;font-size: 12px;">'.'> ' . strtoupper($row->nama_racikan).'</strong><br>';
																				?>
																			<td>	
																		</tr>
														<?php 	
