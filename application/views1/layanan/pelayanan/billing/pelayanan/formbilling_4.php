                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="st" id="st" value="0" checked>
                                            Dalam Perawatan
                                        </label>
                                    </div>
                                    <div class="radio">
				...
				<div class="modal-footer">
					<div class="row">
						<div class="col-sm-12">
                            ...
                            <button type="button" onclick="cetakpostingrekap()" class="btn btn-primary btn-flat btn-sm">Rekap Billing Terjamin</button>
                            <button type="button" onclick="cetakposting()" class="btn btn-primary btn-flat btn-sm">Billing Terjamin</button>
						</div>
					</div>
				</div>
			</div>
