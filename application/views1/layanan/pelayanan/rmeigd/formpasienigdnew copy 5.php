				...
				<div class="col-md-11">
					<div class="card-body">
						...
						<input class="form-control" id="kode_dokter" type="hidden"
							value="<?php echo $this->session->userdata("kodedokter"); ?>">
						...
						<!-- <input class="form-control" id="tgl_masuk" type="text" value="<?php echo $editing ?>"> -->

						<!-- untuk cek pembacaan form agar 1x saja di baca -->
						<!-- <input type="text" class="form-control" name="cektriase" id="cektriase" maxlength="1" value='0'>
						<input type="text" class="form-control" name="cekasmed" id="cekasmed" maxlength="1" value='0'>
						<input type="text" class="form-control" name="cekaskep" id="cekaskep" maxlength="1" value='0'>
						<input type="text" class="form-control" name="cekpersalinan" id="cekpersalinan" maxlength="1" value='0'>
						<input type="text" class="form-control" name="cekobat" id="cekobat" maxlength="1" value='0'> -->
						<p>
			...
			<div class="tab-pane fade show" id="tabutama" role="tabpanel2">
				<nav>
					<div class="nav nav-tabs" id="subnav12" role="tablist2">
						...
						<a class="nav-item nav-link" id="subtabpartograp" data-toggle="tab" data-target="#partograp"
							href="#partograp" role="tab" aria-controls="subnav12-22" aria-selected="false"
							style="border: 1px solid #ABB2B9;">Partograp</a>
					</div>
									...
									<div class="row spacing-row">
												...
												<div class="mb-2">
													...
													<div id="collapseResep" class="collapse  mt-3">
														...
														<div class="table-responsive mt-2 table-hover table-scrollable"
															...
															style="max-height: 600px; overflow-y: auto;">
															<table class="table" id="tabelresep"
										...
										<div class="col-md-3 mt-5" id="hasil">
											...
											<div class="form-inline mt-3">
												<label style="font-size: 14px; font-weight: bold; color: black;">+ Order
													RESEP</label>
												<?php if ($editing == 1) { ?>
													<button onclick="tambahObat()" class="btn btn-sm btn-secondary ml-auto"
														id="tambahObatBaru" name="tambahObatBaru"
														style="background-color: #FF5733; color: white;">+ Obat</button>
													<button onclick="tambahRacik()" class="btn btn-sm btn-secondary ml-2"
														id="tombolLain" name="tombolLain"
														style="background-color: #000033; color: white;">+ Racikan</button>
												<?php } ?>
											</div>
