												...
												<div class="card-body">
													<div class="col-md-12">
														<div class="form-group row col-spacing-row">
															...
															<div class="col-md-11">
																<input class="state icheckbox_square-red" type="checkbox" id="datangSendiri" <?php echo ($dtassawal->datangsendiri == 1) ? "checked" : ""; ?> name="caraMasuk" onchange="handleCheckboxChange(this)" > Datang Sendiri
																<input class="state icheckbox_square-red ml-3" type="checkbox" id="rujukandari" <?php echo ($dtassawal->rujukandari == 1) ? "checked" : ""; ?> name="caraMasuk" class="form-check-input" onchange="handleCheckboxChange(this)"> Rujukan Dari 
																<div class="form-check form-check-inline ml-2">
																	<input type="text" class="form-control col-form-label" name="isian" id="isian" style="width: 250px;" <?php echo ($dtassawal->rujukandari == 1) ? "" : "disabled"; ?> value="<?php echo $dtassawal->isian ?>">
																</div>
															</div>
														</div>
													</div>
													...
													<div class="col-md-12">
														<div class="form-group row col-spacing-row">
															...
															<div class="col-md-11">
																	<input class="state icheckbox_square-red" type="checkbox" id="Auto" name="anamnesis" <?php echo ($dtassawal->auto == 1) ? "checked" : ""; ?> onchange="handleAnamnesisChange(this)"> Auto
																	<input class="state icheckbox_square-red ml-3" type="checkbox" id="Allo" name="anamnesis" <?php echo ($dtassawal->allo == 1) ? "checked" : ""; ?> onchange="handleAnamnesisChange(this)"> Allo
													...
													<div class="col-md-12 mt-3">
														<div class="form-group row col-spacing-row">
															...
															<div class="col-md-11">
																	<input class="state icheckbox_square-red" type="checkbox" id="alergitidak" <?php echo ($dtassawal->alergitidak == 1) ? "checked" : ""; ?> name="caraMasuk" onchange="handleAlergiChange(this)"> Tidak
																	<input class="state icheckbox_square-red ml-3" type="checkbox" id="alergiya" <?php echo ($dtassawal->alergiya == 1) ? "checked" : ""; ?> name="caraMasuk" onchange="handleAlergiChange(this)"> Ya
																<div class="form-check form-check-inline">
											...
											<div class="card-body">
												<div class="col-md-12 mt-3">
													...
													<div class="form-group row col-spacing-row mt-3">
														...
														<div class="col-md-3" style="border: 0.5px solid #000;">
															<canvas id="myCanvas" width="400" height="300"></canvas>
															<button onclick="undo()" class="btn btn-dark mb-2" data-bs-dismiss="modal">Undo</button>
															<button onclick="saveCanvasAsmed()" class="btn btn-primary mb-2" data-bs-dismiss="modal">Simpan Gambar</button>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="card-body">
												<div class="col-md-12">
													...
													<div class="form-group row col-spacing-row">
														...
														<div class="col-md-11">
															<input class="state icheckbox_square-red" type="checkbox" id="menjalartidak" name="menjalar" class="form-check-input"  <?php echo ($dtassawal->menjalartidak == 1) ? "checked" : ""; ?>   onchange="handleMenjalar(this)" > Tidak
															<input class="state icheckbox_square-red ml-3" type="checkbox" id="menjalarya" name="menjalar" class="form-check-input"  <?php echo ($dtassawal->menjalarya == 1) ? "checked" : ""; ?>   onchange="handleMenjalar(this)" > Ya, ke
															<div class="form-check form-check-inline ml-3">
																<input type="text" class="form-control col-form-label" id="menjalarke" style="width: 250px; border: 1px solid" value="<?php echo $dtassawal->menjalarke ?>" disabled>
															</div>
														</div>
													</div> 
										...
										<div class="card">
											<div class="card-body">
												<div class="col-md-12">
													<div class="form-group row col-spacing-row">
														<div class="col-md-11">
															<input class="state icheckbox_square-red" type="checkbox" id="dirawat" name="caraMasuk" class="form-check-input" onchange="handleDirawat(this)" <?php echo ($dtassawal->dirawat == 1) ? "checked" : ""; ?>> Dirawat
															<div class="form-check form-check-inline">
													...
													<div class="form-group row col-spacing-row">
														<div class="col-md-11">
															<input class="state icheckbox_square-red" type="checkbox" id="pulang" name="caraKeluar" class="form-check-input" onchange="handlePulang(this)" <?php echo ($dtassawal->pulang == 1) ? "checked" : ""; ?>> Pulang
													...
													<div class="form-group row col-spacing-row mt-3">
														...
														<div class="col-md-12">
															<div class="form-check form-check-inline">
																<div class="form-group row col-spacing-row">
																	<div class="col-md-12">
																		<input class="state icheckbox_square-red" type="checkbox" id="pasien" name="hubungan" class="form-check-input" <?php echo ($dtassawal->edukasipasien == 1) ? "checked" : ""; ?> onchange="handleEdukasi(this)"> Pasien
																		<input class="state icheckbox_square-red ml-3" type="checkbox" id="keluarga" name="hubungan" class="form-check-input" <?php echo ($dtassawal->edukasikeluarga == 1) ? "checked" : ""; ?> onchange="handleEdukasi(this)"> Keluarga
																		<input class="state icheckbox_square-red ml-3" type="checkbox" id="tidak" name="hubungan" class="form-check-input" onchange="handleEdukasi(this)"> Tidak
...
<script>
	...
	function savekondisiawal() {
			...
			var rujukandari = $("#rujukandari").prop("checked") ? 1 : 0;
			var isian = document.getElementById("isian").value;
...
<!-- perbaikan checkbook dan text book=== -->
<script>
	function handleCheckboxChange(checkbox) {
		...
		var isianText = document.getElementById("isian");

		if (checkbox.id === "datangSendiri" && checkbox.checked) {
			rujukandariCheckbox.checked = false;
			isianText.disabled = true;
			isianText.value = ""; // Mengosongkan nilai isian
		} else if (checkbox.id === "rujukandari" && checkbox.checked) {
			datangSendiriCheckbox.checked = false;
			isianText.disabled = false;
		} else {
			isianText.disabled = true;
			isianText.value = ""; // Mengosongkan nilai isian jika tidak ada checkbox yang terpilih
		}
	}
</script>
...
<script>
	function handleAnamnesisChange(checkbox) {
		var autoCheckbox = document.getElementById("Auto");
		var alloCheckbox = document.getElementById("Allo");
		var allotextInput = document.getElementById("Allotext");

		if (checkbox.id === "Auto" && checkbox.checked) {
			alloCheckbox.checked = false;
			allotextInput.disabled = true;
			allotextInput.value = ""; // Mengosongkan nilai Allotext
		} else if (checkbox.id === "Allo" && checkbox.checked) {
			autoCheckbox.checked = false;
			allotextInput.disabled = false;
		} else {
			allotextInput.disabled = true;
			allotextInput.value = ""; // Mengosongkan nilai Allotext jika tidak ada checkbox yang terpilih
		}
	}
</script>

<script>
	function handleAlergiChange(checkbox) {
		var alergitidakCheckbox = document.getElementById("alergitidak");
		var alergiyaCheckbox = document.getElementById("alergiya");
		var alergitextInput = document.getElementById("alergitext");

		if (checkbox.id === "alergitidak" && checkbox.checked) {
			alergiyaCheckbox.checked = false;
			alergitextInput.disabled = true;
			alergitextInput.value = ""; // Mengosongkan nilai alergitext
		} else if (checkbox.id === "alergiya" && checkbox.checked) {
			alergitidakCheckbox.checked = false;
			alergitextInput.disabled = false;
		} else {
			alergitextInput.disabled = true;
			alergitextInput.value = ""; // Mengosongkan nilai alergitext jika tidak ada checkbox yang terpilih
		}
	}
</script>

<script>
    function handleMenjalar(checkbox) {
        var menjalartidakCheckbox = document.getElementById("menjalartidak");
        var menjalaryaCheckbox = document.getElementById("menjalarya");
        var menjalarkeInput = document.getElementById("menjalarke");

        if (checkbox.id === "menjalartidak" && checkbox.checked) {
            menjalaryaCheckbox.checked = false;
            menjalarkeInput.disabled = true;
            menjalarkeInput.value = ""; // Mengosongkan nilai menjalarke
        } else if (checkbox.id === "menjalarya" && checkbox.checked) {
            menjalartidakCheckbox.checked = false;
            menjalarkeInput.disabled = false;
        } else {
            menjalarkeInput.disabled = true;
            menjalarkeInput.value = ""; // Mengosongkan nilai menjalarke jika tidak ada checkbox yang terpilih
        }
    }
</script>

<script>
    function handleDirawat(checkbox) {
        var dirawatCheckbox = document.getElementById("dirawat");
        ...
        var pulangCheckbox = document.getElementById("pulang");
        ...
        if (checkbox.checked) {
            ...
            pulangCheckbox.checked = false;
        } else {
            konsulInput.disabled = true;
        }
    }

    function handlePulang(checkbox) {
        var dirawatCheckbox = document.getElementById("dirawat");
        var pulangCheckbox = document.getElementById("pulang");
        var izinDokterCheckbox = document.getElementById("izinDokter");
        var permintaanSendiriCheckbox = document.getElementById("permintaanSendiri");
...
<script>
    function handleEdukasi(checkbox) {
        var pasienCheckbox = document.getElementById("pasien");
        var keluargaCheckbox = document.getElementById("keluarga");
        var tidakCheckbox = document.getElementById("tidak");
        var edukasiTidakKarenaInput = document.getElementById("edukasitidakkarena");

        if (checkbox.id === "tidak" && checkbox.checked) {
            edukasiTidakKarenaInput.disabled = false;
            pasienCheckbox.checked = false;
            keluargaCheckbox.checked = false;
        } else {
            edukasiTidakKarenaInput.disabled = true;
            edukasiTidakKarenaInput.value = "";
        }

        // Memastikan hanya satu opsi yang terpilih
        if (pasienCheckbox.checked && pasienCheckbox !== checkbox) {
            pasienCheckbox.checked = false;
        }
        if (keluargaCheckbox.checked && keluargaCheckbox !== checkbox) {
            keluargaCheckbox.checked = false;
        }
        if (tidakCheckbox.checked && tidakCheckbox !== checkbox) {
...
<script>
        ...
        function saveCanvasAsmed() {
            ...
            $.ajax({
                type: "POST",
				url: "<?php echo site_url(); ?>/rme/simpanGambarAsmed",
                data: { 
...
<script>
  // Mendapatkan referensi ke elemen canvas dan konteks gambar 2D
  var canvas = document.getElementById('myCanvas');
  var ctx = canvas.getContext('2d');
  ...
  var img = new Image();
	...
	// =============
  	...
  	// Menentukan sumber gambar, yang benar  ini dibawah
	  img.src = '../../assets/image/rm/bodyfull.jpeg';
	  img.onload = function() {
	    ctx.drawImage(img, 0, 0, canvas.width, canvas.height);
	  };
</script>
