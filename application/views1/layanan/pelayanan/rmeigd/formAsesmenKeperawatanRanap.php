							...
							<div class="card-body">
								<div class="col-md-12 mt-3">
									...
									<div class="form-group row col-spacing-row mt-1">
										<label class="col-md-8 col-form-label" style="font-weight: bold; font-size: 12px; color: #000000;"> UNTUK ANAK DAN DEWASA (Berdasarkan Malnutrition Screening Tool/MST)</label>
									</div>
									<div class="form-group row col-spacing-row">
									...
									<div class="form-group row col-spacing-row"> 
										<label class="col-md-1" style="font-weight: bold; font-size: 14px; color: #000000;"> NILAI SKOR</label>
										<div class="col-md-1">
											<input type="text" class="form-control" id="skorhasilgizi" style="font-size: 14px; border: 1px solid;">
										</div>
									</div>
									<div class="form-group row col-spacing-row mt-3">
										<label class="col-md-8 col-form-label" style="font-weight: bold; font-size: 12px; color: #000000;"> UNTUK GERIATRI (Berdasarkan MNA-SF)</label>
									</div>
									<div class="form-group row col-spacing-row">
									...
									<div class="form-group row col-spacing-row">
										<label><input type="radio" class="state iradio_square-red ml-3" id="geriasupan1" name="geriasupan" value="0" <?php if ($dtaskepranap->geriasupan == 0) {echo "checked";} ?>> Asupan makanan sangat berkurang</label>
										<label><input type="radio" class="state iradio_square-red ml-3" id="geriasupan2" name="geriasupan" value="1" <?php if ($dtaskepranap->geriasupan == 1) {echo "checked";} ?>> Asupan makanan agak berkurang</label>
										<label><input type="radio" class="state iradio_square-red ml-3" id="geriasupan2" name="geriasupan" value="2" <?php if ($dtaskepranap->geriasupan == 2) {echo "checked";} ?>> Asupan makanan tidak berkurang</label>
									</div>
									<div class="form-group row col-spacing-row">
									...
									<div class="form-group row col-spacing-row">
										<label><input type="radio" class="state iradio_square-red ml-3" id="geribb1" name="geribb" value="0" <?php if ($dtaskepranap->geribb == 0) {echo "checked";} ?>> Penurunan berat badan lebih dari 3 Kg</label>
										<label><input type="radio" class="state iradio_square-red ml-3" id="geribb2" name="geribb" value="1" <?php if ($dtaskepranap->geribb == 1) {echo "checked";} ?>> Tidak tahu</label>
										<label><input type="radio" class="state iradio_square-red ml-3" id="geribb3" name="geribb" value="2" <?php if ($dtaskepranap->geribb == 2) {echo "checked";} ?>> Penurunan berat badan antara 1 hingga 3 Kg</label>
										<label><input type="radio" class="state iradio_square-red ml-3" id="geribb4" name="geribb" value="3" <?php if ($dtaskepranap->geribb == 3) {echo "checked";} ?>> Tidka ada penurunan berat badan</label>
									</div>
									<div class="form-group row col-spacing-row">
										<label class="col-md-10 col-form-label" style="font-weight: bold; font-size: 12px; color: #000000;"> Mobilitas</label>
									</div>
									<div class="form-group row col-spacing-row">
										<label><input type="radio" class="state iradio_square-red ml-3" id="gerimobilitas1" name="gerimobilitas" value="0" <?php if ($dtaskepranap->gerimobilitas == 0) {echo "checked";} ?>> Terbatas pada tempat tidur</label>
										<label><input type="radio" class="state iradio_square-red ml-3" id="gerimobilitas2" name="gerimobilitas" value="1" <?php if ($dtaskepranap->gerimobilitas == 1) {echo "checked";} ?>> Mampu bangun dari tempat tidur / kursi tetapi tidak berpergian keluar rumah</label>
										<label><input type="radio" class="state iradio_square-red ml-3" id="gerimobilitas3" name="gerimobilitas" value="2" <?php if ($dtaskepranap->gerimobilitas == 2) {echo "checked";} ?>> Dapat berpergian keluar rumah</label>
									</div>
									<div class="form-group row col-spacing-row">
									...
									<div class="form-group row col-spacing-row">
										<label><input type="radio" class="state iradio_square-red ml-3" id="geritekanan1" name="geritekanan" value="0" <?php if ($dtaskepranap->geritekanan == 0) {echo "checked";} ?>> Ya</label>
										<label><input type="radio" class="state iradio_square-red ml-3" id="geritekanan2" name="geritekanan" value="1" <?php if ($dtaskepranap->geritekanan == 1) {echo "checked";} ?>> Tidak</label>
									</div>
									<div class="form-group row col-spacing-row"> 
										<label class="col-md-10 col-form-label" style="font-weight: bold; font-size: 12px; color: #000000;"> Gangguan Neuropsikologis</label>
									</div>
									<div class="form-group row col-spacing-row">
										<label><input type="radio" class="state iradio_square-red ml-3" id="gerigangguan1" name="gerigangguan" value="0" <?php if ($dtaskepranap->gerigangguan == 0) {echo "checked";} ?>> Depresi</label>
										<label><input type="radio" class="state iradio_square-red ml-3" id="gerigangguan2" name="gerigangguan" value="1" <?php if ($dtaskepranap->gerigangguan == 1) {echo "checked";} ?>> Kepikunan Ringan</label>
										<label><input type="radio" class="state iradio_square-red ml-3" id="gerigangguan3" name="gerigangguan" value="2" <?php if ($dtaskepranap->gerigangguan == 1) {echo "checked";} ?>> Tidak ada gangguan Psikologis</label>
									</div>
									<div class="form-group row col-spacing-row">
										<label class="col-md-10 col-form-label" style="font-weight: bold; font-size: 12px; color: #000000;"> Indeks Masa Tubuh(IMT)</label>
									</div>
									<div class="form-group row col-spacing-row">
										<label><input type="radio" class="state iradio_square-red ml-3" id="geriindeks1" name="geriindeks" value="0" <?php if ($dtaskepranap->geriindeks == 0) {echo "checked";} ?>> IMT kurang dari 19</label>
										<label><input type="radio" class="state iradio_square-red ml-3" id="geriindeks2" name="geriindeks" value="1" <?php if ($dtaskepranap->geriindeks == 1) {echo "checked";} ?>> IMT 19 sampai kurang dari 21</label>
										<label><input type="radio" class="state iradio_square-red ml-3" id="geriindeks3" name="geriindeks" value="2" <?php if ($dtaskepranap->geriindeks == 2) {echo "checked";} ?>> IMT 21 sampai kurang dari 23</label>
										<label><input type="radio" class="state iradio_square-red ml-3" id="geriindeks4" name="geriindeks" value="3" <?php if ($dtaskepranap->geriindeks == 3) {echo "checked";} ?>> IMT 23 atau lebih</label>
									</div>
									<div class="form-group row col-spacing-row">
									...
									<div class="form-group row col-spacing-row">
										<label><input type="radio" class="state iradio_square-red ml-3" id="geriindeks5" name="geriindeks" value="0" <?php if ($dtaskepranap->geriindeks == 4) {echo "checked";} ?>> Lingkar betis kurang dari 31</label>
										<label><input type="radio" class="state iradio_square-red ml-3" id="geriindeks6" name="geriindeks" value="1" <?php if ($dtaskepranap->geriindeks == 5) {echo "checked";} ?>> Lingkar betis sama dengan 31 atau lebih</label>
									</div>
									<div class="form-group row col-spacing-row MT-3">
										...
										<label class="col-md-1 col-form-label text-right" style="font-weight: bold; font-size: 14px; color: #000000;">SKOR</label>
										<div class="col-md-1">
