		...
		<div class="form-group row col-spacing-row">
			<div class="col-md-12 mt-3">
				...
				<div class="form-check form-check-inline">
					...
					<input type="text" id="imt" name="imt" class="form-control ml-3" style="width: 120px; display: inline-block; border: 1px solid;" value="<?php echo $dtgiziranap->imt ?>" disabled>
