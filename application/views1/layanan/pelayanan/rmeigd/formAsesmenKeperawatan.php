...
<div class="card">
	...
	<div class="col-12 mt-2 ml-3" id="formAskep">
			<!-- =========== -->
				<div class="tab-pane fade show" id="tabasesmenawalmedis" role="tabpanel">
					<nav>
						<div class="nav nav-tabs" id="subnav1" role="tablist">
							...
							<a class="nav-item nav-link" id="subtabpemeriksaan" data-toggle="tab" href="#pemeriksaantab"
								role="tab" aria-controls="subnav1-2" aria-selected="false">Pemeriksaan Fisik</a>

							<a class="nav-item nav-link" id="subtabnyeri" data-toggle="tab" href="#nyeritab" role="tab"
						...
						<div class="tab-content" id="subnav1-content">
							...
							<div class="tab-pane fade" id="dissability" role="tabpanel" aria-labelledby="subtabdissability">
								<div class="card">
									<div class="card-body">
										<div class="col-md-12 mt-3">
											<div class="form-group row col-spacing-row">
							...
							<div class="tab-pane fade" id="pemeriksaantab" role="tabpanel"
							...
							<!-- savenyeri -->
							<div class="tab-pane fade" id="nyeritab" role="tabpanel" aria-labelledby="subtabnyeri">
								<div class="card">
									<div class="card-body">
										<div class="col-md-12">
											<div class="form-group row col-spacing-row mt-3">
