                        ...
                        <div class="box-body">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <!-- <input type="number" class="form-control" name="qty" id="qty" value="0" onkeyup="hitungjumlah()"> -->
			                        <input type="text" class="form-control text-right" name="qty" id="qty"  onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this); hitungjumlah();" autocomplete="off">
			                        <!-- <input type="text" class="form-control text-right" name="qty" id="qty"  onkeydown="return numbersonly(this, event);" onkeyup="hitungjumlah()" autocomplete="off"> -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <!-- <input type="number" class="form-control" name="hrg" id="hrg" value="0" onkeyup="hitungjumlah()"/> -->
			                            <input type="text" class="form-control text-right" name="hrg" id="hrg"  onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this); hitungjumlah();" autocomplete="off">
                                        <!-- <input type="number" class="form-control" name="hrg2" id="hrg" value="0" onkeyup="hitungjumlah()"/> -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
			                            ...
			                            <!-- <input type="text" class="form-control text-right" name="disc" id="disc"  onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this); hitungjumlah();" autocomplete="off"> -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
			                            ...
			                            <!-- <input type="text" class="form-control text-right" name="pot" id="pot"  onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this); hitungjumlah();" autocomplete="off"> -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
			                            ...
			                            <input type="text" class="form-control text-right" name="jum" id="jum"  onchange="return numbersonly(this, event);">
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control" name="isi" id="isi" value="0">
                                    </div>
                                </div>
                                <div class="form-group">
