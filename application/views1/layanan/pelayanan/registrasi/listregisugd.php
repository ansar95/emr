			...
			<div class="col-12">
				<div class="card">
					<div class="card-header d-flex justify-content-between align-items-center">
						<h4 class="mb-0">Registrasi Pelayanan Unit Gawat Darurat</h4>
						<button class='btn btn-sm btn-success' onclick="location.href='<?php echo site_url(); ?>/registrasipasien/dataregistrasibaruugd'">
								...
								<table class="table table-bordered table-hover" id="barispasien">
									<thead>
										<tr>
											...
											<!-- <th width='9%'>Rujukan</th> -->
											<th width='8%'>No. Transaksi</th>
											<th width='10%'>No. SEP</th>
											<th style="text-align:center" width='6%'>Cetak</th>
											<th style="text-align:center" width='8%'>Proses</th>
											<th style="text-align:center" width='8%'>SEP</th>
											<th style="text-align:center" width='8%'>SPRI</th>
											<!-- <th style="text-align:center" width='12%'>Proses</th> -->
										</tr>
									</thead>
									<tbody>
										<tr>
