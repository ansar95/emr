			...
			<div class="col-12">
				<div class="card">
					<div class="card-header d-flex justify-content-between align-items-center">
						<h4 class="mb-0">Instalasi Radiologi</h4>
						<button class='btn btn-sm btn-info' id="tambahlab">
					...
					<div class="card-body">
						<div class="row">
							<div class="form-group col-md-3">
								<label for="inputEmail4">Tanggal Kunjungan</label>
						...
						<div class="box-body">
							<table class="table table-bordered table-hover" id="tabellab">
								<thead>
									<tr>
										<th width='5%'>No. RM</th>
										...
										<th width="18%">Dokter Instruksi</th>
										<th width="18%">Dokter Penerima</th>
