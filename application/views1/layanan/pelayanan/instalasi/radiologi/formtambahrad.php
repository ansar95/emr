    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Registrasi Pasien Instalasi Radiologi</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group row col-spacing-row">
                    <label for="username" class="col-sm-3 col-form-label">Radiografer</label>
                    <div class="col-sm-9">
...
?>
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <!-- <div class="box box-default box-solid" id="proseskotak"> -->
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Pasien Instalasi Radiologi</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <div class="form-group row col-spacing-row">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control prov" style="width: 100%;" name="radiografer" id="radiografer">
                            ...
                            foreach ($dtradiografer as $row) {
                            ?>
                                <option value="<?php echo $row->kode_dokter; ?>" <?php if ($dt->kode_radiografer == $row->kode_dokter) {
                                                                                        echo "selected";
                                                                                    } ?>><?php echo $row->nama_dokter; ?></option>
                            <?php
                            }
