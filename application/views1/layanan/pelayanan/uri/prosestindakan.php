...
?>
	<div class="col-md-6">
		<div class="box box-info">
			<div class="box-body">
				...
				<div class="form-group row col-spacing-row">
					<label for="inputEmail3" class="col-sm-3 col-form-label">Pelaksana 1</label>
					<div class="col-sm-9">
				...
				<div class="form-group row col-spacing-row">
					<label for="inputEmail3" class="col-sm-3 col-form-label">Pelaksana 2</label>
					<div class="col-sm-9">
	...
	<div class="col-md-6">
		<div class="box box-info">
			<div class="box-body">
				...
				<div class="form-group row col-spacing-row">
					<label for="inputEmail3" class="col-sm-3 col-form-label">Biaya per Jasa</label>
					<div class="col-sm-3">
	...
	<div class="col-md-12 text-right">
		<button onclick="simpandatatindakan();" class="btn btn-primary pull-right">Simpan</button>
	</div>
<?php
} else if ($pilihform == 1) {
?>
	<div class="col-md-6">
		...
		<div class="form-group row col-spacing-row">
			...
			<div class="col-md-9">
				<input type="time" id="tdwaktu" name="tdwaktu" class="form-control" id="time" value="<?php echo $dataedit->jam; ?>">
			</div>
		</div>
		<div class="form-group row col-spacing-row">
	...
	<div class="col-md-6">
		<button onclick="ubahtindakan();" class="btn btn-secondary">Batal</button>
	</div>
	<div class="col-md-6 text-right">
		<button onclick="ubahdatatindakan(<?php echo $dataedit->id; ?>);" class="btn btn-danger pull-right">Ubah</button>
	</div>
<?php
}
?>
