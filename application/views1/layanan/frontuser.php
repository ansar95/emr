                                    ...
                                    <div class="row">
                                        <!-- <div class="col-12 col-lg-12 d-block d-md-flex d-lg-block"> -->
                                                        ...
                                                        <div class="card-body">
                                                            <div class='d-flex px-0 px-lg-2 py-2 align-self-center'>
                                                                ...
                                                                <div class='card-liner-content'>
                                                                    <h2 class="card-liner-title text-white">Pelayanan</h2>
                                                                    <h7 class="card-liner-subtitle text-white">Pelayanan Pasien</h7>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </a>
                                            ...
                                            <div class="card bg-success  rounded-0 col-12 col-md-4 col-lg-3">
												<a href="<?php echo site_url();?>/<?php echo "rme";?>">
                                                    <div class="card-body">
                                                        <div class='d-flex px-0 px-lg-2 py-3 align-self-center'>
                                                            <i class="fas fa-stethoscope card-liner-icon mt-2 text-white"></i>
                                                            <div class='card-liner-content'>
                                                                <h2 class="card-liner-title text-white">Form Dokter</h2>
                                                                <h6 class="card-liner-subtitle text-white">Pelayanan Pasien</h6>
                                                            </div>
                                                        </div>
                                                    </div>
												</a>
		                                    ...
		                                    if ($this->session->userdata("BO") == 1) {

                                            ?>
											<div class="card bg-danger  rounded-0 col-12 col-md-4 col-lg-3">
                                                <a href="<?php echo site_url();?>/<?php echo "applayanan/menuappbackoffice";?>">
                                                <div class="card-body">
                                                    <div class='d-flex px-0 px-lg-2 py-3 align-self-center'>
                                                        <i class="fas fa-calculator card-liner-icon mt-2 text-white"></i>
                                                        <div class='card-liner-content'>
                                                            <h2 class="card-liner-title text-white">Administrasi</h2>
                                                            <h6 class="card-liner-subtitle text-white">Perkantoran</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
											...
											<div class="card bg-dark  rounded-0 col-12 col-md-4 col-lg-3">
												<a href="<?php echo site_url();?>/<?php echo "applayanan/menuappadm";?>">
													<div class="card-body">
														<div class='d-flex px-0 px-lg-2 py-3 align-self-center'>
															<i class="fas fa-address-card card-liner-icon mt-2 text-white"></i>
															<div class='card-liner-content'>
																<h2 class="card-liner-title text-white">Admin</h2>
																<h6 class="card-liner-subtitle text-white">Administrator</h6>
															</div>
														</div>
													</div>
												</a>	
