            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">Cek Data Rawat Inap</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                        ...
                                        <div class="form-group row col-spacing-row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control pull-right datepick" id="awal" name="awal" value="" required>
                                                </div>
                                            </div>
                                            <label class="col-form-label">s/d</label>
                                            <div class="col-md-4">
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control pull-right datepick" id="akhir" name="akhir" value="" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row spacing-row">
                                    ...
                                    <div class="col-md-6 col-6 col-sm-6">
                                        <div class="row col-spacing-row col ">
                                            ...
                                            <button onclick="load_data_uri()" class="btn btn-primary ">Tampilkan</button>
                                            <div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card-body">
                        <div class="sort-panel">
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-7">
                                    <button class="btn btn-primary" style="float:right !important;" onclick="tambahVerifikasiUri()"><i class="fa fa-plus"></i> Tambah Data</button>
                                </div>
                            </div>
                        </div>
                        <div class="table-responsive mt-2 table-scrollable" style="max-height: 400px;">
                            <table id="tabelmedikuri" class="display table dataTable table-bordered" style="width: 180%">
                                <thead class="position-relative z-0">
                                    <tr>
                                        ...
                                        <th rowspan="2" width="6%" class="position-sticky bg-white border-left" style="right:0; z-index:4">Aksi</th>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group row col-spacing-row">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <div class="input-group">
                                                        <input type="text" name="tgl_keluar" class="form-control pull-right datepick" value="" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="form-group row col-spacing-row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-group row col-spacing-row">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <div class="input-group">
                                                        <input type="text" name="tgl_masuk" class="form-control pull-right datepick" value="" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="table-responsive table-scrollable" style="max-height: 400px">
                            <table id="tabelrinciandokter" class="display table dataTable table-bordered">
                                <thead>
                                    <th>Nama Dokter</th>
                                    <th>Type</th>
                                    <th>Jumlah Jasa Dibagi</th>
                                    <th>Jasa Diterima</th>
                                    <th class="mx-auto" width="8%">Aksi</th>
                                </thead>
                                <tbody>
                                </tbody>
                            </table>
        ...
        <div class="modal fade" id="tambahModal" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="simpanUri()" class="btn btn-primary">Simpan</button>
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="editModal" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="updateUri()" class="btn btn-primary">Simpan</button>
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    </div>
                </div>
            </div>
