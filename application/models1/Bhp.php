...
class Bhp extends CI_Model {
    ...
    public function pilihbhpbersalin() {
		$this->db->select("kodeobat, namaobat, id");
        $this->db->from("mobat");
		$this->db->where("bhp", "1");
		$data = $this->db->get();
    ...
    public function pilihobatbersalin() {
		$this->db->select("kodeobat, namaobat, id");
        $this->db->from("mobat");
		$data = $this->db->get();
		return $data->result();
    ...
    function fetch_details($limit, $start) {
		...
		<tr>
			...
			<td class="text-center">
				<button onclick="rubahharga('.$row->id.')" class="btn btn-sm btn-primary btn-flat">Rubah Harga</button>
    ...
    function fetch_details_pbf($limit, $start) {
		...
		<tr>
			...
			<td class="text-center">
				<button onclick="panggiledit('.$row->id.')" class="btn btn-sm btn-info btn-flat"><i class="fa fa-edit"></i></button>
				<button  class="btn btn-sm btn btn-danger btn-flat"><i class="fa fa-trash"></i></button>
			</td>
		</tr>
		';
        }
