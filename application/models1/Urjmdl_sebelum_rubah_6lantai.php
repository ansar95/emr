...
class Urjmdl extends CI_Model {
	...
	public function carinamapasienurj() {
		...
		// $tgl1 = trim($this->input->get("tglp1"));
	...
	public function datamtdobat() {
		$no = $this->input->get("notrans");
		$unit = $this->input->get("unit");
		$this->db->select("resep_header.tglresep, resep_detail.namaobat, resep_detail.satuanpakai, resep_detail.hargapakai, resep_detail.qty, resep_detail.idnoresep,resep_detail.dosis, resep_header.noresep ");
