...
class Bpjsmodel extends CI_Model {
	...
	public function cekjadwaldokter($param1,$param2,$param3) {
		// $url = getenv('V_URL') . "RencanaKontrol/JadwalPraktekDokter/JnsKontrol/1/KdPoli/INT/TglRencanaKontrol/2023-05-26";
		$url = getenv('V_URL') . "RencanaKontrol/JadwalPraktekDokter/JnsKontrol/".$param1."/KdPoli/".$param2."/TglRencanaKontrol/".$param3."";
		$request_headers = $this->ambilheaderurlencode();
		$timestampsep= $this->ambiltimestamp();
		$curl = curl_init();
		curl_setopt_array($curl, [
