...
class Apotik extends CI_Model {
    ...
    public function ambildetail($id) {
        $this->db->select("namaobat, satuanpakai, qty, hargapakai, tuslag, jumlah, dosis, noninacbg, idnoresep, proses, pagi, siang, malam, takaran, caramakan, takaran,keterangan ");
        $this->db->from("resep_detail");
    ...
    public function batalkanresepunit() {
        ...
        public function editheader() {
            ...
            $this->db->where('norep', $norep);
            $dt = $this->db->update("resep_header", $detailresep);
            return $dt;
        }    
