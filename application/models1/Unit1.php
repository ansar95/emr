	...
	function fetch_details($limit, $start) {
		...
		foreach($query->result() as $row) {
            if (ceksess("EDIT", $id) == TRUE) {
                $edit = '<button onclick="panggiledit('.$row->idunit.')" class="btn-sm btn-info btn"><i class="fa fa-edit"></i></button>';
            } else {
                $edit = "";
            }
            if (ceksess("DEL", $id) == TRUE) {
                $del = '<button onclick="hapusdata(this, '.$row->idunit.')" class="btn-sm btn-danger btn"><i class="fa fa-trash"></i></button>';
            } else {
                $del = "";
            }
