            ...
            <div class="row vh-100 justify-content-between align-items-center">
                <div class="col-12">
                    <form action="<?php echo site_url();?>/login/masuk" method="post" class="row row-eq-height lockscreen  mt-5 mb-5">
                        <div class="lock-image col-12 col-sm-5 p-4"><img src="<?php echo site_url();?>/../assets/img/logosulsel.png"  width="210" height="250" /></div>
                        <div class="login-form col-12 col-sm-7">
                            <div class="form-group mb-3">
                                <label>SISTEM INFORMASI MANAJEMEN RUMAH SAKIT</label>
                            </div>
