...
<div class="modal fade" id="formmodal" data-backdrop="static" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false">
    ...
    <script type="text/javascript">
	    ...
	    function tambahtanda() {
            var tanda = $("#tanda").val();
            $.ajax({
                url: "<?php echo site_url();?>/faktur/cekdatatandaterima",
                type: "GET",
	            data: {
                    tanda: tanda
	            },
        ...
        function addfaktur() {
            modaldetail();
            $.ajax({
                url: "<?php echo site_url();?>/faktur/tambahfakturbhp",
                type: "GET",
                success: function (ajaxData) {
        ...
        function prosesheader_old() {
            ...
            $.ajax({
                url: "<?php echo site_url();?>/faktur/simpanfakturheaderbhp",
                type: "GET",
                data: {sj: sj, bhp : bhp},
                success: function (ajaxData){
                    var dt = JSON.parse(ajaxData);
                    if (dt.stat.sukses == true) {
                        ...
                        $("#pendanaan").val(""+dt.stat.header.pendanaan+"").trigger('change');
            ...
            $.ajax({
                ...
                success: function (ajaxData){
                    ...
                    if (dt.stat.sukses == true) {
                        ...
                        $("#ppn").val(""+dt.stat.header.ppn+"").trigger('change');
                        $("#pendanaan").val(""+dt.stat.header.pendanaan+"").trigger('change');
                        $("#status").val(""+dt.stat.header.status+"").trigger('change');
                        $("#vendor").val(""+dt.stat.header.kodepbf+"").trigger('change');
                        $("#no").val(""+dt.stat.header.nofak+"");
        ...
        function updateFaktur() {
            ...
            var sj = $("#sj").val();
            $.ajax({
                url: "<?php echo site_url();?>/faktur/ubahnofaktur",
                type: "GET",
                data: {
                    no: no,
	                terima: sj
        ...
        function updateinfofaktur_old() {
            ...
            $.ajax({
                url: "<?php echo site_url();?>/faktur/ubahheaderfaktur",
                type: "GET",
                data: {
                    sj: sj,
                    tgl: tgl,
        ...
        function deletefaktur() {
            ...
            $.ajax({
                url: "<?php echo site_url();?>/faktur/hapusfaktur",
                type: "GET",
                data: {
                    sj: sj
                },
        ...
        function prosesretur() {
            ...
            console.log('masuk');
            $.ajax({
                url: "<?php echo site_url();?>/faktur/tampilkanretur",
                type: "GET",
                data: { awal: awal,
                        akhir : akhir,
                        vendor : vendor },
                success: function (ajaxData){
                        ...
                        // $("tabledetail_retur").html(dt);
                        $("#tabledetail_retur").html(dt.dtview);
        ...
        function addfakturretur() {
            modaldetail();
            $.ajax({
                url: "<?php echo site_url();?>/faktur/tambahretur",
                type: "GET",
                success: function (ajaxData) {
                    $("#formmodal").html(ajaxData);
                    $("#formmodal").modal('show', {backdrop: 'true'});
        ...
        function editdetailfaktur(id) {
            modaldetail();
            $.ajax({
                // url: "<?php echo site_url();?>/faktur/tambahfaktur",
                url: "<?php echo site_url();?>/faktur/editdetailfakturbhp",
                type: "GET",
                data : { id: id },
                success: function (ajaxData) {
                    $("#formmodal").html(ajaxData);
