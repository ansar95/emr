...
<script type="text/javascript">
	...
	function load_data(page) {
		...
		cari.addEventListener('click', function(){
			...
			console.log(key1);
                $.ajax({
                    url:"<?php echo site_url();?>/masterdata/paginationmedis/"+"1",
                    method:"GET",
                    data: {key1: key1},
                    dataType:"json",
        ...
        $.ajax({
                    url:"<?php echo site_url();?>/masterdata/paginationmedis/"+page,
                    method:"GET",
                    data: {key1: key1},
                    dataType:"json",
                    success:function(data) {
	...
	$(document).ready(function () {
		...
		$("#tambahmedis").click(function(e) {
			modaltable();
			$.ajax({
				url: "<?php echo site_url();?>/masterdata/panggiltambahmedis",
				type: "GET",
    ...
    function panggiledit(id) {
        modaltable();
        $.ajax({
            url: "<?php echo site_url();?>/masterdata/panggileditmedis",
            type: "GET",
            data: {id: id},
            success: function (ajaxData){
                $("#formmodal").html(ajaxData);
        ...
        $.confirm({
            ...
            buttons: {
                ...
                hapus: {
                    ...
                    action: function(){
                        $.ajax({
                            url: "<?php echo site_url();?>/masterdata/deleteparamedis",
                            type: "GET",
                            data : {
                                id: id
                            },
