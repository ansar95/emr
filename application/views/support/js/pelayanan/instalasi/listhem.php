...
<script type="text/javascript">
	...
	$(document).ready(function () {
		$("#caridata").click(function(e) {
			...
			$.ajax({
				url: "<?php echo site_url();?>/ihemodialisa/caridatahem",
				type: "GET",
				data : {tgl: tgl, nrp: nrp, kdunit: kdunit},
				success: function (ajaxData){
					$("#tabelhem tbody tr").remove();
					$("#tabelhem tbody").append(ajaxData);
					hapusload();
				}
			});
		});

		$("#tambahhem").click(function(e) {
			$.ajax({
				url: "<?php echo site_url();?>/ihemodialisa/panggiltambahhem",
				type: "GET",
				success: function (ajaxData){
					hapusload();
	...
	function panggilproses(id) {
		...
		var kdunit = $("#kdunit").val();
		$.ajax({
			url: "<?php echo site_url();?>/ihemodialisa/panggilformproseshem",
			type: "GET",
    ...
    function panggiledit(id) {
        ...
        var kdunit = $("#kdunit").val();
        $.ajax({
            url: "<?php echo site_url();?>/ihemodialisa/panggiledithem",
            type: "GET",
            data : {id: id, kdunit: kdunit},
            success: function (ajaxData){
                hapusload();
            ...
            buttons: {
                ...
                kembali: {
                    ...
                    action: function () {
                        ...
                        var nrp = document.getElementById("nrp").value;
                        $.ajax({
                            url: "<?php echo site_url();?>/ihemodialisa/hapusinstalasi",
                            type: "GET",
                            data: {
                                id: id,
                                unit: unit,
