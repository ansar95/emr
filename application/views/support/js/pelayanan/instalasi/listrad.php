...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		$("#caridata").click(function(e) {
			...
			$.ajax({
				url: "<?php echo site_url();?>/iradiologi/caridatarad",
				type: "GET",
		...
		$("#tambahlab").click(function(e) {
			$.ajax({
				url: "<?php echo site_url();?>/iradiologi/panggiltambahrad",
				type: "GET",
				success: function (ajaxData){
					hapusload();
	...
	function panggilproses(id) {
		...
		var kdunit = $("#kdunit").val();
		$.ajax({
			url: "<?php echo site_url();?>/iradiologi/panggilformprosesrad",
			type: "GET",
    ...
    function panggiledit(id) {
        ...
        var kdunit = $("#kdunit").val();
        $.ajax({
            url: "<?php echo site_url();?>/iradiologi/panggileditrad",
            type: "GET",
            data : {id: id, kdunit: kdunit},
            success: function (ajaxData){
                hapusload();
            ...
            buttons: {
                ...
                kembali: {
                    ...
                    action: function () {
                        ...
                        var nrp = document.getElementById("nrp").value;
                        $.ajax({
                            url: "<?php echo site_url();?>/iradiologi/hapusinstalasi",
                            type: "GET",
                            data: {
                                id: id,
                                unit: unit,
