...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		$("#caridata").click(function(e) {
			...
			$.ajax({
				url: "<?php echo site_url();?>/ilaboratorium/caridatalab",
				type: "GET",
		...
		$("#tambahlab").click(function(e) {
			$.ajax({
				url: "<?php echo site_url();?>/ilaboratorium/panggiltambahlab",
				type: "GET",
				success: function (ajaxData){
					hapusload();
	...
	function panggilproses(id) {
		...
		var kdunit = $("#kdunit").val();
		$.ajax({
			url: "<?php echo site_url();?>/ilaboratorium/panggilformproseslab",
			type: "GET",
    ...
    function panggiledit(id) {
        ...
        var kdunit = $("#kdunit").val();
        $.ajax({
            url: "<?php echo site_url();?>/ilaboratorium/panggileditlab",
            type: "GET",
            data : {id: id, kdunit: kdunit},
            success: function (ajaxData){
                hapusload();
            ...
            buttons: {
                ...
                kembali: {
                    ...
                    action: function () {
                        ...
                        var nrp = document.getElementById("nrp").value;
                        $.ajax({
                            url: "<?php echo site_url();?>/ilaboratorium/hapusinstalasi",
                            type: "GET",
                            data: {
                                id: id,
                                unit: unit,
