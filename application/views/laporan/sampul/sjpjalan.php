  ...
  <tr>
    <td><table width="548" border="1" cellspacing="0">
      ...
      <tr>
        <td><table width="122" border="0" cellspacing="2">
          <tr>
            <td height="18"><span class="style59">Diagnosa Rujukan </span></td>
          </tr>
        </table></td>
        <td colspan="2"><table width="155" border="0" cellspacing="2">
          <tr>
            <td><span class="style62"><?php echo $xdiagnosarujukan ;?></span></td>
          </tr>
        </table></td>
        <td><table width="95" border="0" cellspacing="2">
          <tr>
            <td><span class="style59">Rujukan Intern RS </span></td>
          </tr>
        </table></td>
        <td colspan="2"><table width="149" border="0" cellspacing="2">
          <tr>
            <td><span class="style59">Polik</span></td>
          </tr>
        </table></td>
        </tr>
      <tr>
