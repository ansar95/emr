...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="6" style="font-family: Arial, sans-serif; font-size: 14px;">RSUD KOTA MAKASSAR</td>
  </tr>
  <tr>
    <td colspan="6" style="font-family: Arial, sans-serif; font-size: 16px;">HASIL PEMERIKSAAN LABORATORIUM PATOLOGI ANATOMI</td>
  </tr>
  <tr>
    <td colspan="6">&nbsp;</td>
  </tr>
  <tr>
    <td width="12%" style="font-family: Arial, sans-serif; font-size: 11px;">Nama Pasien</td>
    <td colspan="2" style="font-family: Arial, sans-serif; font-size: 11px;">: <?php echo $nama_pasien?></td>
    <td width="14%" style="font-family: Arial, sans-serif; font-size: 11px;">&nbsp;</td>
    <td width="25%" colspan="2" style="font-family: Arial, sans-serif; font-size: 11px;">: </td>
  </tr>
