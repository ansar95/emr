...
<body>
<?php
      $qry2=$this->db->query("SELECT *,register.golongan as asuransi1,pasien.status as kawin FROM register INNER JOIN pasien ON register.no_rm = pasien.no_rm INNER JOIN register_detail ON register.notransaksi =register_detail.notransaksi and register_detail.id = '".$id."' LIMIT 1");;
