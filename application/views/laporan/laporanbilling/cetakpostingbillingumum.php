...
<?php
   ...
   foreach ($qry2->result_array() as $brs2) {
                   ...
                   $nama_dokter=$brs2['nama_dokter']; //salah jika ambil dari register
...
<!-- tindakan KEPERAWATAN -->
      ...
      <?php
            $xjumharga=0;
            $qry4=$this->db->query("select * from ptindakanperawat where notransaksi='$xnotransaksi'  and nonasuransi='$nonas'  order by tanggal,id");
...
<?php
        ...
        foreach ($qry->result_array() as $brs) {
          ...
          $qry7=$this->db->query("select * from ptindakan where notransaksi='$zno_transaksi_secondary'  and kode_unit='$zkode_unit' and nonasuransi='$nonas' order by tanggal");
          foreach ($qry7->result_array() as $brs7) 
          {
              $xtanggal=$brs7['tanggal'];
