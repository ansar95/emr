...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  ?>
  <tr>
    <td width="88%"><span class="style2"><?php echo 'Rekam Medik';?></span></td>
  ...
  ?>
  <tr>
    <td width="88%"><span class="style2"><?php echo 'Administrasi';?></span></td>
    <td width="12%"><div align="right"><span class="style2"><?php echo groupangka($xhargaqty);?></span></div></td>
  </tr>
  <?php
  ...
  ?>
 <tr>
    <td width="88%"><span class="style2"><?php echo 'Materai';?></span></td>
    <td width="12%"><div align="right"><span class="style2"><?php echo groupangka($xhargaqty);?></span></div></td>
  </tr>
</table>
</div>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="87%" height="15"><div align="right"><span class="style21">TOTAL (Rp.)</span></div></td>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr class="style13">
    <td width="9%"><span class="style21">Terbilang : </span></td>
    <td width="91%" class="style14"><?php echo terbilang($xterbilangnya).' rupiah***';?></td>
  </tr>
</table>
