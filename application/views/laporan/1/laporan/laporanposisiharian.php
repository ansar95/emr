        ...
        foreach ($qry->result_array() as $brs) {
         ...
         ?>  
            <tr style="font-family: Arial; font-size: 11px; text-align: center;">
              ...
              <?php if ($qtysaja != "on" ) { ?>
                <td width="10%" style="text-align: right" ><?php echo $cekprinternya == 3 ? (int)$harga : formatuang($harga); ?></td>
                <td width="12%" style="text-align: right" ><?php echo $cekprinternya == 3 ? (int)$nilaistok : formatuang($nilaistok); ?></td>
              <?php } ?>
            </tr>
          <?php
        } }
...
<table width="100%" border="0" cellpadding="3" cellspacing="1">
  <tbody>
    <tr style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 11px; text-align: center;">
      ...
      <th width="8%" style="text-align: right" ><?php echo $cekprinternya == 3 ? (int)$totaljumlah : formatuang($totaljumlah); ?></th>
    </tr>
  </tbody>
</table>
