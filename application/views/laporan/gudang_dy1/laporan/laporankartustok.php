...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    <tr>
          <td style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-style: normal; font-weight: bold; font-size: 11px;">INSTALASI FARMASI RUMAH SAKIT UMUM DAERAH LUWUK</td>
    </tr>
    <tr>
    ...
    <tr>
      <td width="70%" style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; font-weight: bold; font-size: 11px;"><?php echo 'Nama Obat : '.$namaobat.' | '.$satuanpakai; ?></td>
      <td width="30%" style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; font-size: 14px; text-align: right;"><?php echo $pendanaan; ?></td>
    </tr>
  </tbody>
</table>
...
<table class="tabelbiasa2" width="100%"  align="left" cellpadding="1" cellspacing="1">
  <tbody>
    <?php
        ...
        $per1="SELECT sum(masuk-keluar-returk+returm) as saldoawal FROM kartustok_gudang where tanggal<'$tanggalawal' and kodeobat='$kodeobat' and pendanaan='$pendanaan' ";
...
<?php
        ...
        $per2="SELECT * FROM kartustok_gudang where (tanggal BETWEEN '$tanggalawal' and '$tanggalakhir') and kodeobat='$kodeobat' and pendanaan='$pendanaan' order by tanggal,id ";
