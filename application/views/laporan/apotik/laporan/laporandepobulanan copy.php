...
<table width="100%"   cellspacing="0" cellpadding="2">
  <tr>
    ...
    <?php
      ...
      // if ($cekperawatan==0) {$cekperawatan = "";} else {$cekperawatan=" and golongan='$golongan' ";} 
      ...
      foreach ($qry2->result_array() as $brs2) {
                    ...
                    // uji apakah di cetak atau tidak sesuai pilihan jenis perawatan
                    $cetak=false;
                    if ($cekperawatan == 0) {
                      $cetak=true;
                      ...
                      if ($bagian == 'INAP') {
                        ...
                        if ($bagian=='IGD' and $kode_keluarpada!='IGDD' and $kode_keluarpada!='IGDP' and $kode_keluarpada!='') {
                          $cetak=true;
                        } elseif ($bagian=='IGD' and $kode_keluarpada =='') {
                          //cek dulu apakah ada pindah dari ugd
                          $jumlahrecord=0;
                          $per15="SELECT count(no_rm) as jum FROM register_detail where register_detail.notransaksi='$notransaksi' and kode_unit !='IGDD' and kode_unit !='IGDP' group by notransaksi";
                          $qry25=$this->db->query($per15);
                          foreach ($qry25->result_array() as $brs25) {
                            $jumlahrecord=$brs25['jum'];
                          }  
                          if ($jumlahrecord > 0 ) {
                            $cetak=true;
                          } else {
                      ...
                      if ($bagian == 'IGD') {
                        if ($kode_keluarpada=='IGDD' or $kode_keluarpada =='IGDP') {
                          $cetak=true;
                        } else {
                           //cek dulu apakah ada pindah dari ugd
                           $jumlahrecord=0;
      ...
      if ($cetak == true) {       //uji apakah cetak atau tidak
        ?>
