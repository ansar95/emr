        ...
        foreach ($qry->result_array() as $brs) {
         ...
         ?>  
            <tr style="font-family: Arial; font-size: 11px; text-align: center;">
              <td width="3%" style="text-align: right" ><?php echo $i.'.'; ?></td>
              <td style="text-align: left" ><?php echo $namaobat; ?></td>
              <td width="8%" style="text-align: left" ><?php echo $satuanpakai; ?></td>
              <td width="8%" style="text-align: right" ><?php echo $cekprinternya == 3 ? (double)$sawal : formatuang($sawal); ?></td>
              <td width="8%" style="text-align: right" ><?php echo $cekprinternya == 3 ? (double)$masuk : formatuang($masuk); ?></td>
              <td width="8%" style="text-align: right" ><?php echo $cekprinternya == 3 ? (double)$keluar : formatuang($keluar); ?></td>
              <td width="8%" style="text-align: right" ><?php echo $cekprinternya == 3 ? (double)$jumlahstok : formatuang($jumlahstok); ?></td>
              <?php if ($qtysaja != "on" ) { ?>
                <td width="10%" style="text-align: right" ><?php echo $cekprinternya == 3 ? (double)$harga : formatuang($harga); ?></td>
                <td width="12%" style="text-align: right" ><?php echo $cekprinternya == 3 ? (double)$nilaistok : formatuang($nilaistok); ?></td>
              <?php } ?>
            </tr>
          <?php
        } }
...
<?php if (($masuk != 0 || $keluar != 0) and $qtysaja !=  "on") { ?>
