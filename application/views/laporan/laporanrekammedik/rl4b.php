    ...
    <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="5%" rowspan="2"><img src="../rsudpemprov/assets/img/logokes.jpg" width="36" height="45"></td>
            <td width="95%" valign="bottom"><span class="style33">Formulir RL. 4.B </span></td>
          </tr>
          <tr>
            <td valign="top"><span class="style33">DATA KEADAAN MORBIDITAS  PASIEN RAWAT JALAN</span></td>
          </tr>
          <!-- <tr>
            <td colspan="2"><hr /></td>
          </tr> -->
...
<table width="700" cellpadding="0" cellspacing="0" border="1">
  <tr>
    ...
    <td colspan="18"><div align="center"><span class="style3">Jumlah Pasien Kasus Menurut Golongan Umur &amp; Jenis Kelamin</span></div></td>
    <td colspan="2"><div align="center"><span class="style3">Kasus Baru Menurut Jenis Kelamin</span></div></td>
    <td rowspan="3" ><div align="center"><span class="style3">Jumlah Kasus Baru (23+24)</span></div></td>
    <td rowspan="3" width="30"><div align="center"><span class="style3">Jumlah Kunjungan</span></div></td>
  </tr>
  <tr height="25">
  ...
  $user=$this->session->userdata("nmuser");
      ...
      $q2="select * from prl4 where kecelakaan=0 order by nourut ";
