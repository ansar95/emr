...
<table width="90%" border="0" align="center" cellspacing="0">
  ...
  <tr>
    <td><span class="style8">ANALISA KELENGKAPAN DAN KETEPATAN WAKTU SETOR BRM RAWAT INAP</span></td>
  </tr>
  <tr>
    <td><span class="style8">BERDASARKAN RUANG PERAWATAN </span></td>
  </tr>
  <tr>
    ...
    <td><table width="100%" border="1" cellspacing="0">
      ...
      <?php
            ...
            $xtottidaktepatwaktu=0;
             $qry1=$this->db->query("SELECT kode_keluarpada FROM register where tglsetor>='".$tglawal."' and tglsetor<='".$tglakhir."' and bagian='INAP' group by kode_keluarpada order by kode_keluarpada ");
            foreach ($qry1->result_array() as $brs1) {
              $xnomor++;
              $xkode_keluarpada=$brs1['kode_keluarpada'];  
              $qry2=$this->db->query("SELECT keluarpada,lengkap,waktusetor FROM register where tglsetor>='".$tglawal."' and tglsetor<='".$tglakhir."' and bagian='INAP' and kode_keluarpada='".$xkode_keluarpada."'order by kode_keluarpada");
      ...
      <tr>
        ...
        <td width="5%"><div align="center"><span class="style1"><?php echo groupangka($xtottepatwaktu) ;?></span></div></td>
        <td width="5%"><div align="center"><span class="style1"><?php echo groupangka($xtottidaktepatwaktu) ;?></span></div></td>
