        ...
        foreach ($qry->result_array() as $brs) {
         ...
         ?>  
            <tr style="font-family: Arial; font-size: 11px; text-align: center;">
              ...
              <th width="8%" style="text-align: right" ><?php echo $cekprinternya == 3 ? (double)$harga : formatuang($harga); ?></th>
              <th width="8%" style="text-align: right" ><?php echo $cekprinternya == 3 ? (double)$nilaistok : formatuang($nilaistok); ?></th>
