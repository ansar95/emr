       ...
       $i=0;
        foreach ($qry->result_array() as $brs) {
            ...
            if ($qtysaja ==  "on" ) {
              ...
              $per2="SELECT sum(masuk) as jummasuk, sum(keluar) as jumkeluar, sum(returm) as jumreturm, sum(returk) as jumreturk FROM kartustok_gudang where kodeobat='$kodeobat' and tanggal>='$tanggalawal' and tanggal<='$tanggalakhir' and harga='$harga'  ";
              $digrup=" group by kodeobat, harga";
            }
