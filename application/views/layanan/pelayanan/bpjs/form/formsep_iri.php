                    ...
                    <div class="row spacing-row">
                        <div class="col-md-12">
                            <div class="row form-group" id="datahidden">
                                ...
                                <input type="hidden" id="nosepigd" name="nosepigd" value="<?php echo $regis->nosep?>">
                            </div>
                        </div>
                    </div>
                    <div class="row spacing-row">
                        <div class="col-md-12">
                            <div class="row form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="hidden" class="form-control" name="kodeasalrujukan" id="kodeasalrujukan" value="<?php echo '2';?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row spacing-row">
                        <div class="col-md-12">
                            <div class="row form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="hidden" class="form-control" name="kodeppkrujukan" id="kodeppkrujukan"  value="<?php echo getenv('V_PPK');?>">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                    <div class='input-group date'>
                                        ...
                                        <input type="hidden" id="txttglrujukan" name="txttglrujukan" value="<?php echo $dtspri->tglrencanakontrol?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row spacing-row">
                        <div class="col-md-12">
                            <div class="row form-group" id="divPoli">
                                ...
                                <div class="col-md-2">
                                    <input type="hidden" class="form-control" name="txtkddpjpspri" id="txtkddpjpspri" value="<?php echo $dtspri->kodedokterbpjs; ?>">
                                </div>   
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                                <label class="form-control" col-form-label><input type="checkbox" id="chkCOB" name="chkCOB"> Peserta COB</label>
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row spacing-row">
                        <div class="col-md-12">
                            <div class="row form-group">
                                ...
                                <div class="col-md-2">
                                    <input type="hidden" class="form-control" id="valueselectkelas" value=<?php echo $valuekelas;?> >
                                </div>                        
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row spacing-row">
                            <div class="col-md-12">
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input type="hidden" class="form-control" id="valueselectnaikkelas" value=<?php echo $valuenaikkelas;?> >
                                    </div>                        
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row spacing-row">
                        <div class="col-md-12">
                            <div class="row form-group">
                                ...
                                <div class="col-md-2">
                                    <input type="hidden" class="form-control" id="valuekecelakaan" value="<?php echo $dtsep->kecelakaan ?>">
                                </div>                      
                            </div>
                        </div>
                    </div>
...
<div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                        ...
                        <div class="row spacing-row">
                            <div class="col-md-12">
                                <div class="row form-group">
                                    <label class="col-md-2 col-sm-3 col-xs-12 col-form-label text-right">Kelas Rawat Inap<label style="color:red;font-size:small">*</label></label>
                                    <div class="col-md-3 col-sm-3 col-xs-6">
                                        <select class="form-control col-form-label" id="selectnaikkelas" name="selectnaikkelas" onchange="pilihkelasnaik()" disabled>
                                                <?php if ($dtsep->peserta_hak_kelas == 3){ $valuenaikkelas=2; ?>
                                                    <option value="2">Kelas 2</option>
                                                    <option value="1">Kelas 1</option>
                                                    <option value="4">Diatas Kelas 1</option>
                        ...
                        <div class="row spacing-row">
                            <div class="col-md-12">
                                <div class="row form-group">
                                    <label class="col-md-2 col-sm-3 col-xs-12 col-form-label text-right">Penanggung Jawab<label style="color:red;font-size:small">*</label></label>
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <textarea class="form-control" id="txtpenanggung" name="txtpenanggung" rows="2" placeholder="Jika Pembiayaan Oleh [Pemberi Kerja] atau [Asuransi Kesehatan Tambahan]" disabled></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-6 text-left">
                        <button id="deletesep" class="btn btn-danger" text-left>Hapus</button>
                    </div>
                    <div class="col-md-6 text-right">
