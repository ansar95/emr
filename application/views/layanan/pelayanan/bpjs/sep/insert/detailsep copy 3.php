                                    ...
                                    <form class="form-horizontal" id="theform">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group row" id="divPoli">
                                                <div class="col-md-2">
                                                    <label class="control-label">Spesialis/SubSpesialis <label style="color:red;font-size:small">*</label></label>
                                                </div>
                                                <div class="col-md-9">
                                                    <label class="col-md-3"><input type="checkbox" id="chkpoliesekutif" name="chkpoliesekutif">Eksekutif</label>
                                                    <div class="col-md-9">
