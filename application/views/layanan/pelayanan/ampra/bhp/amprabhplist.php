                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <?php if ($bhp == 0) { ?>
                            ...
                            <input type="text" class="form-control" name="valuebhp" id="valuebhp" value="<?php echo $bhp; ?>" hidden/>
                        <?php } else { ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-1 my-auto">
                            <button class="btn btn-sm btn-primary" onclick="lanjutproses(<?php echo $bhp; ?>)">Lanjut</button>
                        </div>
                        <!-- <div class="row">
                            <input type="text" class="form-control" name="tglpilih" id="tglpilih"/>
                        </div> -->
                    </div>
                    <div class="card-body position-relative" id="kotakdetail">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-2" id="tabletanggal">
                            ...
                            <div class="col-12 col-md-10" id="tableampra">
