		...
		<form class="form-horizontal" id="kotakform">
			<div class="box box-default box-solid">
				<div class="modal-header">
                    <h6 class="modal-title">Billing</h6>
				...
				<div class="modal-body">
                    ...
                    <div class="box-body row col-spacing-row">
                        <div class="col-sm-6">
                            <div class="form-group row col-spacing-row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" name="st" value="0" id="st" checked>
                                        <label class="custom-control-label" for="st">Dalam Perawatan</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" name="st" value="1" id="st1">
                            ...
                            <div class="form-group row col-spacing-row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control text-right"  onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" name="selisihkelas" id="selisihkelas" autocomplete="off" value="<?php echo formatuang($hasil->selisih);?>" >
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label class="col-sm-5 control-label">Proses</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control text-right"  name="prosesnya" id="prosesnya" disabled>
                                </div>
                            </div>
                        </div>
                        <!-- <div class="col-sm-6">
				...
				<div class="modal-footer">
					<div class="row">
						<div class="col-sm-12">
                            ...
                            <button type="button" onclick="cetakposting()" class="btn btn-primary btn-flat btn-sm">Cetak Billing</button>
						</div>
					</div>
				</div>
			</div>
	...
	function postingdata() {
        ...
        $.ajax({
            ...
            success: function (ajaxData){
                ...
                suksesalert();
                document.getElementById("prosesnya").value = 'POSTING SELESAI';
                //dihilangkan karena biasa salah
