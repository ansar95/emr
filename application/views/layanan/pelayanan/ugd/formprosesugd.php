			...
			<div class="row  spacing-row">
				...
				<div class="col-md-6">
					...
					<div class="form-group row col-spacing-row">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" name="sdhdokterkode" id="sdhdokterkode" value="<?php echo $dtpasien->kode_dokter; ?>" hidden>
				...
				<ul class="nav nav-tabs d-block d-sm-flex">
					<li class="nav-item mr-auto mb-4">
						<a class="nav-link p-0 active" data-toggle="tab" href="#tab_1">
							<div class="d-flex">
								<div class="media-body font-weight-bold align-self-center mb-1 text-danger">
					...
					<li class="nav-item mr-auto mb-4">
						<a class="nav-link p-0" data-toggle="tab" href="#tab_3">
							<div class="d-flex">
								<div class="media-body font-weight-bold align-self-center mb-1 text-info">
					...
					<li class="nav-item mr-auto mb-4">
						<a class="nav-link p-0" data-toggle="tab" href="#tab_4">
							<div class="d-flex">
								<div class="media-body font-weight-bold align-self-center mb-1 text-dark">
			...
			<div class="tab-content">
						...
						<table class="table  table-striped" id="tabelodua">
							<thead>
								<tr>
									...
									<th style="text-align:center" width="6%">Jam</th>
									<th style="text-align:right" width="8%">Jml Liter</th>
									<th style="text-align:center" width="7%">UM/ASR</th>
					...
					<div class="row" id="formdokter">
						...
						<div class="col-md-6">
							...
							<div class="form-group row col-spacing-row">
								...
								<div class="col-md-5">
									<div class="custom-control custom-checkbox custom-control-inline">
										<input type="checkbox" class="custom-control-input" name="drumum" id="drumum">
				...
				<div class="tab-pane fade" id="tab_6">
					...
					<div class="row  spacing-row">
						...
						<div class="col-md-5">
							<div class="row form-group">
								<label class="col-md-4 col-form-label">Unit/Kelas Tujuan</label>
								<div class="col-md-8">
...
// 						$.ajax({
// 							url: "<?php echo site_url(); ?>/ugd/tampilkanpilihandiagnosa",
// 							type: "GET",
// 							data: {
// 								diagnosa: diagnosa
// 							},
