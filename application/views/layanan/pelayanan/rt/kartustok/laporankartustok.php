...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    ...
    <tr>
      <td style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; font-weight: bold; font-size: 14px;">KARTU STOK BHP Non MEDIS</td>
    </tr>
    <tr>
...
<table class="tabelbiasa2" width="100%"  align="left" cellpadding="1" cellspacing="1">
  <tbody>
    <?php
        ...
        $jumlahmasuk=0;
        $jumlahkeluar=0;
        $per1="SELECT sum(masuk-keluar-returk+returm) as saldoawal FROM kartustok_gudang_rt where tanggal<'$tanggalawal'";
...
<?php
        $per2="SELECT * FROM kartustok_gudang_rt where (tanggal BETWEEN '$tanggalawal' and '$tanggalakhir') and kodeobat='$kodeobat' order by tanggal,id ";
