<table class="table table-bordered">
    <tr>
        ...
        <th>Nama Barang</th>
        <th width=10% style="text-align:left;">Satuan (Kemasan)</th>
        <th width=13% style="text-align:right;">QTY (Satuan Terkecil)</th>
        <th width=13% style="text-align:right;">Harga (Satuan Terkecil)</th>
        <th width=10% style="text-align:right;">% Diskon</th>
        <th width=10% style="text-align:right;">Potongan Langsung</th>
    ...
    if ($hasil == null) {
        ...
        foreach($hasil as $row) {
            ...
            echo "<td align='right'>".groupangka($diskonnya)."</td>";
            echo "<td align='right'>".groupangka($row->potlangsung)."</td>";
            echo "<td align='right'>".groupangka($row->bayar)."</td>";
            // echo "<td>".$row->hargasementara."</td>";
            // echo "<td>".$row->hargaperolehan."</td>";
            echo '<td align="center"><a onclick="hapusdata(this, '.$row->id.')" class="btn-sm btn-danger btn-flat"><i class="fa fa-trash"></i></a></td>';
            echo "</tr>";
