<table class="table table-bordered">
    ...
    if ($hasil == null) {
        ...
        foreach($hasil as $row) {
            ...
            echo "<td align='right'>".groupangka_dec($row->qty)."</td>";
            echo "<td align='right'>".groupangka_dec($row->harga)."</td>";
            echo "<td align='right'>".$row->diskon."</td>";
            echo "<td align='right'>".groupangka_dec($row->potlangsung)."</td>";
            echo "<td align='right'>".groupangka_dec($row->bayar)."</td>";
            echo "<td align='right'>".$row->isisatuan."</td>";
            echo "<td>".$row->expire."</td>";
            echo "<td>".$row->batch."</td>";
            echo '<td><button onclick="editdetailfaktur('.$row->id.')" class="btn-sm btn-primary btn-flat"><i class="fa fa-edit"></i></button></td>';
            echo '<td><button onclick="hapusdata(this, '.$row->id.')" class="btn-sm btn-danger btn-flat"><i class="fa fa-trash"></i></button></td>';
            echo "</tr>";
        ...
        echo "<td align='right'><span style='font-weight:bold'>".groupangka_dec($jumdiskon)."</td>";
        echo "<td align='right'><span style='font-weight:bold'>".groupangka_dec($jumpotlangsung)."</span></td>";
        // echo "<td align='right'><span style='font-weight:bold'>".number_format($jumbayar,2,",",".")."</span></td>";
        echo "<td align='right'><span style='font-weight:bold'>".groupangka_dec($jumbayar)."</span></td>";
        ...
        echo "<td align='right'><span style='font-weight:bold'>".groupangka_dec($ppnnya)."</span></td>";
        echo "<td></td>";
        echo "</tr>";
        $totaldibayar=0;
        ...
        // echo "<td align='right'><span style='font-weight:bold'>".groupangka_dec($jumdiskon)."</td>";
        // echo "<td align='right'><span style='font-weight:bold'>".groupangka_dec($jumpotlangsung)."</span></td>";
        echo "<td align='right'><span style='font-weight:bold'>".groupangka_dec($totaldibayar)."</span></td>";
        echo "<td></td>";
        echo "</tr>";
    }
    ?>
