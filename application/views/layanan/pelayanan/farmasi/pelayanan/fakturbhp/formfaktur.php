        ...
        <section class="content col-12">
            <div class="card">
                <div class="card-header with-border d-flex justify-content-between align-items-center">
                    <h5 class="card-title ">Pencatatan Penerimaan BHP</h5>
                ...
                <div class="card-body">
                    <div class="row">
                            <div class="col-sm-12 col-spacing-row row">
                                <div class="col-sm-5 ">
                                    <div class="form-group  col-spacing-row row">
                                        ...
                                        <div class="col-sm-3 col-spacing-row row">
