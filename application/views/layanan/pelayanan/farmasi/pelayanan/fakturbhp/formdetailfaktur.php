        ...
        <div class="modal-content" >
                ...
                <div class="card card-default card-solid" id="kotakform">
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Detail BHP </h5>
                        ...
                        <div class="card-body">
                            <div class="col-sm-12">
                                <div class="form-group row col-spacing-row">
                                    <label class="col-sm-5 control-label">Kode</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" name="kode" id="kode" disabled>
                                    </div>
                                </div>
                                <div class="form-group row col-spacing-row">
                                    <label class="col-sm-5 control-label">Nama Obat/BHP*</label>
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group row col-spacing-row">
                                    <label class="col-sm-5 control-label">Qty (kemasan)*</label>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group row col-spacing-row">
                                    <label class="col-sm-5 control-label">Harga (per Kemasan)*</label>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group row col-spacing-row">
                                    <label class="col-sm-5 control-label">Pot. Langsung (Rp)</label>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group row col-spacing-row">
                                    <label class="col-sm-5 control-label">Jumlah Harga</label>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group row col-spacing-row">
                                    <label class="col-sm-5 control-label">Isi Dalam Kemasan*</label>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group row col-spacing-row">
                                    <label class="col-sm-5 control-label">Batch No.</label>
                                    <div class="col-sm-5">
        ...
        <div class="modal-content" >
                <div class="card card-default card-solid" id="kotakform">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title">Edit Detail BHP</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                                ...
                                <div class="form-group row col-spacing-row">
                                    ...
                                    <div class="col-sm-7">
                                        <select class="form-control" style="width: 100%;" name="barang" id="barang" onchange="cariobat()">
                                            ...
                                            foreach($dtobat as $row) {
                                                ?>
                                                <option value="<?php echo $row->kodeobat . "_" . $row->id; ?>" <?php echo ($row->kodeobat != $dtdetailfaktur->kodebarang ? "" : "selected");?>><?php echo $row->namaobat.' | '.$row->satuanpakai.' | Rp. '.formatuang($row->hargastok); ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
