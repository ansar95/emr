					...
					<div class="card-body">
						<form target="_blank" action="<?php echo site_url(); ?>/fakturpelayanan/panggilcetak" method="post">
							...
							<div class="row mb-2">
								...
								<div class="col-md-3">
									<div class="custom-control custom-radio custom-control-inline">
										<input type="radio" class="custom-control-input" name="namecekdana" value="1" id="uncekdana" onclick="javascript:unitcekdana();" checked>
										<label class="custom-control-label" for="uncekdana">Semua</label>
									</div>
									<div class="custom-control custom-radio custom-control-inline">
										<input type="radio" name="namecekdana" class="custom-control-input" value="2" id="cekdana" onclick="javascript:unitcekdana();">
										<label class="custom-control-label" for="cekdana">Pilihan</label>
									</div>
								</div>
								<div class="col-md-3">
									<select class="form-control unit2" style="width: 100%;" id="dana" name="dana" disabled>
										<?php
							...
							<div class="row mb-2">
								...
								<div class="col-md-3">
									<div class="custom-control custom-radio custom-control-inline">
										<input type="radio" class="custom-control-input" name="cekprinter" value="0" id="cekprinter1" checked>
										<label class="custom-control-label" for="cekprinter1">LAYAR</label>
									</div>
									<div class="custom-control custom-radio custom-control-inline">
										<input type="radio" class="custom-control-input" name="cekprinter" value="1" id="cekprinter2">
										<label class="custom-control-label" for="cekprinter2">EXCEL</label>
									</div>
								</div>
							</div>
...
<script>
	...
	function unitcekdana() {
		if (document.getElementById('cekdana').checked) {
			document.getElementById('dana').disabled = false;
		} else
			document.getElementById('dana').disabled = true;
	}
</script>