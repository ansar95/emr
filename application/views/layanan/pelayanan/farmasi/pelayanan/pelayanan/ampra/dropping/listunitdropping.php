                    ...
                    <div class="card-header d-md-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex">
                            <div class="d-flex mr-2">
		                        ...
		                        <input type="text" class="form-control" id="idamprapanggil" name="idamprapanggil" value="<?php echo $idamprapanggil; ?>" hidden>
		                        <input type="text" class="form-control" id="namaunitpanggil" name="namaunitpanggil" value="<?php echo $namaunitpanggil; ?>" hidden>

                                <!-- <input type="text" class="form-control" id="bhpkode" name="bhpkode" value=<?php echo $bhp; ?>> -->
                            </div>
