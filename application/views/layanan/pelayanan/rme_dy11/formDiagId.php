 ...
 <div class="modal-dialog modal-lg modal-dialog-centered" style="margin: 0 auto;">
        ...
        <div class="box box-default box-solid" id="kotakform">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    <div class="col-6">
                        <?php echo '<span style="font-size: 20px;">' . $dtDetailDiad->diagnosa . '</span> Ingin Dihapus ?'; ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 text-right">
                        <button onclick="hapusDiag(<?php echo $dtDetailDiad->id; ?>)" class="btn btn-danger">Hapus</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function hapusDiag(id) {
            ...
            $.ajax({
                url: "<?php echo site_url(); ?>/rme/hapusDiagRme",
                type: "GET",
                data: {
                    id: id,
                    // kodeobat: kodeobat,
