    ...
    <div class="modal-content">
        <div class="box box-default box-solid" id="kotakform">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Obat Saat Masuk</h5>
            ...
            <div class="modal-body">
                <div class="form-group row">
                    <label for="username" class="col-sm-1 col-form-label">Nama Obat</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="namaobat" id="namaobat">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-1 col-form-label">Aturan Pakai</label>
                    <div class="col-sm-4">
                        <input type="number" class="form-control" name="aturanpakai" id="aturanpakai">
                    </div>
                    <div class="col-sm-2">
