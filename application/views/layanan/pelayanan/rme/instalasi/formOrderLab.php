 ...
 <div class="modal-dialog modal-lg modal-dialog-centered" style="margin: 0 auto;">
    <div class="modal-content">
        <div class="box box-default box-solid" id="kotakform">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Order Laboratorium</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label for="username" class="col-sm-2">Perlakuan</label>
                    <div class="col-sm-9">
                        <input class="state icheckbox_square-red" type="checkbox" id="cito">&nbsp;CITO
                    </div>
                </div>
                <div class="form-group row">
                    <label for="username" class="col-sm-2">Laboratorium</label>
                    <div class="col-sm-9">
						<label><input type="radio" class="state iradio_square-red" id="klinik" name="pilihunitlab" value="1" > KLINIK</label>
						<label><input type="radio" class="state iradio_square-red ml-4" id="anatomi" name="pilihunitlab" value="2"> ANATOMI</label>
						<label><input type="radio" class="state iradio_square-red ml-4" id="anatomi" name="pilihunitlab" value="3"> MIKROBIOLOGI</label>
						<label><input type="radio" class="state iradio_square-red ml-4" id="anatomi" name="pilihunitlab" value="0" checked hidden></label>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row col-spacing-row">
					...
					<div class="col-md-3">
						<input type="date" class="form-control"  name="tanggal" id="tanggalorder" style="border: 1px solid gray;" value="<?= date('Y-m-d'); ?>" required>
					</div>
					<label class="col-md-1 col-form-label">Jam</label>
					<div class="col-md-3">
						<input type="time" class="form-control"  name="jam" id="jamorder" style="border: 1px solid gray;" value="<?= date('H:i:s'); ?>" required>
					</div>
				</div>
                <div class="form-group row col-spacing-row mt-2">
					<label class="col-md-2 col-form-label">Diagnosa</label>
					<div class="col-md-9">
                        <input type="text" class="form-control" name="diagnosa" id="diagnosa" style="border: 1px solid gray;" required>
					</div>
				</div>
                <br>
                <div class="row">
                    ...
                    <div class="col-6 text-right">
                        <button onclick="SaveOrderHeaderLab()" class="btn btn-primary" data-bs-dismiss="modal">Save</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function SaveOrderHeaderLab() {
            ...
            var cito = $("#cito").prop("checked") ? 1 : 0;
            ...
            console.log(cito);
            console.log('pilih unit :'+pilihunitlab);
            ...
            $.ajax({
                url: "<?php echo site_url(); ?>/rme/saveOrderHeaderlab",
                type: "GET",
                data: {
                    no_rm :no_rm,
