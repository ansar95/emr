...
?>
 <div class="modal-dialog modal-lg modal-dialog-centered" style="margin: 0 auto;">
    <div class="modal-content">
        <div class="box box-default box-solid" id="kotakform">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Order Laboratorium</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input class="state icheckbox_square-red" type="checkbox" id="cito" <?php echo ($cito_EDIT == 1) ? "checked" : ""; ?>> &nbsp;CITO
                    </div>
                </div>
                <div class="form-group row">
                    <label for="username" class="col-sm-2">Laboratorium</label>
                    <div class="col-sm-9">
						<label><input type="radio" class="state iradio_square-red" id="klinik" name="pilihunitlab" value="1" <?php echo ($pilihunitlab_EDIT=="1" ? "checked" : "") ?> > KLINIK</label>
						<label><input type="radio" class="state iradio_square-red ml-4" id="anatomi" name="pilihunitlab" value="2" <?php echo ($pilihunitlab_EDIT=="2" ? "checked" : "") ?>> ANATOMI</label>
						<label><input type="radio" class="state iradio_square-red ml-4" id="anatomi" name="pilihunitlab" value="3" <?php echo ($pilihunitlab_EDIT=="3" ? "checked" : "") ?>> MIKROBIOLOGI</label>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="row">
                    ...
                    <div class="col-6 text-right">
                        <button onclick="SaveEditOrderHeaderLab()" class="btn btn-primary" data-bs-dismiss="modal">Update</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function SaveEditOrderHeaderLab() {
            modalform();
            ...
            $.ajax({
                url: "<?php echo site_url(); ?>/rme/saveEditHeaderLab",
                type: "GET",
                data: {
                    no_rm :no_rm,
