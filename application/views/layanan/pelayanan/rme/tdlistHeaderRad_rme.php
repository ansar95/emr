<?php	
										...
										<?php
													...
													<tr>
														<td colspan="2">
															<div class="form-inline">
																...
																?>
																<button onclick="tambahrad('<?php echo $row->notransaksi_IN.'_'.$row->pilihunitlab; ?>')" class="btn btn-sm btn-secondary ml-auto"  id="tambahLabBaru" name="tambahLabBaru" style="background-color: #E9F713; color: black;" >+ P</button>
											...
											?>
													...
													<!-- <tr onclick="bukaFormRad('<?php echo $row2['idnya']; ?>')"> -->
										...
										?>		
												<tr>
													<td colspan="2">
													<button onclick="kirimrad('<?php echo $row->notransaksi_IN; ?>')" class="btn btn-sm btn-secondary ml-3" id="kirimlab" name="kirimlab" style="background-color: #034A82; color: white;">Kirim Order ke Radiologi</button>
													</td>
												</tr>
										<?php } ?>		
