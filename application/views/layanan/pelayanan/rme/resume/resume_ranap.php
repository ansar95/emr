...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    <td colspan="3"><div align="center" class="style29">RESUME MEDIS</div></td>
  </tr>
  <tr>
    <td width="30%">&nbsp;</td>
    <td width="38%">&nbsp;</td>
...
<?php
  ...
  $nama_dokter_detail='';
  if ($kode_unit == 'IGDD' || $kode_unit == 'IGDP' ) { 
    $qry2 = $this->db->query("SELECT * FROM register_detail WHERE no_rm = '$no_rm' and notransaksi='$notransaksi' and (kode_unit = 'IGDD' or kode_unit = 'IGDP')  order by id limit 1");
  } else {
        ...
        <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
          ...
          foreach ($qry2->result_array() as $brs2) {
            ...
            <tr>
              ...
              <td class="style39"><div align="center"><?php echo $brs2['qty']; ?></div></td>
