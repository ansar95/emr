...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
  ...
  <tr>
    <!-- <td colspan="6" style="font-size: 13px;"><span style="font-size: 16px; font-style: italic;"><?php echo nl2br($dtkonsulranap->jawaban);?></span></td> -->
    <td colspan="6" style="font-size: 13px; white-space: pre-wrap;"><span style="font-size: 16px; font-style: italic;"><?php echo nl2br($dtkonsulranap->jawaban);?></span></td>
  </tr>
  <tr>
    <td style="font-size: 13px;">&nbsp;</td>
    <td>&nbsp;</td>
