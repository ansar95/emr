		...
		<div class="form-horizontal">
			<div class="box box-default box-solid" id="kotakform">
				<div class="modal-header">
					...
					<h4 class="modal-title">Tambah Data Master Jenis</h4>
				</div>
				<div class="modal-body">
					<div class="box-body">
						<div class="col-sm-12">
							...
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">Nama Makanan</label>
								<div class="col-sm-9">
		...
		<div class="form-horizontal">
			<div class="box box-default box-solid" id="kotakform">
				<div class="modal-header">
					...
					<h4 class="modal-title">Ubah Data Master Jenis</h4>
				</div>
				<div class="modal-body">
					<div class="box-body">
						<div class="col-sm-12">
				...
				<div class="modal-footer">
					<a onclick="ubahdata(<?php echo $id;?>)" class="btn btn-primary">Simpan</a>
				</div>
			</div>
		</div>
	</div>
