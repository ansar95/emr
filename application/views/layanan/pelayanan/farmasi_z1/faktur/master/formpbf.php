    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header p-1 pl-3 align-text-bottom">
                <b class="modal-title" id="exampleModalLabel">Tambah Data Master PBF</b>
            ...
            <div class="modal-body">
                <div class="row ">
                    <div class="col">
                        ...
                        <div class="form-group row col-spacing-row">
                            <label class="col-md-3 col-form-label">Nama Kontak</label>
                            <div class="col-md-9">
            ...
            <div class="modal-footer">
                <button id="simpanpbf" class="btn btn-primary">Simpan</button>
            </div>
        </div>
    </div>
    <script>
...
?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <!-- <div class="box box-default box-solid" id="proseskotak"> -->
            <div class="modal-header p-1 pl-3 align-text-bottom">
                <b class="modal-title" id="exampleModalLabel">Edit Master PBF</b>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <div class="row ">
                    <div class="col">
                        ...
                        <div class="form-group row col-spacing-row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control prov" style="width: 100%;" name="jenis" id="jenis">
                                    <option value="UTAMA" <?php if ($dtpbf->jenis == "UTAMA") {
                                                                echo "selected";
                                                            } ?>>UTAMA</option>
                                    <option value="LAIN-LAIN" <?php if ($dtpbf->jenis == "LAIN-LAIN") {
                                                                    echo "selected";
                                                                } ?>>LAIN-LAIN</option>
                                    <option value="KHUSUS" <?php if ($dtpbf->jenis == "KHUSUS") {
                                                                echo "selected";
                                                            } ?>>KHUSUS</option>
                                </select>
                            </div>
