...
if ($formpilih == 0) {
    ...
    <div class="modal-dialog" >
        <div class="modal-content" >
                ...
                <div class="card card-default card-solid" id="kotakform">
                    ...
                    <h5 class="modal-title">Tambah Item Retur Faktur</h5>
                    ...
                    <div class="modal-body">
                        <div class="card-body">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group row col-spacing-row">
                                    <label class="col-sm-4 control-label">NO.SJ/Faktur</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" name="nosj" id="nosj" onkeyup="this.value = this.value.toUpperCase(); carifaktur()">
                                    </div>
                                </div>
                                <div class="form-group row col-spacing-row">
                                ...
                                <div class="form-group row col-spacing-row">
                                    <label class="col-sm-4 control-label">Sebab</label>
                                    <div class="col-sm-8">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#tglretur').datepicker({ autoclose: true }).datepicker("setDate", "0");
