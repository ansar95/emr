		...
		<div class="tab-pane fade show" id="tabutama" role="tabpanel2">
				<nav>
					<div class="nav nav-tabs" id="subnav12" role="tablist2">
						...
						<!-- <a class="nav-item nav-link" id="subtabpulang" data-toggle="tab" href="#pulang" role="tab" aria-controls="subnav12-9" aria-selected="false" style="border: 1px solid #ABB2B9;">Rencana Pulang Pasien</a> -->
					</div>
							...
							<div class="col-md-3 mt-4" id="order">
								...
								<div id="accordion4712" class="accordion-alt" role="tablist" style="background-color: #FFFFFF;">
									<div class="mt-4">
										...
										<button class="btn btn-primary float-right" onclick="bukaFormHistoriIgd()">Buka</button>

										<div id="collapse4712" class="collapse" role="tabpanel" data-parent="#accordion4712">
