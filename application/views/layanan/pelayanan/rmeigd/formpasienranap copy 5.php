						...
						<div class="col-md-12">
							...
							<div class="col-md-3 mt-5" id="hasil">
								...
								<div class="form-inline mt-3">
									...
									<?php if ($editing == 1) { ?>	
										<button onclick="orderLabDPJP()" class="btn btn-sm btn-secondary ml-auto" id="orderResep" name="orderResep" style="background-color: #FF5733; color: white;">+ Order Lab</button>
									<?php } ?>
								</div>
