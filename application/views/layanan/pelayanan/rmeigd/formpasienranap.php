						...
						<div class="col-md-12">
							...
							<div class="col-md-3 mt-5" id="hasil">
								...
								<div class="form-inline mt-3">
									...
									<?php if ($editing == 1) { ?>	
										<button onclick="orderResepDPJP()" class="btn btn-sm btn-secondary ml-auto" id="orderResep" name="orderResep" style="background-color: #FF5733; color: white;">+ Order Resep</button>
									<?php } ?>
								</div>
...
function bukaFormLab(id,notransaksi_IN) {
    $.ajax({
...
function bukaFormRad(id,notransaksi_IN) {
    $.ajax({
...
// });
    ...
    document.addEventListener("DOMContentLoaded", function() {
        document.getElementById("carilab").addEventListener("input", function() {
            ...
            table = document.getElementById("tabellab");
            tr = table.getElementsByTagName("tr");
            for (i = 0; i < tr.length; i++) {
                td = tr[i].getElementsByTagName("td")[0]; // Mengambil kolom nama dokter
                if (td) {
