				...
				<div class="tab-content mt-3" id="nav-tabContent">
					...
					<!-- <table border="1" width="100%"> -->
						<table border="1" width="100%" style="border-color: black;">
							...
							<tr>
								<td style=" font-size: 12px; height:80px; background-color: #F25E4C; color: white; text-align: center;"><input type="checkbox" id="kategori1" <?php echo ($dttriase->kategori1 == 1) ? "checked" : "";?> > Kategori 1<br>Resusitasi<br> Respon Time : 0</td>
								<td style=" font-size: 12px; height:80px; background-color: #F25E4C; color: white; text-align: center;"><input type="checkbox" id="kategori2" <?php echo ($dttriase->kategori2 == 1) ? "checked" : "";?>> Kategori 2<br>Emergency / Gawat Darurat<br> Respon Time : 1 - 3 Menit</td>
								<td style=" font-size: 12px; height:80px; background-color: yellow; color: black; text-align: center;"><input type="checkbox" id="kategori3" <?php echo ($dttriase->kategori3 == 1) ? "checked" : "";?>> Kategori 1<br>Urgen / Darurat<br> Respon Time : 3 - 5 Menit</td>
								<td style=" font-size: 12px; height:80px; background-color: yellow; color: black; text-align: center;"><input type="checkbox" id="kategori4" <?php echo ($dttriase->kategori4 == 1) ? "checked" : "";?>> Kategori 2<br>Semi Darurat</td>
								<td style=" font-size: 12px; height:80px; background-color: green; color: white; text-align: center;"><input type="checkbox" id="kategori5" <?php echo ($dttriase->kategori5== 1) ? "checked" : "";?>> Tidak Darurat</td>
							...
							<tr>
								...
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: #F25E4C; color: white;">
									<input type="checkbox" id="airway11" <?php echo ($dttriase->airway11 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 15px;"> Sumbatan Total
									<br>
									<input type="checkbox" id="airway12" value="sebagian"> Sumbatan Sebagian
								</td>
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: #F25E4C; color: white;">
									<input type="checkbox" id="airway21" <?php echo ($dttriase->airway21 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 15px;"> Paten
								</td>
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: yellow; color: black;">
									<input type="checkbox" id="airway31" <?php echo ($dttriase->airway31 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 15px;"> Paten
								</td>
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: yellow; color: black;">
									<input type="checkbox" id="airway41" <?php echo ($dttriase->airway41 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 15px;"> Paten
								</td>
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: green; color: white;">
									<input type="checkbox" id="airway51" <?php echo ($dttriase->airway51 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 15px;"> Paten
								</td>
							</tr>
							<tr>
								...
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: #F25E4C; color: white; margin-top: 15px;">Distres Pernapasan Berat<br>
									<input type="checkbox" id="breathing11" <?php echo ($dttriase->breathing11 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 10px; margin-top: 10px"> Sumbatan Total
									<br>
									<input type="checkbox" id="breathing12" <?php echo ($dttriase->breathing12 == 1) ? "checked" : "";?> value="sebagian"> Sumbatan Sebagian
								</td>
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: #F25E4C; color: white; margin-top: 15px;">Distres Pernapasan Sedang<br>
									<input type="checkbox" id="breathing21" <?php echo ($dttriase->breathing21 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 10px; margin-top: 10px"> RR > 30x / menit
									<br>
									<input type="checkbox" id="breathing22" <?php echo ($dttriase->breathing22 == 1) ? "checked" : "";?> value="sebagian"> Penggunaan otot bantu napas
								</td>
								...
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: yellow; color: black; margin-top: 15px;">Distres Pernapasan Ringan<br>
									<input type="checkbox" id="breathing31" <?php echo ($dttriase->breathing31 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 10px; margin-top: 10px"> RR > 30x / menit
								</td>
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: yellow; color: black; margin-top: 15px;">Tidak ada Distres Pernapasan<br>
									<input type="checkbox" id="breathing41" <?php echo ($dttriase->breathing41 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 10px; margin-top: 10px"> RR > Normal
								</td>
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: green; color: white; margin-top: 15px;"><br>
									<input type="checkbox" id="breathing51" <?php echo ($dttriase->breathing51 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 10px; margin-top: 10px"> RR > Normal
								</td>
							...
							<tr>
								...
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: #F25E4C; color: white; margin-top: 15px;">Gangguan Hemodinamik Berat<br>
									<input type="checkbox" id="circulation11" <?php echo ($dttriase->circulation11 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 10px; margin-top: 10px"> Nadi Tidak Teraba
									<br>
									<input type="checkbox" id="circulation12" <?php echo ($dttriase->circulation12 == 1) ? "checked" : "";?> value="sebagian"> Pendarahan yang tidak terkontrol / pendarahan aktif
								</td>
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: #F25E4C; color: white; margin-top: 15px;">Gangguan Hemodinamik Sedang<br>
									<input type="checkbox" id="circulation21" <?php echo ($dttriase->circulation21 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 10px; margin-top: 10px"> Nadi Tidak Teraba / Sangat Halus
									<br>
									<input type="checkbox" id="circulation22" <?php echo ($dttriase->circulation22 == 1) ? "checked" : "";?> value="sebagian"> Pendarahan kapiler > 2 detik
								</td>
								...
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: yellow; color: b;lack margin-top: 15px;">Gangguan Hemodinamik Ringan<br>
									<input type="checkbox" id="circulation31" <?php echo ($dttriase->circulation31 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 10px; margin-top: 10px"> Nadi Teraba (Lemah - Kuat)
									<br>
									<input type="checkbox" id="circulation32" <?php echo ($dttriase->circulation32 == 1) ? "checked" : "";?> value="sebagian"> Pendarahan kapiler < 2 detik
								</td>
								...
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: yellow; color: black; margin-top: 15px;">Tidak ada gangguan Gangguan Hemodinamik<br>
									<input type="checkbox" id="circulation41" <?php echo ($dttriase->circulation41 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 10px; margin-top: 10px"> Nadi Teraba
								</td>
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: green; color: white; margin-top: 15px;">Tidak ada gangguan Gangguan Hemodinamik<br>
									<input type="checkbox" id="circulation51" <?php echo ($dttriase->circulation51 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 10px; margin-top: 10px"> Nadi Normal
								</td>
							</tr>
							<tr>
								<td width="10%" style=" font-size: 12px; padding-left: 15px; background-color: #CFD1CF; height:90px;">DISABILITY</td>
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: #F25E4C; color: white;">
									<input type="checkbox" id="disability11" <?php echo ($dttriase->disability11 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 15px;"> GCS < 9
								</td>
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: #F25E4C; color: white;">
									<input type="checkbox" id="disability21" <?php echo ($dttriase->disability21 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 15px;"> GCS 9 - 12
								</td>
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: yellow; color: black;">
									<input type="checkbox" id="disability31" <?php echo ($dttriase->disability31 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 15px;"> GCS 12 - 14
								</td>
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: yellow; color: black;">
									<input type="checkbox" id="disability41" <?php echo ($dttriase->disability41 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 15px;"> GCS 12 - 14
								</td>
								<td width="18%" style=" font-size: 12px; padding-left: 30px; background-color: green; color: white;">
									<input type="checkbox" id="disability51" <?php echo ($dttriase->disability51 == 1) ? "checked" : "";?> value="total" style=" font-size: 12px; margin-bottom: 15px;"> GCS Normal
								</td>
							</tr>
							<tr>
					...
					<div class="tab-pane fade" id="tabasesmenawalmedis" role="tabpanel" >		
						<nav>
							<div class="nav nav-tabs" id="subnav1" role="tablist">
								...
								<a class="nav-item nav-link" id="subtabnyeri" data-toggle="tab" href="#nyeri" role="tab" aria-controls="subnav1-2" aria-selected="false">nyeri</a>
											...
											<div class="card-body">
													...
													<div class="form-group row col-spacing-row">
														...
														<div class="col-md-11">
															<div class="form-check form-check-inline">
																<input type="checkbox" id="datangSendiri" <?php echo ($dtassawal->datangsendiri == 1) ? "checked" : "";?> name="caraMasuk" class="form-check-input">Datang Sendiri
															</div>
															<div class="form-check form-check-inline">
																<input type="checkbox" id="rujukandari" <?php echo ($dtassawal->rujukan == 1) ? "checked" : "";?> name="caraMasuk" class="form-check-input">Rujukan Dari
															</div>
															<div class="form-check form-check-inline">
																<!-- <input type="text" class="form-control col-form-label"  name="isian" id="isian" disabled> -->
												...
												<div class="col-md-12">
													<div class="form-group row col-spacing-row">
														...
														<div class="col-md-11">
															<div class="form-check form-check-inline">
																<input type="checkbox" id="Auto" name="anamnesis" class="form-check-input" <?php echo ($dtassawal->auto == 1) ? "checked" : "";?>>Auto
															</div>
															<div class="form-check form-check-inline">
																<input type="checkbox" id="Allo" name="anamnesis" class="form-check-input" <?php echo ($dtassawal->allo == 1) ? "checked" : "";?>>Allo
															</div>
															<div class="form-check form-check-inline">
																<input type="text" class="form-control col-form-label"  name="Allotext" id="Allotext" style="width: 250px;" <?php echo ($dtassawal->allo == 1) ? "" : "disabled";?>  value="<?php echo $dtassawal->allotext ?>">
															</div>
														</div>
													</div>
												</div>
												...
												<div class="col-md-12">
													<div class="form-group row col-spacing-row">
														...
														<div class="col-md-11">
															<div class="form-check form-check-inline">
																<input type="checkbox" id="preventif" name="preventif" class="form-check-input" <?php echo ($dtassawal->preventif == 1) ? "checked" : "";?>>Preventif
															</div>
															<div class="form-check form-check-inline">
																<input type="checkbox" id="paliatif" name="paliatif" class="form-check-input" <?php echo ($dtassawal->paliatif == 1) ? "checked" : "";?>>Paliatif
															</div>
															<div class="form-check form-check-inline">
																<input type="checkbox" id="kuratif" name="kuratif" class="form-check-input" <?php echo ($dtassawal->kuratif == 1) ? "checked" : "";?>>Kuratif
															</div>
															<div class="form-check form-check-inline">
																<input type="checkbox" id="rehabilitatip" name="rehabilitatip" class="form-check-input" <?php echo ($dtassawal->rehabilitatip == 1) ? "checked" : "";?> >Rehabilitatip
															</div>
														</div>
													</div>
												</div>
												...
												<div class="col-md-12">
													<div class="form-group row col-spacing-row">
														...
														<div class="col-md-11">
															<div class="form-check form-check-inline">
																<input type="checkbox" id="alergitidak" <?php echo ($dtassawal->alergitidak == 1) ? "checked" : "";?> name="caraMasuk" class="form-check-input">Tidak
															</div>
															<div class="form-check form-check-inline">
																<input type="checkbox" id="alergiya" <?php echo ($dtassawal->alergiya == 1) ? "checked" : "";?> name="caraMasuk" class="form-check-input">Ya
															</div>
															<div class="form-check form-check-inline">
																<input type="text" class="form-control col-form-label" name="alergitext" id="alergitext" style="width: 250px;" <?php echo ($dtassawal->alergiya == 1) ? "" : "disabled";?> value="<?php echo $dtassawal->alergitext ?>">
															</div>
														</div>
													</div>
												</div>
								...
								<div class="tab-pane fade" id="pemeriksaan" role="tabpanel" aria-labelledby="subtabpemeriksaan">
									<div class="card">
										<div class="card-body">
											<div class="col-md-12">
												<div class="form-group row col-spacing-row">
													<label class="col-md-1 col-form-label">Keadaan Umum</label>
													<div class="col-md-11">
														<div class="form-check form-check-inline">
															<input type="checkbox" id="baik" name="kondisi" class="form-check-input" <?php echo ($dtassawal->baik == 1) ? "checked" : "";?> onchange="checkKondisi(this)" >
															Baik
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="sakitringan" name="kondisi" class="form-check-input" <?php echo ($dtassawal->sakitringan == 1) ? "checked" : "";?> onchange="checkKondisi(this)">
															Sakit Ringan
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="sakitsedang" name="kondisi" class="form-check-input" <?php echo ($dtassawal->sakitsedang == 1) ? "checked" : "";?> onchange="checkKondisi(this)">
															Sakit Sedang
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="sakitberat" name="kondisi" class="form-check-input" <?php echo ($dtassawal->sakitberat == 1) ? "checked" : "";?> onchange="checkKondisi(this)">
															Sakit Berat
														</div>
													</div>
												</div>
												<div class="form-group row col-spacing-row">
													...
													<div class="col-md-11">
														<div class="form-check form-check-inline">
															<input type="checkbox" id="cm" name="kesadaran" class="form-check-input" <?php echo ($dtassawal->cm == 1) ? "checked" : "";?> onchange="checkKesadaran(this)">
															CM
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="apatis" name="kesadaran" class="form-check-input" <?php echo ($dtassawal->apatis == 1) ? "checked" : "";?> onchange="checkKesadaran(this)">
															Apatis
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="somnolen" name="kesadaran" class="form-check-input" <?php echo ($dtassawal->somnolen == 1) ? "checked" : "";?> onchange="checkKesadaran(this)">
															Somnolen
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="sopor" name="kesadaran" class="form-check-input" <?php echo ($dtassawal->sopor == 1) ? "checked" : "";?> onchange="checkKesadaran(this)">
															Sopor
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="koma" name="kesadaran" class="form-check-input" <?php echo ($dtassawal->koma == 1) ? "checked" : "";?> onchange="checkKesadaran(this)">
															Koma
														</div>
													</div>
												</div>
								...
								<div class="tab-pane fade" id="nyeri" role="tablitabpanelst" aria-labelledby="subtabnyeri">
									<div class="card">
										<div class="card-body">
											<div class="col-md-12">
												<div class="form-group row col-spacing-row">
													<label class="col-md-1 col-form-label" style="font-size: 12px;">Nyeri</label>
													<div class="col-md-11">
														<div class="form-check form-check-inline">
															<input type="checkbox" id="tidak" name="nyerirasa" class="form-check-input" onchange="checkNyeri(this)">
															<span style="font-size: 12px;">Tidak</span>
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="ya" name="nyerirasa" class="form-check-input" onchange="checkNyeri(this)">
												...
												<div class="form-group row col-spacing-row">
													<label class="col-md-1 col-form-label">Sifat</label>
													<div class="col-md-11">
														<div class="form-check form-check-inline">
															<input type="checkbox" id="akut" name="sifat" class="form-check-input" onchange="checkSifat(this)">
															Akut
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="kronis" name="sifat" class="form-check-input" onchange="checkSifat(this)">
															Kronis
														</div>
													</div>
												</div>
												...
												<br>
												<div class="form-group row col-spacing-row">
													<label class="col-md-1 col-form-label">Kualitas Nyeri</label>
													<div class="col-md-11">
														<div class="form-check form-check-inline">
															<input type="checkbox" id="nyeritumpul" name="kualitasnyeri" class="form-check-input" onchange="kualitasnyeri(this)">
															Nyeri Tumpul
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="nyeritajam" name="kualitasnyeri" class="form-check-input" onchange="kualitasnyeri(this)">
															Nyeri Tajam
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="panasterbakar" name="kualitasnyeri" class="form-check-input" onchange="kualitasnyeri(this)">
															Panas / Terbakar
														</div>
													</div>
												</div>
												<div class="form-group row col-spacing-row">
													<label class="col-md-1 col-form-label">Menjalar</label>
													<div class="col-md-11">
														<div class="form-check form-check-inline">
															<input type="checkbox" id="tidak" name="menjalar" class="form-check-input" onchange="Menjalar(this)">
															Tidak
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="ya" name="menjalar" class="form-check-input" onchange="Menjalar(this)">
															Ya
														</div>
														<div class="form-check form-check-inline">
															<input type="text" class="form-control col-form-label" id="menjalarke" style="width: 250px;" disabled>
														</div>
													</div>
												</div>
												<div class="form-group row col-spacing-row">
													...
													<div class="col-md-11">
														<input type="text" class="form-control col-form-label" id="skor" style="width: 250px;">
													</div>
												</div>
												<div class="form-group row col-spacing-row">
													<label class="col-md-1 col-form-label">Frekuensi</label>
													<div class="col-md-11">
														<div class="form-check form-check-inline">
															<input type="checkbox" id="jarang" name="frekuensi" class="form-check-input" onchange="Frekuensi(this)">
															Jarang
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="hilangtimbul" name="frekuensi" class="form-check-input" onchange="Frekuensi(this)">
															Hilang Timbul
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="terusmenerus" name="frekuensi" class="form-check-input" onchange="Frekuensi(this)">
															Terus Menerus
														</div>
													</div>
												</div>
												<div class="form-group row col-spacing-row">
													<label class="col-md-1 col-form-label">Mempengaruhi</label>
													<div class="col-md-11">
														<div class="form-check form-check-inline">
															<input type="checkbox" id="tidur" name="kondisi" class="form-check-input">
															Tidur
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="aktif" name="kondisi" class="form-check-input">
															Aktif
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="konsentrasi" name="kondisi" class="form-check-input">
															Konsentrasi
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="nafsumakan" name="kondisi" class="form-check-input">
															Nafsu Makan
														</div>
													</div>
												</div>
												<div class="form-group row col-spacing-row">
													<label class="col-md-5 col-form-label" style="font-weight: bold; font-size: 14px; color: blue;">SKALA FLCC untuk Anak < 6 Tahun</label>
												</div>
												<div class="form-group row col-spacing-row">
													<div class="col-md-12">
														<table border="1" style="width: 80%;">
															...
															<tr>
																...
																<td><input type="text" id="wajah" name="wajah" /></td>
															</tr>
															<tr>
																<td>Kaki</td>
																...
																<td><input type="text" id="kaki" name="kaki" /></td>
															<tr>
																<td>Aktif</td>
																...
																<td><input type="text" id="aktif" name="aktif" /></td>
															...
															<tr>
																...
																<td><input type="text" id="mengangis" name="mengangis" /></td>
															</tr>
															<tr>
																<td>Bersuara</td>
																...
																<td><input type="text" id="bersuara" name="bersuara" /></td>
															</tr>
														</table>
														<br>
													</div>
												...
												<div class="form-group row col-spacing-row">
													...
													<div class="col-md-6">
														<input type="text" class="form-control col-form-label" name="pencetus" id="pencetus">
													</div>
												</div>
												<div class="form-group row col-spacing-row">
													<label class="col-md-2 col-form-label text-right">(Q) Faktor Kualitas</label>
													<div class="col-md-6">
														<input type="text" class="form-control col-form-label" name="kualitas" id="kualitas">
													</div>
												</div>
												<div class="form-group row col-spacing-row">
													<label class="col-md-2 col-form-label text-right">(R) Lokasi</label>
													<div class="col-md-6">
														<input type="text" class="form-control col-form-label" name="lokasi" id="lokasi">
													</div>
												</div>
												<div class="form-group row col-spacing-row">
													<label class="col-md-2 col-form-label text-right">(S) Skala Nyeri</label>
													<div class="col-md-11">
														<input type="text" class="form-control col-form-label" name="skalanyeri" id="skalanyeri">
													</div>
												</div>
												<div class="form-group row col-spacing-row">
													<label class="col-md-2 col-form-label text-right">(T) Lama Nyeri</label>
													<div class="col-md-6">
														<input type="text" class="form-control col-form-label" name="lamanyeri" id="lamanyeri">
													</div>
												</div>
												<div class="form-group row col-spacing-row">
												...
												<div class="form-group row col-spacing-row">
													<div class="col-md-10">
														<div class="form-check form-check-inline">
															<input type="checkbox" id="laboratorium" name="pemeriksaan" class="form-check-input">
																	Laboratorium
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="radiologi" name="pemeriksaan" class="form-check-input">
																	Radiologi
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="ekg" name="pemeriksaan" class="form-check-input">
																	EKG
														</div>
													</div>
												</div>
												<div class="form-group row col-spacing-row">
													<label class="col-md-1 col-form-label">Lain-lain</label>
													<div class="col-md-6">
														<input type="text" class="form-control col-form-label" name="laintext" id="laintext">
													</div>
												</div>
											</div>
														...
														<table class="table" id="tableterapi">
															<tbody>
																...
																?>
																	...
																	?>	
																		<tr style="background-color: <?php echo $warnabackground;?>;" onclick="openSoapForm('<?php echo $row->id;?>')">
																			<td width="2%">
																			</td>
																			<td width="98%">
																				<?php 
																				echo '<strong style="color: Navy; font-size: 13px;">' . tanggaldua($row->tanggal) .' | ' .$row->tanggal.'</strong><br>';
																					if ($row->terapi != null) {echo '<span style="color: darkred;">Terapi : </span><strong>' . $row->terapi . '<br></strong>';} 
																					if ($row->oleh != null) {echo '<span style="color: darkred;">Riwayat Sekarang : </span><strong>'.$row->oleh . "<br></strong>";} 
																					if ($row->evaluasi != null) {echo '<span style="color: darkred;">Riwayat Dahulu : </span><strong>'.$row->evaluasi . "<br></strong>";} 
																				echo "<br>";	
																				?>
																			</td>
																		<tr>
										...
										<div class="card-body">
											<div class="col-md-12">
												<div class="form-group row col-spacing-row">
													<div class="col-md-11">
														<div class="form-check form-check-inline">
															<input type="checkbox" id="dirawat" name="caraMasuk" class="form-check-input">Dirawat
														</div>
														<div class="form-check form-check-inline">
															<label class="col-md-5 col-form-label">Konsul Spesialis</label>
															<input type="text" class="form-control col-form-label" name="konsul" id="konsul" style="width: 250px;" disabled>
														</div>
													</div>
												</div>
												<div class="form-group row col-spacing-row">
													<!-- <label class="col-md-1 col-form-label">Cara Keluar</label> -->
													<div class="col-md-11">
														<div class="form-check form-check-inline">
															<input type="checkbox" id="pulang" name="caraKeluar" class="form-check-input">Pulang
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="izinDokter" name="caraKeluar" class="form-check-input" disabled>Izin Dokter
														</div>
														<div class="form-check form-check-inline">
															<input type="checkbox" id="permintaanSendiri" name="caraKeluar" class="form-check-input" disabled>Permintaan Sendiri
														</div>
													</div>
												</div>
												<div class="form-group row col-spacing-row">
										...
										<div class="card-body">
											<div class="col-md-12">
												<div class="form-group row col-spacing-row">
													...
													<div class="col-md-12">
														<div class="form-check form-check-inline">
															<textarea id="edukasi" name="edukasi" rows="7" style="width: 1200px;"><?php echo $dtassawal->edukasi?></textarea>
														</div>
													</div>
												</div>
												<div class="form-group row col-spacing-row">
													...
													<div class="col-md-12">
														<div class="form-check form-check-inline">
															<div class="form-group row col-spacing-row">
																<div class="col-md-12">
																	<div class="form-check form-check-inline">
																		<input type="checkbox" id="pasien" name="hubungan" class="form-check-input">Pasien
																	</div>
																	<div class="form-check form-check-inline">
																		<input type="checkbox" id="keluarga" name="hubungan" class="form-check-input">Keluarga
																	</div>
																	<div class="form-check form-check-inline">
																		<input type="checkbox" id="tidak" name="hubungan" class="form-check-input">Tidak
																		<input type="text" class="form-control col-form-label ml-4" name="edukasitidakkarena" id="edukasitidakkarena" style="width: 1000px;">
																	</div>
														...
														<div class="form-check form-check-inline">
															<div class="form-group row col-spacing-row">
																<div class="form-check">
																	<input type="checkbox" id="membaik" name="kondisi" class="form-check-input">
																	<label for="membaik" class="form-check-label">Membaik</label>
																</div>
																<div class="form-check">
																	<input type="checkbox" id="memburuk" name="kondisi" class="form-check-input">
																	<label for="memburuk" class="form-check-label">Memburuk</label>
																</div>
																<div class="form-check">
																	<input type="checkbox" id="tetapmasihsakit" name="kondisi" class="form-check-input">
																	<label for="tetapmasihsakit" class="form-check-label">Tetap / Masih Sakit</label>
																</div>
																<div class="form-check">
																	<input type="checkbox" id="meninggal" name="kondisi" class="form-check-input">
																	<label for="meninggal" class="form-check-label">Meninggal</label>
																</div>
																<div class="form-check">
																	<input type="text" id="jammeninggal" name="jammeninggal" class="form-control" placeholder="Jam Meninggal" disabled>
																</div>
																<div class="form-check">
																	<input type="checkbox" id="doa" name="kondisi" class="form-check-input">
																	<label for="doa" class="form-check-label">DOA</label>
																</div>
															</div>
														</div>
														<div class="form-group row col-spacing-row">
															...
															<div class="form-inline col-md-12">
																...
																<input type="text" class="form-control col-form-label ml-3" id="pulangtd" value="<?php echo $dtassawal->pulangtd?>">
																<label class="col-form-label ml-3">Nadi</label>
																<input type="text" class="form-control col-form-label ml-3" id="pulangnadi" value="<?php echo $dtassawal->pulangnadi?>">
																<label class="col-form-label ml-3">RR</label>
																<input type="text" class="form-control col-form-label ml-3" id="pulangrr" value="<?php echo $dtassawal->pulangrr?>">
																<label class="col-form-label ml-3">Suhu</label>
																<input type="text" class="form-control col-form-label ml-3" id="pulangs" value="<?php echo $dtassawal->pulangs?>">
															</div>
														</div>
													</div>
												</div>
...
function savekondisiawal() {
	...
	function Menjalar(checkbox) {
        var yaCheckbox = document.getElementById('ya');
        var tidakCheckbox = document.getElementById('tidak');
        var menjalarkeText = document.getElementById('menjalarke');

        if (checkbox === yaCheckbox && checkbox.checked) {
            menjalarkeText.disabled = false;
            tidakCheckbox.checked = false;
        } else if (checkbox === tidakCheckbox && checkbox.checked) {
            menjalarkeText.disabled = true;
	...
	const dirawatCheckbox = document.getElementById('dirawat');
    const konsulTextbox = document.getElementById('konsul');

    dirawatCheckbox.addEventListener('change', function() {
        konsulTextbox.disabled = !this.checked;
    });

	const pulangCheckbox = document.getElementById('pulang');
    const izinDokterCheckbox = document.getElementById('izinDokter');
    const permintaanSendiriCheckbox = document.getElementById('permintaanSendiri');

    pulangCheckbox.addEventListener('change', function() {
        if (this.checked) {
            izinDokterCheckbox.checked = false;
            permintaanSendiriCheckbox.checked = false;
        }
        izinDokterCheckbox.disabled = !this.checked;
        permintaanSendiriCheckbox.disabled = !this.checked;
    });

    izinDokterCheckbox.addEventListener('change', function() {
        if (this.checked) {
            permintaanSendiriCheckbox.checked = false;
        }
    });

    permintaanSendiriCheckbox.addEventListener('change', function() {
        if (this.checked) {
            izinDokterCheckbox.checked = false;
        }
    });
