									...
									<div class="form-group row col-spacing-row">
										...
										<div class="col-md-10">
											<div class="form-group row col-spacing-row">
												...
												<label><input type="radio" class="state iradio_square-red ml-3" id="lingkungan1" name="lingkungan" value="4" <?php if ($dtaskepranap->lingkungan == 1) {echo "checked";} ?>> Pasien berada di tempat tidur</label>
												<label><input type="radio" class="state iradio_square-red ml-3" id="lingkungan2" name="lingkungan" value="3" <?php if ($dtaskepranap->lingkungan == 1) {echo "checked";} ?>> Area Rawat Jalan</label>
											</div>
										</div>
									</div>
									<div class="form-group row col-spacing-row">
										...
										<div class="col-md-10">
											<div class="form-group row col-spacing-row">
												...
												<label><input type="radio" class="state iradio_square-red ml-3" id="respon3" name="respon" value="2" <?php if ($dtaskepranap->respon == 1) {echo "checked";} ?>> > 24 Jam</label>
											</div>
										</div>
									</div>
									<div class="form-group row col-spacing-row">
										...
										<div class="col-md-10">
											<div class="form-group row col-spacing-row">
												...
												<label><input type="radio" class="state iradio_square-red ml-3" id="penggunaanobat3" name="penggunaanobat" value="2" <?php if ($dtaskepranap->penggunaanobat == 1) {echo "checked";} ?>> Pengobatan lain</label>
											</div>
										</div>
									</div>
									<div class="form-group row col-spacing-row">
										...
										<div class="col-md-1">
											<input type="text" class="form-control" id="skorjatuhanak"  style="font-size: 14px; border: 1px solid;" disabled>
										</div>
										<div class="col-md-8">
