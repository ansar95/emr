																		...
																		foreach ($dtobatpulang as $row) {
																			...
																			<tr>
																				...
																				<td style="font-size: 13px; text-align: center;">
																					<button onclick="saveperubahanpulang1('<?php echo $row->id;?>')" class="btn btn-primary" data-bs-dismiss="modal"><i class="fa fa-save" style="font-size: 14px;"></i></button>
																					<button onclick="hapusobatpulang('<?php echo $row->id;?>')" class="btn btn-danger" data-bs-dismiss="modal"><i class="fa fa-trash" style="font-size: 14px;"></i></button>
