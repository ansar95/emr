				...
				<div class="row spacing-row">
					<div class="col-md-11">
						<div class="card-body">
							...
							<p>
								<span style="display: inline;font-weight: bold; font-size: 10px; color: black;">Pasien </span><br>
								<span style="display: inline; font-weight: bold; font-size: 20px; color: blue;"><?php echo $dataPasien->no_rm.' | '.$nama_pasien; ?></span><br>
