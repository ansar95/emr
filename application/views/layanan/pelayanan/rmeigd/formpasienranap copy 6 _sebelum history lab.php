					...
					<div class="col-md-11">
						<div class="card-body">
							...
							<p>
								...
								<span style="display: inline;font-weight: bold; font-size: 14px; color: #4C0428;"><?php echo ' Kelas : '.$dataPasien->nama_kelas.' ('.$dataPasien->kode_kelas.'-'.$dataPasien->kode_kamar.')';?></span><br>
		...
		<div class="tab-pane fade show" id="tabutama" role="tabpanel2">
				<nav>
					<div class="nav nav-tabs" id="subnav12" role="tablist2">
						...
						<a class="nav-item nav-link" id="subuploadfile" data-toggle="tab" href="#uploadfile" role="tab" aria-controls="subnav12-9" aria-selected="false" style="border: 1px solid #ABB2B9;">Upload File</a>

						<a class="nav-item nav-link" id="subobatoral" data-toggle="tab" href="#obatoral" role="tab" aria-controls="subnav12-21" aria-selected="false" style="border: 1px solid #ABB2B9;">Pemberian Obat Oral</a>

						<!-- <a class="nav-item nav-link" id="subadmin" data-toggle="tab" href="#admin" role="tab" aria-controls="subnav12-9" aria-selected="false" style="border: 1px solid #ABB2B9;">Admin</a> -->
									...
									<div class="mb-2">
										...
										<div id="collapseLaboratorium" class="collapse mt-3">
											...
											<!-- <div class="form-inline mt-2">
												<label><input type="radio" class="state iradio_square-red" id="pilihlab" name="lamarawat" value="1" checked>&nbsp;Klinik</label>	
												<label><input type="radio" class="state iradio_square-red ml-3" id="pilihlab" name="lamarawat" value="2">&nbsp;Anatomi</label>	
												<label><input type="radio" class="state iradio_square-red ml-3" id="pilihlab" name="lamarawat" value="2">&nbsp;Microbiologi</label>	
											</div> -->
											<div class="form-inline">
										...
										<?php
											...
											<?php 	
												...
												foreach ($data2 as $row2) {
													$ada=1;
											?>
													<!-- <tr onclick="bukaFormLab('<?php echo $row2['idnya']; ?>')" style="border-bottom: 1px solid #0099CC;"> -->
													<tr onclick="bukaFormLab('<?php echo $row2['idnya']; ?>')">
							...
							<div class="col-md-3 mt-4" id="order">
								...
								<div id="accordion47" class="accordion-alt" role="tablist" style="background-color: #FFFFFF;">
									<div class="mt-4">
										...
										<div id="collapse47" class="collapse show" role="tabpanel" data-parent="#accordion47">
				...
				<br>
						...
						<div class="tab-pane fade" id="obatoral" role="tabpanel2" aria-labelledby="subobatoral">
							<!-- =========on progress========== -->
							Pemberian Obat Oral
						</div>
						<div class="tab-pane fade" id="admin" role="tabpanel2" aria-labelledby="subadmin">
							<!-- =========on progress========== -->
							admin
						</div>
					</div>
	...
	$(document).ready(function () {
		$("#subadmin").on("click", function (e) {
			...
			var notransaksi = document.getElementById("notransaksi").value;
					...
					console.log(notransaksi);
			$.ajax({
				url: "<?php echo site_url(); ?>/uri_rme/panggiluriform",
				type: "GET",
				data: {
					no_rm: no_rm,
					notransaksi: notransaksi
...
<script>
	// Event listener untuk tab "triase"
	$(document).ready(function () {
		$("#subobatoral").on("click", function (e) {
			e.preventDefault(); // Mencegah tab berperilaku standar
			...
			$.ajax({
				url: "<?php echo site_url(); ?>/rme/panggilFormCatatObatoral",
				type: "GET",
				data: {
					no_rm: no_rm,
					notransaksi: notransaksi
