            ...
            <div class="form-horizontal">
                <div class="box box-default box-solid" id="kotakform">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Registrasi Pasien Hemodialisa</h4>
                    </div>
                    <div class="modal-body">
                        <div class="box-body">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Petugas</label>
                                    <div class="col-sm-6">
                                        <select class="form-control prov" style="width: 100%;" name="dpetugas" id="dpetugas">
                                            <?php
                                            foreach($datahemodialis as $row) {
                                                ?>
                                                <option value="<?php echo $row->kode_dokter; ?>"><?php echo $row->nama_dokter; ?></option>
                                                <?php
                                            }
                    ...
                    <div class="modal-footer">
                        <a id="simpanpasien" class="btn btn-primary">Save changes</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#simpanpasien").click(function(e) {
                ...
                var dpetugas = $("#dpetugas").val();
                var dpetugastext = $("#dpetugas option:selected").text();
                ...
                // }
                $.ajax({
                    url: "<?php echo site_url();?>/ihemodialisa/simpanregisinstalasihem",
                    type: "GET",
                    data : {
                        nmpas: nmpas,
                        dataadd: dataadd,
...
?>
            ...
            <div class="form-horizontal">
                <div class="box box-default box-solid" id="kotakform">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Edit Pasien Instalasi Hemodialisa</h4>
                    </div>
                    <div class="modal-body">
                        <div class="box-body">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control" name="tgli" id="tgli" disabled value="<?php echo tglind($dt->tanggal);?>">
									</div>
								</div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Dokter Pengirim</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control prov" style="width: 100%;" name="dpetugas" id="dpetugas">
                                            ...
                                            foreach($datahemodialis as $row) {
                                                ?>
                                                <option value="<?php echo $row->kode_dokter; ?>" <?php if ($dt->kode_hemodialis == $row->kode_dokter) { echo "selected"; }?>><?php echo $row->nama_dokter; ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#dpemeriksa').select2({ tags :true });
            $('#dpetugas').select2({ tags :true });
            //$('#tglx').datepicker({ autoclose: true }).datepicker();
        ...
        $(document).ready(function () {
            ...
            var rm = $("#rm").val();
            $.ajax({
                url: "<?php echo site_url();?>/ihemodialisa/caridatarm",
                type: "GET",
                data : {rm: rm},
            }).then(function (data) {
                $("#unitdepan option").remove();
        ...
        function ubahdata(id) {
            ...
            $.ajax({
                url: "<?php echo site_url();?>/ihemodialisa/ubahregisinstalasihem",
                type: "GET",
                data : {
                    id: id,
                    dpengirim: dpengirim,
