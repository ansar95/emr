...
?>
	...
	<div class="col-md-12 text-right">
		<button onclick="simpandataodua()" class="btn btn-primary pull-right">Simpan</button>
	</div>
<?php
} else if ($pilihform == 1) {
?>
		...
		<div class="box box-info">
			<div class="box-body">
				...
				<div class="form-group row col-spacing-row">
					...
					<div class="col-sm-5">
						<div class="custom-control custom-checkbox custom-control-inline">
							<input type="checkbox" class="custom-control-input" name="oumum" id="oumum" <?php if ($dataedit->nonasuransi == "1") {
																											echo "checked";
																										} ?>>
							<label class="custom-control-label" for="oumum">Berlaku Umum</label>
						</div>
	...
	<div class="col-md-6 text-right">
		<button onclick="ubahdataodua(<?php echo $dataedit->id; ?>);" class="btn btn-danger pull-right">Ubah</button>
	</div>
<?php
}
?>
