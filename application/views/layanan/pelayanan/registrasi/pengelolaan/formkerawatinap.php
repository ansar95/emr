<div class="modal-dialog modal-lg" role="document">
	<div class="modal-content">
		...
		<div class="modal-header">
			<h5 class="modal-title" id="exampleModalLabel">Registrasi Poli ke Rawat Inap</h5>
		...
		<div class="modal-body">
				...
				<div class="col-md-12">
					<div class="row form-group">
						...
						<div class="col-sm-8">
							...
							<input type="text" name="pulang" id="pulang" hidden value="<?php echo $pulang; ?>">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="row form-group">
						<label class="col-sm-4 col-form-label">Unit/Kelas Tujuan</label>
						<div class="col-sm-8">
			...
			<div class="row">
				<div class="col-12 text-right">
					<button onclick="simpanpindahrawatinap();" class="btn btn-primary">Simpan</button>
				</div>
			</div>
		</div>
		<!-- </div> -->
...
<script>
	...
	function simpanpindahrawatinap() {
		modalload();
		...
		if (pulang == 0) {
			alert('Pasien Belum di Pulangkan di Poli');
			return;
		}
		...
		$.ajax({
			url: "<?php echo site_url(); ?>/registrasipasien/layanankerawatinap",
			type: "GET",
			data: {
				notrans: notrans,
				pktgl: pktgl,
