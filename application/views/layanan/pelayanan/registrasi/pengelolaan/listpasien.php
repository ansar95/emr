			...
			<div class="col-12">
				<div class="card">
					<div class="card-header d-flex justify-content-between align-items-center">
						<h4 class="mb-0">Admision | Pengelolaan Administrasi Pasien</h4>
					</div>
					<div class="card-body">
						<div class="row">
							<div class="col-md-12">
								<div class="row form-group">
									...
									<div class="col-md-2 pr-0">
										<input id="rm" name="rm" type="text" class="form-control col-sm-12">
									</div>
									<div class="col-md-1">
										<button class='btn btn-warning' onclick="filterrm();"><i class="fa fa-search"></i></button>
									</div>
									...
									<div class="col-md-1">
										<button class=' btn btn-primary' onclick="filterunit();"><i class="fa fa-search"></i></button>
									</div>
									<div class="col-md-2">
										<button class=' btn btn-success' onclick="filternon();"><i class="fa fa-search mr-2"></i> Tampilkan Semua</button>
									</div>
								</div>
							</div>
						</div>
									...
									<table class="table table-bordered table-striped" id="barispasien">
										<thead>
											<tr>
												...
												<th width="10%">Unit Pelayanan</th>
												<th width='10%'>Kamar</th>
												<th width='10%'>Tgl. Masuk Unit</th>
												<th width='5%'>Jam</th>
