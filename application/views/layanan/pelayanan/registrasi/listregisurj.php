			...
			<div class="col-12">
				<div class="card">
					<div class="card-header d-flex justify-content-between align-items-center">
						<h4 class="mb-0">Registrasi Pelayanan Rawat Jalan</h4>
						<button class='btn btn-sm btn-success' onclick="location.href='<?php echo site_url(); ?>/registrasipasien/dataregistrasibaruurj'">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="table-responsive" >
							<div id="tablepasien">
								<table class="table table-bordered table-hover table-scrollable"  id="barispasien">
									<thead>
										<tr>
