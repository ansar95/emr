                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row spacing-row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-12 col-form-label">Nama Pasien</label>
                                    <div class="col-sm-7">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-12 col-form-label">Tgl. Lahir Pasien</label>
                                    <div class="col-sm-7">
                        ...
                        <div class="row spacing-row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-12 col-form-label">Panggilan Pasien</label>
                                    <div class="col-sm-7">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-12 col-form-label">No. Kartu Pasien</label>
                                    <div class="col-sm-7">
                        ...
                        <div class="row spacing-row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-12 col-form-label">Alamat Pasien</label>
                                    <div class="col-sm-7">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-12 col-form-label">NIK Pasien</label>
                                    <div class="col-sm-7">
                        ...
                        <div class="row spacing-row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-12 col-form-label">No. RM Pasien</label>
                                    <div class="col-sm-7">
