...
?>
                    ...
                    <div class="row spacing-row">
                        ...
                        <div class="col-md-5">
                            <div class="row form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" value="<?php echo $dtpasien->nik; ?>" disabled>
                                </div>
                                <!-- <div class="col-sm-3"> -->
    ...
    <script>
        ...
        // function ceknokabpjs($noka) {
        //     pesanvclaim('BPJS','noka tidak aktif');
        // }
                ...
                $.ajax({
                    ...
                    success: function(ajaxData) {
                        ...
                        if (t.stat == 'AKTIF') {        
                            ...
                            pesanalert('Pesan','Kartu Peserta Tidak Aktif');
                            gagalalert();
                            modalloadtutup();
                        }
                    }
