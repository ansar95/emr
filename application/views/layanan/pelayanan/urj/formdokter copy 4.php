		...
		<div class="col-12">
			...
			<nav>
				<div class="nav nav-tabs font-weight-bold border-bottom ml-3" id="nav-tab" role="tablist">
					...
					<a class="nav-item nav-link mt-2 text-white" id="rajalOld" data-toggle="tab" href="#navRajalOld" role="tab" aria-controls="navRajalOld" aria-selected="false" style="color: red; font-size: 12px; background-color: #7A8407;">History Pasien Rajal</a>
				</div>
			</nav>
...
function bukaFormPasien(id, notransaksi, nama_pasien, no_rm, kode_dokter,angkaNav,editing) {
    ...
    function filterData() {
        ...
        cards = document.getElementsByClassName("custom-card");
