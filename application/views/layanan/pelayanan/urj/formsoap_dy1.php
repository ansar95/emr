				...
				<div class="col-md-12">
					...
					<div class="form-group row col-spacing-row">
						<div class="col-md-12">
							...
							<input type="text" class="form-control" name="notrans" id="notrans" value="<?php echo $dtpasien->notransaksi; ?>" disabled hidden>
						</div>
					</div>
							...
							<tbody>
								...
								?>
									...
									<?php	
										...
										?>
										<td class="text-center">
											<button onclick="prosesdatasoap(<?php echo $row->id; ?>)" class="btn btn-sm btn-primary">Isi/Update</button>
										</td>
										<?php
										} else {
										?>	
											<td class="text-center">
											<button onclick="prosesdatasoap(<?php echo $row->id; ?>)" class="btn btn-sm btn-primary" disabled>Isi/Update</button>
										</td>
				...
				<ul class="nav nav-tabs d-block d-sm-flex">
					...
					<li class="nav-item mr-4 mb-2">
						<a class="nav-link p-0" data-toggle="tab" href="#tab_2">
							<div class="d-flex">
								<div class="media-body font-weight-bold">Diagnosa</div>
							</div>
						</a>
					</li>
				</ul>
					...
					<div class="row spacing-row">
						<div class="col-12">
							...
							<div class="row form-group col-spacing-row">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" readonly name="diagnosa" id="diagnosa" >
								</div>
                                <label class="col-sm-2 col-form-label text-right" >Isi/Edit Diagnosa</label>
                                <div class="col-sm-4">
									<select class="form-control" disabled style="width: 100%;" name="icd" id="icd">
										<?php
						...
						<div class="col-md-5">
							<div class="form-group row col-spacing-row">
								...
								<div class="col-md-9">
									...
									<!-- <input type="text" class="form-control" name="diagpasien" id="diagpasien" disabled> -->
								</div>
							</div>
							<div class="form-group row col-spacing-row">
