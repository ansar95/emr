...
?>
	...
	<div class="col-md-6">
		...
		<div class="form-group row col-spacing-row">
			...
			<div class="col-sm-5">
				<div class="custom-control custom-checkbox custom-control-inline">
					<input type="checkbox" class="custom-control-input" name="oumum" id="oumum" <?php if ($dataedit->nonasuransi == "1") { echo "checked";}?>>
					<label class="custom-control-label" for="oumum">Berlaku Umum</label>
				</div>
			</div>
	...
	<div class="col-md-6 text-left">
		<button onclick="ubahodua();" class="btn btn-secondary">Batal</button>
	</div>
