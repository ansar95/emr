<div class="modal-dialog modal-xl" id="myModal2" role="document">
	<div class="modal-content">
		...
		<div class="modal-header p-1 pl-3 align-text-bottom">
			...
			?>
			<b class="modal-title" id="exampleModalLabel">Pemeriksaan Radiologi | <?php echo $rm . ' ' . $nama_pasien; ?></b>
			...
			<div class="table-scrollable p-2">
				<div style="max-height: 500px; min-height: 500px;">
					<div class="row" id="formtindakan">
						...
						?>
							<div class="col-md-4 rad-checkbox">
		...
		<div class="modal-footer">
			<div class="row">
				<div class="col-md-12 text-right">
					...
					<button onclick="batalrad();" class="btn btn-danger ">Batal</button>
					<button onclick="simpandatatindakanrad();" class="btn btn-primary">Simpan</button>
				</div>
			</div>
		</div>
	</div>
...
<script>
	...
	function simpandatatindakanrad() {
		...
		$.ajax({
			url: "<?php echo site_url(); ?>/urj/simpanrad",
			type: "GET",
			data: {
				noinst: noinst,
				hasil: hasil,
		...
		$(".rad-checkbox").each(function(index, elem) {
