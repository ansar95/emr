		...
		<div class="card border-secondary">
			<div class="card-body">
				...
				?>
					...
					<button class="btn btn-primary float-right" onclick="bukaFormPasienOperasi('<?php echo $row->id; ?>', '<?php echo $row->notransaksi; ?>', '<?php echo $row->nama_pasien; ?>', '<?php echo $row->no_rm; ?>','<?php echo $row->notransaksi_IN; ?>',7,0)"><?php echo 'Buka'; ?></button>
