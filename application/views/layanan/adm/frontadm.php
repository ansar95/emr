                                ...
                                <div class="card-body p-0">
                                    <div class="row">
                                        <!-- <div class="col-12 col-lg-12 d-block d-md-flex d-lg-block"> -->
                                            <div class="card bg-primary rounded-0 col-3 col-md-4 col-lg-3"> 
												<a href="<?php echo site_url();?>/<?php echo "users";?>">
													<div class="card-body">
														<div class='d-flex px-0 px-lg-2 py-2 align-self-center'>
															<i class="fas fa-address-book card-liner-icon mt-2 text-white"></i>
															<div class='card-liner-content'>
																<h2 class="card-liner-title text-white">User</h2>
																<h7 class="card-liner-subtitle text-white">Pengaturan User</h7>
															</div>
														</div>
													</div>
												</a>
