        ...
        <form class="form-horizontal" id="kotakform">
            <div class="box box-default box-solid">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Form Pembayaran / Kwitansi</h4>
                </div>
                <div class="modal-body">
                    <div class="box-body">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-4 control-label">No. Faktu</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-4 control-label">Nilai Kwitansi</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="pb" id="pb">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-4 control-label">Nilai PPN</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="pb" id="pb">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-4 control-label">%PPH</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="pb" id="pb">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-4 control-label">Nilai PPH</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="pb" id="pb">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-4 control-label">Nilai DIbayarkan</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="pb" id="pb">
                                </div>
                            </div>
