...
class Masterfarmasi extends CI_Controller {
    ...
    public function editdataharga() {
        if ($this->session->userdata("login") == TRUE) {
            $this->load->model("bhp");
            $dtsimpan = $this->bhp->edithargaobat();
    ...
    public function hapusdataobat() {
        if ($this->session->userdata("login") == TRUE) {
            $this->load->model("bhp");
            $dtsimpan = $this->bhp->hapusdataobat();
            echo $dtsimpan;
        } else {
            redirect('login');
        }
    ...
    //cek data stokminimum
     // master obat
     public function masterobatminimum() {
        if ($this->session->userdata("login") == TRUE) {
            $data['include'] = "layanan/pelayanan/farmasi/faktur/master/cekminimum";
            $data['menusamping'] = "menufakturobat";
            $data['backhome'] = "gudang";
            $data['js'] = "pelayanan/farmasi/master/masterobat";
            $data['css'] = "pelayanan/farmasi/master/masterobat";
    ...
    public function paginationobatminimum() {
        $this->load->model("bhp");
        $config = array();
        $config["base_url"] = "#";
        $config["total_rows"] = $this->bhp->count_all();
