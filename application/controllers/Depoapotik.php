...
class Depoapotik extends CI_Controller {
    ...
    public function datapasien() {
        if ($this->session->userdata("login") == TRUE) {
            ...
            // $data['include'] = "layanan/pelayanan/apotik/resep/listresep";
            $data['include'] = "layanan/pelayanan/registrasi/listpasien_resep";
            $data['menusamping'] = "menuapotik";
            $data['backhome'] = "tiga";

            $data['js'] = "pelayanan/registrasi/lihatdatapasien_apotik";
    ...
    public function resepselesai() {
        if ($this->session->userdata("login") == TRUE) {
            $this->load->model("apotik");
            $dtresep = $this->apotik->resepselesai();
	...
	public function laporandepo() { 
		...
		$data['golongan'] = $this->golongan->full();
        $data['dtpendanaan'] = $this->apotik->pilihpendanaan();
        $data['dtruangan'] = $this->unit->unituntuklaporan();
        $data['menusamping'] = "menuapotik";
		$data['backhome'] = "tiga";
    ...
    public function laporandepobulanan() { 
		$this->load->model('unit');
		$this->load->model('golongan');
		$this->load->model('apotik');
        $data['unit'] = $this->unit->fulldepo();
        ...
        $data['menusamping'] = "menuapotik";
		$data['backhome'] = "tiga";
		$data['include'] = "laporan/apotik/form/laporandepobulanan";
        $data['js'] = "pelayanan/apotik/listresep";
        $data['css'] = "pelayanan/apotik/listresep";
		$this->load->view('templatesidebar/content', $data);
	}

    public function laporanperpasien() { 
		$this->load->model('unit');
		$this->load->model('golongan');
		$this->load->model('apotik');
		$this->load->model('dokter');
        ...
        $data['dtpendanaan'] = $this->apotik->pilihpendanaan();
        $data['dtruangan'] = $this->unit->unituntuklaporan();
        $data['dttandatangan'] = $this->dokter->tandatangan();
        $data['menusamping'] = "menuapotik";
		$data['backhome'] = "tiga";
		$data['include'] = "laporan/apotik/form/laporanperpasien";
        $data['js'] = "pelayanan/apotik/listresep";
        $data['css'] = "pelayanan/apotik/listresep";
		$this->load->view('templatesidebar/content', $data);
	}
    ...
    public function panggilcetak() {
        if ($this->session->userdata("login") == TRUE) {
            ...
            $cekunit=$this->input->post("unit");
            $depo=$this->input->post("depo");
            $cekgolongan=$this->input->post("cekgolongan");
            $golongan=$this->input->post("golongan");
            $cekpendanaan=$this->input->post("cekpendanaan");
            ...
            $data['cekpendanaan']=$cekpendanaan;
    ...
    public function panggilcetakbulanan() {
        if ($this->session->userdata("login") == TRUE) {
            $awal=$this->input->post("awal");
            $akhir=$this->input->post("akhir");
            $cekunit=$this->input->post("pilihunit");
            $depo=$this->input->post("depo");
            $cekgolongan=$this->input->post("pilihgolongan");
            $golongan=$this->input->post("golongan");
            $cekpendanaan=$this->input->post("cekpendanaan");
            $pendanaan=$this->input->post("pendanaan");
            $kelompok=$this->input->post("kelompok");
            $cekperawatan=$this->input->post("cekperawatan");
            ...
            $data['cekperawatan']=$cekperawatan;
            // $this->load->library('pdf');
            // $this->pdf->setPaper('A4', 'Potrait');
            // $this->pdf->filename = "".date("Ymdhms")."resep.pdf";
            // $this->pdf->load_view('laporan/apotik/laporan/laporandepobulanan', $data);
            $this->load->view('laporan/apotik/laporan/laporandepobulanan', $data);
            // $this->pdf->render();
            // $this->pdf->output();
        // $this->load->view('laporan/apotik/laporan/laporandepo', $data);
    } else {
    ...
    public function panggilcetakperpasien() {
        if ($this->session->userdata("login") == TRUE) {
            $awal=$this->input->post("awal");
            $akhir=$this->input->post("akhir");
            $cektgl=$this->input->post("cektgl");
            $resepawal=$this->input->post("resepawal");
            $resepakhir=$this->input->post("resepakhir");
            $cekunit=$this->input->post("cekunit");
            $depo=$this->input->post("depo");
            $cekgolongan=$this->input->post("cekgolongan");
            $golongan=$this->input->post("golongan");
            $cekpendanaan=$this->input->post("cekpendanaan");
            $pendanaan=$this->input->post("pendanaan");
            $cekunitasal=$this->input->post("cekunitasal");
            $unitasal=$this->input->post("unitasal");
            $cekpasien=$this->input->post("cekpasien");
            ...
            $data['akhir']=$akhir;
            $data['cektgl']=$cektgl;
            $data['resepawal']=$resepawal;
            $data['resepakhir']=$resepakhir;
            $data['cekunit']=$cekunit;
            $data['depo']=$depo;
            $data['cekgolongan']=$cekgolongan;
            $data['golongan']=$golongan;
            $data['cekpendanaan']=$cekpendanaan;
            $data['pendanaan']=$pendanaan;
            $data['cekunitasal']=$cekunitasal;
            $data['unitasal']=$unitasal;
            ...
            $this->pdf->setPaper('A4', 'Potrait');
            $this->pdf->filename = "".date("Ymdhms")."resep.pdf";
            $this->pdf->load_view('laporan/apotik/laporan/laporanpasien', $data);
            $this->pdf->render();
            $this->pdf->output();
    } else {
        redirect('login');
    ...
    public function panggilcetakrekapobat() {
        if ($this->session->userdata("login") == TRUE) {
            ...
            // $this->pdf->render();
            // $this->pdf->output();
            $this->load->view('laporan/apotik/laporan/laporanrekapobat', $data);
    } else {
        redirect('login');
    }
	}
