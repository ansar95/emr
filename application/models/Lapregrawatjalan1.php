...
class Lapregrawatjalan extends CI_Model {
	...
	public function ambilgol($d) {
		...
		$this->db->select('register.golongan as golongan, register.tgl_masuk as tgl, register.no_rm as norm, pasien.nama_pasien as nama, pasien.alamat as alamat, pasien.sex as sex, register.barulama as barulama, register_detail.nama_unit as unit');
