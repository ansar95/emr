...
class Lapregrawatinap extends CI_Model {
	...
	public function ambilharian() {
		...
		$this->db->select('register.golongan as golongan, register.tgl_masuk as tgl, register.no_rm as norm, pasien.nama_pasien as nama, pasien.alamat as alamat, register.barulama as barulama, register_detail.nama_unit as unit, pasien.tgl_lahir as tgl_lahir, pasien.sex as sex, register.keluarpada as unitkeluar');
