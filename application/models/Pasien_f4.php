		...
		<td>
				<div class="btn-group">
					...
					<div class="dropdown-menu p-2 bg-light">
						...
						<a class="dropdown-item" href="javascript:kerawatinap(\''.$row->notransaksi.'\')">Ke Rawat Inap</a>
						
						<a class="dropdown-item" href="javascript:cetakregisranap(\''.$row->id.'\')">Cetak Register</a>

						<a class="dropdown-item" href="javascript:panggilpindahkamar(\''.$row->notransaksi.'\')">Pindah Ruangan/Unit</a>
