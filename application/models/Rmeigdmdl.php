...
public function loaddatareseppulang() {
    $notransaksi = $this->input->get("notransaksi");
    $no_rm = $this->input->get("no_rm");
    $this->db->select("resep_detail.kodeobat as kodeobat, resep_detail.namaobat as namaobat, resep_detail.pagi as pagi, resep_detail.siang as siang, resep_detail.malam as malam, resep_detail.keterangan as keterangan, resep_detail.caramakan as caramakan, resep_header.notraksaksi as notransaksi, resep_detail.qty as qty ");
    $this->db->from("resep_detail");
	$this->db->join("resep_header", "resep_header.noresep = resep_detail.noresep");
    $this->db->where("resep_header.no_rm", $no_rm);
    $this->db->where("resep_header.notraksaksi", $notransaksi);
    ...
    foreach ($dataresep->result() as $row) {
        ...
        if ($num_rows > 0) {
            ...
            $this->db->where("jenis", 3);
            $this->db->limit(1);
            $this->db->update("emr_rekonsiliasiobat", $datasave);
        } else {
            $datasave = array(
                'no_rm' => $no_rm,
                'notransaksi' => $row->notransaksi,
...
public function updateDataobatrekon($id, $tindakLanjut, $perubahan, $rute, $qty) {
...
public function simpandatapersalinan() {
    ...
    $dataawal = array(
        ...
        'pimpinanpembukaan' => $this->input->get("pimpinanpembukaan"),
        'pimpinanpengeluaran' => $this->input->get("pimpinanpengeluaran"),
        'pimpinanuri' => $this->input->get("pimpinanuri"),
        'pimpinan4' => $this->input->get("pimpinan4"),
        'user' => $this->session->userdata("nmuser"),
        'user2' => $this->session->userdata("nmuser"),
        'lastlogin' => date("Y-m-d H:i:s")
    );   
...
public function simpanFisikRanap() {
    ...
    $dataawal = array(
        ...
        'rr_fisik' => $this->input->get("rr_fisik"),
        'suhu_fisik' => $this->input->get("suhu_fisik"),
        'spo2_fisik' => $this->input->get("spo2_fisik"),
        'kepala' => $this->input->get("kepala"),
        'kepalatext' => $this->input->get("kepalatext"),
        'mata' => $this->input->get("mata"),
        'matatext' => $this->input->get("matatext"),
...
public function penggildatapulang($no_rm,$notransaksi) {
    $this->db->select("id");
    $this->db->from("emr_rencana_pulang");
    $this->db->where("no_rm", $no_rm);
    $this->db->where("notransaksi", $notransaksi);
    $this->db->limit(1);
    $cari = $this->db->get();
    ...
    if ($num_rows == 0) {
        ...
        $this->db->insert("emr_rencana_pulang", $datajatuh);
    }
...
public function simpanPulang() {
    ...
    $notransaksi = $this->input->get('notransaksi');
    $dataawal = array(
        'lamarawat' => $this->input->get("lamarawat"),
        ...
        'aktifitas' => $this->input->get("aktifitas"),
        'jatuh' => $this->input->get("jatuh"),
        'alatgerak' => $this->input->get("alatgerak"),
        'alatkesehatan' => $this->input->get("alatkesehatan"),
        'alattext' => $this->input->get("alattext"),
        'fisio' => $this->input->get("fisio"),
        'bab' => $this->input->get("bab"),
        'babtext' => $this->input->get("babtext"),
        'diet' => $this->input->get("diet"),
        'lanjutrumah' => $this->input->get("lanjutrumah"),
        'transportasi' => $this->input->get("transportasi"),
        'tujuan' => $this->input->get("tujuan"),
        'alamat' => $this->input->get("alamat"),
        'yankes' => $this->input->get("yankes"),
        'yankestext' => $this->input->get("yankestext"),
        'hasil' => $this->input->get("hasil"),
        'resumemedis' => $this->input->get("resumemedis"),
        'diagnosaakhir' => $this->input->get("diagnosaakhir"),
        ...
        $this->db->where("notransaksi", $notransaksi);
        $this->db->limit(1);
        $dt = $this->db->update("emr_rencana_pulang", $dataawal);
    return array("sukses" => $dt);
}

public function simpanNyeriAssRanap() {
    $no_rm = $this->input->get('no_rm');
    $notransaksi = $this->input->get('notransaksi');
    ...
    $dataawal = array(
        ...
        'cry' => $this->input->get("cry"),
        'consol' => $this->input->get("consol"),
        'skrining' => $this->input->get("skrining"),
        'saran' => $this->input->get("saran"),
        'nyeri2' => $this->input->get("nyeri2"),
        'sifat2' => $this->input->get("sifat2"),
        'kualitasnyeri2' => $this->input->get("kualitasnyeri2"),
        'menjalar2' => $this->input->get("menjalar2"),
        'skornyeri2' => $this->input->get("skornyeri2"),
        'frekuensi2' => $this->input->get("leg"),
        'lamanyeri2' => $this->input->get("lamanyeri2"),
        'lokasi2' => $this->input->get("lokasi2"),
        'nyeri3' => $this->input->get("nyeri3"),
        'sifat3' => $this->input->get("sifat3"),
        'kualitasnyeri3' => $this->input->get("kualitasnyeri3"),
        'menjalar3' => $this->input->get("menjalar3"),
        'menjalartext3' => $this->input->get("menjalartext3"),
        'skornyeri3' => $this->input->get("skornyeri3"),
        'frekuensi3' => $this->input->get("frekuensi3"),
        'lamanyeri3' => $this->input->get("lamanyeri3"),
        'lokasi3' => $this->input->get("lokasi3"),
        'pemicu3' => $this->input->get("pemicu3"),
        'hilang3' => $this->input->get("hilang3"),
        'skrining3' => $this->input->get("skrining3"),
        'saran3' => $this->input->get("saran3"),
        'user2' => $this->session->userdata("nmuser"),
        'lastlogin' => date("Y-m-d H:i:s")
    );   
        $this->db->where("no_rm", $no_rm);
...
public function simpanAskepGiziRanap() {
    $no_rm = $this->input->get('no_rm');
    $notransaksi = $this->input->get('notransaksi');
    $dataawal = array(
        'turunbbanak' => $this->input->get("turunbbanak"),
        'asupananak' => $this->input->get("asupananak"),
        'diagkhususanak' => $this->input->get("diagkhususanak"),
        'diagkhusustextanak' => $this->input->get("diagkhusustextanak"),
        'bacadietanak' => $this->input->get("bacadietanak"),
        'bacadietjamanak' => $this->input->get("bacadietjamanak"),
        'turunbb' => $this->input->get("turunbb"),
        'asupan' => $this->input->get("asupan"),
        'diagkhusus' => $this->input->get("diagkhusus"),
        'diagkhusustext' => $this->input->get("diagkhusustext"),
        'bacadiet' => $this->input->get("bacadiet"),
        'bacadietjam' => $this->input->get("bacadietjam"),
        'geriasupan' => $this->input->get("geriasupan"),
        'geribb' => $this->input->get("geribb"),
        'gerimobilitas' => $this->input->get("gerimobilitas"),
        'geritekanan' => $this->input->get("geritekanan"),
        'gerigangguan' => $this->input->get("gerigangguan"),
        'geriindeks' => $this->input->get("geriindeks"),
        'user2' => $this->session->userdata("nmuser"),
        'lastlogin' => date("Y-m-d H:i:s")
    );   
        $this->db->where("no_rm", $no_rm);
...
public function panggilcetakLaporanOperasi($notransaksi_IN) {
...
public function simpanJatuhAnak() {
    $no_rm = $this->input->get('no_rm');
    $notransaksi = $this->input->get('notransaksi');
    $dataawal = array(
        'anakusia' => $this->input->get("anakusia"),
        'kelamin' => $this->input->get("kelamin"),
        'diagnosis' => $this->input->get("diagnosis"),
        'gangguan' => $this->input->get("gangguan"),
        'lingkungan' => $this->input->get("lingkungan"),
        'respon' => $this->input->get("respon"),
        'penggunaanobat' => $this->input->get("penggunaanobat"),
        'skorjatuhanak' => $this->input->get("skorjatuhanak"),
        'user2' => $this->session->userdata("nmuser"),
        'lastlogin' => date("Y-m-d H:i:s")
    );   
        $this->db->where("no_rm", $no_rm);
...
public function addrecordobatoral($no_rm,$notransaksi) {    
    $datatriase = array(
        'no_rm' => $no_rm,
        'notransaksi' => $notransaksi,
        'namaobat' =>'',
    ...
    $this->db->insert("emr_obatoral", $datatriase);
    // return 1;
}

public function panggilobatoral($no_rm,$notransaksi) {
    $this->db->from("emr_obatoral");
    $this->db->where('no_rm', $no_rm);
    $this->db->where('notransaksi', $notransaksi);
    $this->db->order_by('tanggal', "desc");
    $this->db->order_by('jam', "desc");
...
public function dataobatoralPerId() {
    $id = $this->input->get("id");
    $this->db->from("emr_obatoral");
    $this->db->where("id", $id);
    $this->db->limit(1);
...
public function hapusdataobatoral($id) {
    $id = $this->input->get("id");
    $this->db->where('id', $id);
    $this->db->limit(1);
    $dt = $this->db->delete('emr_obatoral');
    return $dt;
}

public function simpandataobatoral($id) {    
    $datatriase = array(
        'namaobat' =>$this->input->get("namaobat"),
        'jam' =>$this->input->get("jam"),
        'tanggal' =>$this->input->get("tanggal"),
        'kekuatan' =>$this->input->get("kekuatan"),
        'rute' =>$this->input->get("rute"),
        'frekwensi' =>$this->input->get("frekwensi"),
    ...
    $this->db->where("id", $id);
    $this->db->limit(1);
    $dt = $this->db->update("emr_obatoral", $datatriase);
    // return 1;
}    

public function panggilDataUpload($no_rm,$notransaksi) {
...
public function hapusfileupload($id) {
    $this->db->where('id', $id);
    $this->db->limit(1);
    $dt = $this->db->delete('uploadfile');
    return $dt;
}

public function CatatObatOral() {
    $notransaksi = $this->input->get("notransaksi");
    $no_rm = $this->input->get("no_rm");
    $this->db->from("emr_obatoral_header");
    $this->db->where("notransaksi", $notransaksi);
    $data = $this->db->get();
    return $data->result();
}

public function CatatObatOraldetail() {
    $notransaksi = $this->input->get("notransaksi");
    $no_rm = $this->input->get("no_rm");
    $this->db->select("tanggal");
    $this->db->from("emr_obatoral_detail");
    $this->db->where("notransaksi", $notransaksi);
...
Public function cariJumlahBarisTanggal() {
    $notransaksi = $this->input->get("notransaksi");
    $no_rm = $this->input->get("no_rm");
    $this->db->select("tanggal");
    $this->db->from("emr_obatoral_detail");
...
public function loaddatareseporal() {
    $notransaksi = $this->input->get("notransaksi");
    $no_rm = $this->input->get("no_rm");
    $tglhariini=date("Y-m-d");
    $this->db->select("resep_detail.kodeobat as kodeobat, resep_detail.namaobat as namaobat, resep_detail.pagi as pagi, resep_detail.siang as siang, resep_detail.malam as malam, resep_detail.keterangan as keterangan, resep_detail.caramakan as caramakan, resep_header.notraksaksi as notransaksi, resep_header.kode_dokter as kode_dokter, resep_header.nama_dokter as nama_dokter");
    $this->db->from("resep_detail");
	$this->db->join("resep_header", "resep_header.noresep = resep_detail.noresep");
    $this->db->where("resep_header.no_rm", $no_rm);
    $this->db->where("resep_header.notraksaksi", $notransaksi);
    ...
    foreach ($dataresep->result() as $row) {
        ...
        if ($num_rows > 0) {
            ...
            $this->db->insert("emr_obatoral_header", $datasave);
        }    
        ...
        if ($num_rows > 0) {
            ...
            $this->db->insert("emr_obatoral_detail", $datasave);
        }    
    }
}
