...
class Rtmdl extends CI_Model {
    ...
    public function ambildetail($id) {
        ...
        $this->db->select("id, kodebarang, namabarang, satuan, qty, harga, diskon, potlangsung, bayar, hargasementara, hargaperolehan");
    ...
    public function simpanfaktur() {
        ...
        if ($data->result() == NULL) {
            ...
            $this->db->insert("pfakturheader_rt", $headerfaktur);
            ...
            $dt = $this->db->insert("pfakturdetail_rt", $detailfaktur);
            ...
            if (($nofaktur == "") || ($nofaktur == null)) {
                ...
                foreach ($arrtanda as $item) {
                    ...
                    if ($nofaktur->nofak == "") {
                        ...
                        $this->db->where("noterima", $item);
                        $this->db->update("pfakturheader_rt", $updatenofak);
                    } else {
    ...
    public function updatenofaktur($terima, $nofak) {
        ...
        $data = $this->db->update("pfakturheader_rt", $updatenofak);
        return $data;
    }
    ...
    public function updatefaktur() {
        ...
        //if ($data->result() == NULL) {
            ...
            $this->db->where("noterima", $noterima);
            $dt = $this->db->update("pfakturheader_rt", $headerfaktur1);
            //return $dt;
            return array("sukses" => $dt, "noterima" => $noterima);
    ...
    public function deletedetailfaktur() {
        ...
        if (($datadetail != 0) && ($dataheader != 0)) {
            ...
            $this->db->where("id", $id);
            $dt = $this->db->update("pfakturdetail_rt", $data);
            return $dt;
        } else {
            return "0";
        }
    ...
    public function ubahdatainfoheader() {
        ...
        $status = $this->db->update("pfakturheader_rt", $updatedata);
        return $status;
    }
    ...
    public function hapusdatafaktur() {
        ...
        if ($datadetail == 0) {
			$this->db->where('noterima', $sj);
			$dt = $this->db->delete('pfakturheader_rt');
			return $dt;
        } else {
            return false;
        }
